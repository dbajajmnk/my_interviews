# Topic 10 — Interface by function pointers
...
**Interface by function pointers** is address of a compatible function used for callbacks/dispatch.

# 2. Why

Interviewers use **Interface by function pointers** to test C semantics, bounds, integer/pointer behavior, ownership, cleanup, concurrency, security, and system reasoning.
...
Use **Interface by function pointers** only where it solves a concrete systems, embedded, networking, database, performance or safety requirement. **Evidence First:** do not turn course examples into invented project claims.
...
1. What is **Interface by function pointers**?
...
Write the smallest runnable example for **Interface by function pointers**, introduce one realistic bug, reproduce it with evidence, repair it, and state the review rule.
