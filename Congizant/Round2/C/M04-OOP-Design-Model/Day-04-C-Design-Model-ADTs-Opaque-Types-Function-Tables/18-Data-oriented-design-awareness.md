# Topic 18 — Data-oriented design awareness
...
**Data-oriented design awareness** is the C engineering concept **Data-oriented design awareness**.

# 2. Why

Interviewers use **Data-oriented design awareness** to test C semantics, bounds, integer/pointer behavior, ownership, cleanup, concurrency, security, and system reasoning.

# 3. Plain English

Plain English: the C engineering concept **Data-oriented design awareness**. In C, every buffer needs a known capacity, every pointer needs a valid lifetime, and every resource needs an owner.
...
Use **Data-oriented design awareness** only where it solves a concrete systems, embedded, networking, database, performance or safety requirement. **Evidence First:** do not turn course examples into invented project claims.
...
1. What is **Data-oriented design awareness**?
...
Write the smallest runnable example for **Data-oriented design awareness**, introduce one realistic bug, reproduce it with evidence, repair it, and state the review rule.
