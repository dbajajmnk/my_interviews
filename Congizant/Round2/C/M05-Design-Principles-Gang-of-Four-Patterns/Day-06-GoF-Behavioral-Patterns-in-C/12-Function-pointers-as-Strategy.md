# Topic 12 — Function pointers as Strategy
...
**Function pointers as Strategy** is address of a compatible function used for callbacks/dispatch.

# 2. Why

Interviewers use **Function pointers as Strategy** to test C semantics, bounds, integer/pointer behavior, ownership, cleanup, concurrency, security, and system reasoning.
...
Use **Function pointers as Strategy** only where it solves a concrete systems, embedded, networking, database, performance or safety requirement. **Evidence First:** do not turn course examples into invented project claims.
...
1. What is **Function pointers as Strategy**?
...
Write the smallest runnable example for **Function pointers as Strategy**, introduce one realistic bug, reproduce it with evidence, repair it, and state the review rule.
