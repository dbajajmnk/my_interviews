...
**Buffer overflow bugs** is write beyond object bounds.

# 2. Why

Interviewers use **Buffer overflow bugs** to test C semantics, bounds, integer/pointer behavior, ownership, cleanup, concurrency, security, and system reasoning.
...
Use **Buffer overflow bugs** only where it solves a concrete systems, embedded, networking, database, performance or safety requirement. **Evidence First:** do not turn course examples into invented project claims.
...
1. What is **Buffer overflow bugs**?
...
Write the smallest runnable example for **Buffer overflow bugs**, introduce one realistic bug, reproduce it with evidence, repair it, and state the review rule.
