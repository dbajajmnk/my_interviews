# Topic 10 — Top-level statements awareness
...
**Top-level statements awareness** is the C#/.NET engineering concept **Top-level statements awareness**.

---

# 2. Why

Interviewers use **Top-level statements awareness** to test whether you understand C# semantics, CLR/runtime behavior, async/resource ownership, framework behavior, and production trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Top-level statements awareness** is about the C#/.NET engineering concept **Top-level statements awareness**. Use the language/runtime feature only when it makes the contract safer, clearer, or more efficient.
...
In a production C#/.NET system, **Top-level statements awareness** should connect to a concrete CLR, async, ASP.NET Core, EF Core, API, data, security, or architecture requirement.
...
- Reproduce the smallest failure involving **Top-level statements awareness**.
...
1. What is **Top-level statements awareness**?
...
Create the smallest runnable C# example demonstrating **Top-level statements awareness**. Introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Top-level statements awareness** in plain English.
