# Topic 03 — Primary constructors awareness
...
**Primary constructors awareness** is the C#/.NET engineering concept **Primary constructors awareness**.

---

# 2. Why

Interviewers use **Primary constructors awareness** to test whether you understand C# semantics, CLR/runtime behavior, async/resource ownership, framework behavior, and production trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Primary constructors awareness** is about the C#/.NET engineering concept **Primary constructors awareness**. Use the language/runtime feature only when it makes the contract safer, clearer, or more efficient.
...
In a production C#/.NET system, **Primary constructors awareness** should connect to a concrete CLR, async, ASP.NET Core, EF Core, API, data, security, or architecture requirement.
...
- Reproduce the smallest failure involving **Primary constructors awareness**.
...
1. What is **Primary constructors awareness**?
...
Create the smallest runnable C# example demonstrating **Primary constructors awareness**. Introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Primary constructors awareness** in plain English.
