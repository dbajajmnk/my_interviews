# Topic 15 — Records/discriminated-union-like modeling awareness
...
**Records/discriminated-union-like modeling awareness** is value-oriented reference type with generated equality and non-destructive mutation support.

---

# 2. Why

Interviewers use **Records/discriminated-union-like modeling awareness** to test whether you understand C# semantics, CLR/runtime behavior, async/resource ownership, framework behavior, and production trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Records/discriminated-union-like modeling awareness** is about value-oriented reference type with generated equality and non-destructive mutation support. Use the language/runtime feature only when it makes the contract safer, clearer, or more efficient.

---

# 4. Engineering Explanation

record classes synthesize value-based equality and with support; nested mutable members remain mutable
...
In a production C#/.NET system, **Records/discriminated-union-like modeling awareness** should connect to a concrete CLR, async, ASP.NET Core, EF Core, API, data, security, or architecture requirement.
...
- Reproduce the smallest failure involving **Records/discriminated-union-like modeling awareness**.
...
1. What is **Records/discriminated-union-like modeling awareness**?
...
Create the smallest runnable C# example demonstrating **Records/discriminated-union-like modeling awareness**. Introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Records/discriminated-union-like modeling awareness** in plain English.
...
- [Design Patterns (supplementary)](https://refactoring.guru/design-patterns)
