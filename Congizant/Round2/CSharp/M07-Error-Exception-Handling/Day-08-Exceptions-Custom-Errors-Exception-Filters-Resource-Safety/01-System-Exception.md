...
**System.Exception** is the C#/.NET engineering concept **System.Exception**.

---

# 2. Why

Interviewers use **System.Exception** to test whether you understand C# semantics, CLR/runtime behavior, async/resource ownership, framework behavior, and production trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **System.Exception** is about the C#/.NET engineering concept **System.Exception**. Use the language/runtime feature only when it makes the contract safer, clearer, or more efficient.
...
In a production C#/.NET system, **System.Exception** should connect to a concrete CLR, async, ASP.NET Core, EF Core, API, data, security, or architecture requirement.
...
- Reproduce the smallest failure involving **System.Exception**.
...
Create the smallest runnable C# example demonstrating **System.Exception**. Introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **System.Exception** in plain English.
