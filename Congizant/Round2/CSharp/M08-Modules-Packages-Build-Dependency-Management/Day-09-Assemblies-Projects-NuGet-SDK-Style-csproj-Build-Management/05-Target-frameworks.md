...
**Target frameworks** is the C#/.NET engineering concept **Target frameworks**.

---

# 2. Why

Interviewers use **Target frameworks** to test whether you understand C# semantics, CLR/runtime behavior, async/resource ownership, framework behavior, and production trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Target frameworks** is about the C#/.NET engineering concept **Target frameworks**. Use the language/runtime feature only when it makes the contract safer, clearer, or more efficient.
...
In a production C#/.NET system, **Target frameworks** should connect to a concrete CLR, async, ASP.NET Core, EF Core, API, data, security, or architecture requirement.
...
- Reproduce the smallest failure involving **Target frameworks**.
...
Create the smallest runnable C# example demonstrating **Target frameworks**. Introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Target frameworks** in plain English.
