...
**Project references** is the C#/.NET engineering concept **Project references**.

---

# 2. Why

Interviewers use **Project references** to test whether you understand C# semantics, CLR/runtime behavior, async/resource ownership, framework behavior, and production trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Project references** is about the C#/.NET engineering concept **Project references**. Use the language/runtime feature only when it makes the contract safer, clearer, or more efficient.
...
In a production C#/.NET system, **Project references** should connect to a concrete CLR, async, ASP.NET Core, EF Core, API, data, security, or architecture requirement.
...
- Reproduce the smallest failure involving **Project references**.
...
Create the smallest runnable C# example demonstrating **Project references**. Introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
