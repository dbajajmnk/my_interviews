...
**AOT awareness** is the C#/.NET engineering concept **AOT awareness**.

---

# 2. Why

Interviewers use **AOT awareness** to test whether you understand C# semantics, CLR/runtime behavior, async/resource ownership, framework behavior, and production trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **AOT awareness** is about the C#/.NET engineering concept **AOT awareness**. Use the language/runtime feature only when it makes the contract safer, clearer, or more efficient.
...
In a production C#/.NET system, **AOT awareness** should connect to a concrete CLR, async, ASP.NET Core, EF Core, API, data, security, or architecture requirement.
...
- Reproduce the smallest failure involving **AOT awareness**.
...
Create the smallest runnable C# example demonstrating **AOT awareness**. Introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **AOT awareness** in plain English.
