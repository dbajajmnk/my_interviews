# Topic 02 — Common Intermediate Language IL
...
**Common Intermediate Language IL** is the C#/.NET engineering concept **Common Intermediate Language IL**.

---

# 2. Why

Interviewers use **Common Intermediate Language IL** to test whether you understand C# semantics, CLR/runtime behavior, async/resource ownership, framework behavior, and production trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Common Intermediate Language IL** is about the C#/.NET engineering concept **Common Intermediate Language IL**. Use the language/runtime feature only when it makes the contract safer, clearer, or more efficient.
...
In a production C#/.NET system, **Common Intermediate Language IL** should connect to a concrete CLR, async, ASP.NET Core, EF Core, API, data, security, or architecture requirement.
...
- Reproduce the smallest failure involving **Common Intermediate Language IL**.
...
1. What is **Common Intermediate Language IL**?
...
Create the smallest runnable C# example demonstrating **Common Intermediate Language IL**. Introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Common Intermediate Language IL** in plain English.
