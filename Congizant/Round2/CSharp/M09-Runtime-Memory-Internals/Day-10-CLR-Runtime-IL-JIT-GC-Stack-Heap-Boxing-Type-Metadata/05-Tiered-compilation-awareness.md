# Topic 05 — Tiered compilation awareness
...
**Tiered compilation awareness** is the C#/.NET engineering concept **Tiered compilation awareness**.

---

# 2. Why

Interviewers use **Tiered compilation awareness** to test whether you understand C# semantics, CLR/runtime behavior, async/resource ownership, framework behavior, and production trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Tiered compilation awareness** is about the C#/.NET engineering concept **Tiered compilation awareness**. Use the language/runtime feature only when it makes the contract safer, clearer, or more efficient.
...
In a production C#/.NET system, **Tiered compilation awareness** should connect to a concrete CLR, async, ASP.NET Core, EF Core, API, data, security, or architecture requirement.
...
- Reproduce the smallest failure involving **Tiered compilation awareness**.
...
1. What is **Tiered compilation awareness**?
...
Create the smallest runnable C# example demonstrating **Tiered compilation awareness**. Introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Tiered compilation awareness** in plain English.
