...
**Bounded channels** is asynchronous producer-consumer primitive.

---

# 2. Why

Interviewers use **Bounded channels** to test whether you understand C# semantics, CLR/runtime behavior, async/resource ownership, framework behavior, and production trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Bounded channels** is about asynchronous producer-consumer primitive. Use the language/runtime feature only when it makes the contract safer, clearer, or more efficient.
...
In a production C#/.NET system, **Bounded channels** should connect to a concrete CLR, async, ASP.NET Core, EF Core, API, data, security, or architecture requirement.
...
- Reproduce the smallest failure involving **Bounded channels**.
...
Create the smallest runnable C# example demonstrating **Bounded channels**. Introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Bounded channels** in plain English.
