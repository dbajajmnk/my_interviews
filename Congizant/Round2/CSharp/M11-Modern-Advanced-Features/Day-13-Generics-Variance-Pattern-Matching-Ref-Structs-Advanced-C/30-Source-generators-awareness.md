# Topic 30 — Source generators awareness
...
**Source generators awareness** is the C#/.NET engineering concept **Source generators awareness**.

---

# 2. Why

Interviewers use **Source generators awareness** to test whether you understand C# semantics, CLR/runtime behavior, async/resource ownership, framework behavior, and production trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Source generators awareness** is about the C#/.NET engineering concept **Source generators awareness**. Use the language/runtime feature only when it makes the contract safer, clearer, or more efficient.
...
In a production C#/.NET system, **Source generators awareness** should connect to a concrete CLR, async, ASP.NET Core, EF Core, API, data, security, or architecture requirement.
...
- Reproduce the smallest failure involving **Source generators awareness**.
...
1. What is **Source generators awareness**?
...
Create the smallest runnable C# example demonstrating **Source generators awareness**. Introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Source generators awareness** in plain English.
