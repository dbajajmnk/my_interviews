# Topic 16 — JSON source generation awareness
...
**JSON source generation awareness** is the C#/.NET engineering concept **JSON source generation awareness**.

---

# 2. Why

Interviewers use **JSON source generation awareness** to test whether you understand C# semantics, CLR/runtime behavior, async/resource ownership, framework behavior, and production trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **JSON source generation awareness** is about the C#/.NET engineering concept **JSON source generation awareness**. Use the language/runtime feature only when it makes the contract safer, clearer, or more efficient.
...
In a production C#/.NET system, **JSON source generation awareness** should connect to a concrete CLR, async, ASP.NET Core, EF Core, API, data, security, or architecture requirement.
...
- Reproduce the smallest failure involving **JSON source generation awareness**.
...
1. What is **JSON source generation awareness**?
...
Create the smallest runnable C# example demonstrating **JSON source generation awareness**. Introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **JSON source generation awareness** in plain English.
