...
5. [StringBuilder awareness](05-StringBuilder-awareness.md)
6. [Dictionary for hashing](06-Dictionary-for-hashing.md)
7. [HashSet membership](07-HashSet-membership.md)
8. [Two pointers](08-Two-pointers.md)
9. [Sliding window](09-Sliding-window.md)
10. [Stack<T>](10-Stack-T.md)
11. [Queue<T>](11-Queue-T.md)
12. [PriorityQueue awareness](12-PriorityQueue-awareness.md)
...
17. [Span-aware optimization awareness](17-Span-aware-optimization-awareness.md)

---

# 2. Real-Life Analogy

Day 15 keeps the GOJ structure familiar while translating it into C# language, CLR, async, ASP.NET Core, data and production engineering.
...
```text
Clarify → Brute Force → Dictionary/Pointer/Window → Test → Complexity
```
...
Solve longest substring and explain O(n), Unicode assumptions, and when Span would or would not matter.
