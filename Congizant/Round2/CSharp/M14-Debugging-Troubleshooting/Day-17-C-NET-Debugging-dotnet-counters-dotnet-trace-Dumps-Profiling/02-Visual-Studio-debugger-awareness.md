# Topic 02 — Visual Studio debugger awareness
...
**Visual Studio debugger awareness** is the C#/.NET engineering concept **Visual Studio debugger awareness**.

---

# 2. Why

Interviewers use **Visual Studio debugger awareness** to test whether you understand C# semantics, CLR/runtime behavior, async/resource ownership, framework behavior, and production trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Visual Studio debugger awareness** is about the C#/.NET engineering concept **Visual Studio debugger awareness**. Use the language/runtime feature only when it makes the contract safer, clearer, or more efficient.
...
In a production C#/.NET system, **Visual Studio debugger awareness** should connect to a concrete CLR, async, ASP.NET Core, EF Core, API, data, security, or architecture requirement.
...
- Reproduce the smallest failure involving **Visual Studio debugger awareness**.
...
1. What is **Visual Studio debugger awareness**?
...
Create the smallest runnable C# example demonstrating **Visual Studio debugger awareness**. Introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Visual Studio debugger awareness** in plain English.
