# Topic 14 — Service locator anti-pattern awareness
...
**Service locator anti-pattern awareness** is the C#/.NET engineering concept **Service locator anti-pattern awareness**.

---

# 2. Why

Interviewers use **Service locator anti-pattern awareness** to test whether you understand C# semantics, CLR/runtime behavior, async/resource ownership, framework behavior, and production trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Service locator anti-pattern awareness** is about the C#/.NET engineering concept **Service locator anti-pattern awareness**. Use the language/runtime feature only when it makes the contract safer, clearer, or more efficient.
...
In a production C#/.NET system, **Service locator anti-pattern awareness** should connect to a concrete CLR, async, ASP.NET Core, EF Core, API, data, security, or architecture requirement.
...
- Reproduce the smallest failure involving **Service locator anti-pattern awareness**.
...
1. What is **Service locator anti-pattern awareness**?
...
Create the smallest runnable C# example demonstrating **Service locator anti-pattern awareness**. Introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Service locator anti-pattern awareness** in plain English.
