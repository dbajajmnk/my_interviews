# Topic 16 — Overuse of reflection
...
**Overuse of reflection** is the C#/.NET engineering concept **Overuse of reflection**.

---

# 2. Why

Interviewers use **Overuse of reflection** to test whether you understand C# semantics, CLR/runtime behavior, async/resource ownership, framework behavior, and production trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Overuse of reflection** is about the C#/.NET engineering concept **Overuse of reflection**. Use the language/runtime feature only when it makes the contract safer, clearer, or more efficient.
...
In a production C#/.NET system, **Overuse of reflection** should connect to a concrete CLR, async, ASP.NET Core, EF Core, API, data, security, or architecture requirement.
...
- Reproduce the smallest failure involving **Overuse of reflection**.
...
1. What is **Overuse of reflection**?
...
Create the smallest runnable C# example demonstrating **Overuse of reflection**. Introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Overuse of reflection** in plain English.
