# Topic 17 — Premature abstraction
...
**Premature abstraction** is the C#/.NET engineering concept **Premature abstraction**.

---

# 2. Why

Interviewers use **Premature abstraction** to test whether you understand C# semantics, CLR/runtime behavior, async/resource ownership, framework behavior, and production trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Premature abstraction** is about the C#/.NET engineering concept **Premature abstraction**. Use the language/runtime feature only when it makes the contract safer, clearer, or more efficient.
...
In a production C#/.NET system, **Premature abstraction** should connect to a concrete CLR, async, ASP.NET Core, EF Core, API, data, security, or architecture requirement.
...
- Reproduce the smallest failure involving **Premature abstraction**.
...
Create the smallest runnable C# example demonstrating **Premature abstraction**. Introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Premature abstraction** in plain English.
