# Topic 11 — Incorrect EF Core usage
...
**Incorrect EF Core usage** is modern .NET ORM.

---

# 2. Why

Interviewers use **Incorrect EF Core usage** to test whether you understand C# semantics, CLR/runtime behavior, async/resource ownership, framework behavior, and production trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Incorrect EF Core usage** is about modern .NET ORM. Use the language/runtime feature only when it makes the contract safer, clearer, or more efficient.
...
In a production C#/.NET system, **Incorrect EF Core usage** should connect to a concrete CLR, async, ASP.NET Core, EF Core, API, data, security, or architecture requirement.
...
- Reproduce the smallest failure involving **Incorrect EF Core usage**.
...
1. What is **Incorrect EF Core usage**?
...
Create the smallest runnable C# example demonstrating **Incorrect EF Core usage**. Introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Incorrect EF Core usage** in plain English.
