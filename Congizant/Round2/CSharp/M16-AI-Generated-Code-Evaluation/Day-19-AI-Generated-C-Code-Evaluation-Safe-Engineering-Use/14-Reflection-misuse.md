...
**Reflection misuse** is the C#/.NET engineering concept **Reflection misuse**.

---

# 2. Why

Interviewers use **Reflection misuse** to test whether you understand C# semantics, CLR/runtime behavior, async/resource ownership, framework behavior, and production trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Reflection misuse** is about the C#/.NET engineering concept **Reflection misuse**. Use the language/runtime feature only when it makes the contract safer, clearer, or more efficient.
...
In a production C#/.NET system, **Reflection misuse** should connect to a concrete CLR, async, ASP.NET Core, EF Core, API, data, security, or architecture requirement.
...
- Reproduce the smallest failure involving **Reflection misuse**.
...
Create the smallest runnable C# example demonstrating **Reflection misuse**. Introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Reflection misuse** in plain English.
