# Topic 20 — Exception handling middleware
...
**Exception handling middleware** is request pipeline component.

---

# 2. Why

Interviewers use **Exception handling middleware** to test whether you understand C# semantics, CLR/runtime behavior, async/resource ownership, framework behavior, and production trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Exception handling middleware** is about request pipeline component. Use the language/runtime feature only when it makes the contract safer, clearer, or more efficient.

---

# 4. Engineering Explanation

middleware can run before/after next and must respect cancellation/response-start semantics
...
In a production C#/.NET system, **Exception handling middleware** should connect to a concrete CLR, async, ASP.NET Core, EF Core, API, data, security, or architecture requirement.
...
- Reproduce the smallest failure involving **Exception handling middleware**.
...
1. What is **Exception handling middleware**?
...
Create the smallest runnable C# example demonstrating **Exception handling middleware**. Introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Exception handling middleware** in plain English.
