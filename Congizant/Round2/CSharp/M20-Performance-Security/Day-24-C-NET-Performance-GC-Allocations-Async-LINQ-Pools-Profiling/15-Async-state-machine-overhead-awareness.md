# Topic 15 — Async state-machine overhead awareness
...
**Async state-machine overhead awareness** is compiler-transformed asynchronous method.

---

# 2. Why

Interviewers use **Async state-machine overhead awareness** to test whether you understand C# semantics, CLR/runtime behavior, async/resource ownership, framework behavior, and production trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Async state-machine overhead awareness** is about compiler-transformed asynchronous method. Use the language/runtime feature only when it makes the contract safer, clearer, or more efficient.
...
In a production C#/.NET system, **Async state-machine overhead awareness** should connect to a concrete CLR, async, ASP.NET Core, EF Core, API, data, security, or architecture requirement.
...
- Reproduce the smallest failure involving **Async state-machine overhead awareness**.
...
1. What is **Async state-machine overhead awareness**?
...
Create the smallest runnable C# example demonstrating **Async state-machine overhead awareness**. Introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Async state-machine overhead awareness** in plain English.
