...
**Polly awareness** is resilience library awareness.

---

# 2. Why

Interviewers use **Polly awareness** to test whether you understand C# semantics, CLR/runtime behavior, async/resource ownership, framework behavior, and production trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Polly awareness** is about resilience library awareness. Use the language/runtime feature only when it makes the contract safer, clearer, or more efficient.

---

# 4. Engineering Explanation

policies/pipelines can implement retries, circuit breakers, timeouts and rate controls; business idempotency still matters
...
In a production C#/.NET system, **Polly awareness** should connect to a concrete CLR, async, ASP.NET Core, EF Core, API, data, security, or architecture requirement.
...
- Reproduce the smallest failure involving **Polly awareness**.
...
Create the smallest runnable C# example demonstrating **Polly awareness**. Introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Polly awareness** in plain English.
