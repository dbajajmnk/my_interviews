...
**Activity awareness** is the C#/.NET engineering concept **Activity awareness**.

---

# 2. Why

Interviewers use **Activity awareness** to test whether you understand C# semantics, CLR/runtime behavior, async/resource ownership, framework behavior, and production trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Activity awareness** is about the C#/.NET engineering concept **Activity awareness**. Use the language/runtime feature only when it makes the contract safer, clearer, or more efficient.
...
In a production C#/.NET system, **Activity awareness** should connect to a concrete CLR, async, ASP.NET Core, EF Core, API, data, security, or architecture requirement.
...
- Reproduce the smallest failure involving **Activity awareness**.
...
Create the smallest runnable C# example demonstrating **Activity awareness**. Introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Activity awareness** in plain English.
