...
**Native AOT awareness** is the C#/.NET engineering concept **Native AOT awareness**.

---

# 2. Why

Interviewers use **Native AOT awareness** to test whether you understand C# semantics, CLR/runtime behavior, async/resource ownership, framework behavior, and production trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Native AOT awareness** is about the C#/.NET engineering concept **Native AOT awareness**. Use the language/runtime feature only when it makes the contract safer, clearer, or more efficient.
...
In a production C#/.NET system, **Native AOT awareness** should connect to a concrete CLR, async, ASP.NET Core, EF Core, API, data, security, or architecture requirement.
...
- Reproduce the smallest failure involving **Native AOT awareness**.
...
1. What is **Native AOT awareness**?
...
Create the smallest runnable C# example demonstrating **Native AOT awareness**. Introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Native AOT awareness** in plain English.
