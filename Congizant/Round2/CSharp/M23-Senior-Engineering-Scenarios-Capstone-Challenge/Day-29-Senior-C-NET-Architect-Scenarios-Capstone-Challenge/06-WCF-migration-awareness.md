# Topic 06 — WCF migration awareness
...
**WCF migration awareness** is incremental modernization.

---

# 2. Why

Interviewers use **WCF migration awareness** to test whether you understand C# semantics, CLR/runtime behavior, async/resource ownership, framework behavior, and production trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **WCF migration awareness** is about incremental modernization. Use the language/runtime feature only when it makes the contract safer, clearer, or more efficient.
...
In a production C#/.NET system, **WCF migration awareness** should connect to a concrete CLR, async, ASP.NET Core, EF Core, API, data, security, or architecture requirement.
...
- Reproduce the smallest failure involving **WCF migration awareness**.
...
1. What is **WCF migration awareness**?
...
Create the smallest runnable C# example demonstrating **WCF migration awareness**. Introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **WCF migration awareness** in plain English.
