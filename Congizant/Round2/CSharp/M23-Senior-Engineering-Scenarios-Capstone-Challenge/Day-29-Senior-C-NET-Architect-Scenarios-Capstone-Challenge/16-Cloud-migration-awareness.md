# Topic 16 — Cloud migration awareness
...
**Cloud migration awareness** is incremental modernization.

---

# 2. Why

Interviewers use **Cloud migration awareness** to test whether you understand C# semantics, CLR/runtime behavior, async/resource ownership, framework behavior, and production trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Cloud migration awareness** is about incremental modernization. Use the language/runtime feature only when it makes the contract safer, clearer, or more efficient.
...
In a production C#/.NET system, **Cloud migration awareness** should connect to a concrete CLR, async, ASP.NET Core, EF Core, API, data, security, or architecture requirement.
...
- Reproduce the smallest failure involving **Cloud migration awareness**.
...
1. What is **Cloud migration awareness**?
...
Create the smallest runnable C# example demonstrating **Cloud migration awareness**. Introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Cloud migration awareness** in plain English.
