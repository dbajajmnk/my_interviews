# Topic 02 — Value/reference questions
...
**Value/reference questions** is the C#/.NET engineering concept **Value/reference questions**.

---

# 2. Why

Interviewers use **Value/reference questions** to test whether you understand C# semantics, CLR/runtime behavior, async/resource ownership, framework behavior, and production trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Value/reference questions** is about the C#/.NET engineering concept **Value/reference questions**. Use the language/runtime feature only when it makes the contract safer, clearer, or more efficient.
...
In a production C#/.NET system, **Value/reference questions** should connect to a concrete CLR, async, ASP.NET Core, EF Core, API, data, security, or architecture requirement.
...
- Reproduce the smallest failure involving **Value/reference questions**.
...
1. What is **Value/reference questions**?
...
Create the smallest runnable C# example demonstrating **Value/reference questions**. Introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Value/reference questions** in plain English.
