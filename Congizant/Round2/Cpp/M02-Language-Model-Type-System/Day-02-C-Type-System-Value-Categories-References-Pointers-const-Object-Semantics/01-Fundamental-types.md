...
**Fundamental types** is the C++ engineering concept **Fundamental types**.

---

# 2. Why

Interviewers use **Fundamental types** to test whether you understand C++ semantics, ownership, object lifetime, undefined behavior, concurrency, resource safety, and performance trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Fundamental types** is about the C++ engineering concept **Fundamental types**. In C++, every low-level optimization must still preserve lifetime, ownership and defined behavior.
...
In a production C++ system, **Fundamental types** should connect to a concrete ownership, performance, concurrency, API, data, systems, or architecture requirement.
...
- Reproduce the smallest failure involving **Fundamental types**.
...
Create the smallest runnable C++ example demonstrating **Fundamental types**. Then introduce one realistic misuse, reproduce it using compiler/sanitizer/debugger evidence, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Fundamental types** in plain English.
