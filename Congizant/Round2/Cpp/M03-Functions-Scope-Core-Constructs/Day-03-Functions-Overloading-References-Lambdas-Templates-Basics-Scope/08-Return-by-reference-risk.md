# Topic 08 — Return by reference risk
...
**Return by reference risk** is the C++ engineering concept **Return by reference risk**.

---

# 2. Why

Interviewers use **Return by reference risk** to test whether you understand C++ semantics, ownership, object lifetime, undefined behavior, concurrency, resource safety, and performance trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Return by reference risk** is about the C++ engineering concept **Return by reference risk**. In C++, every low-level optimization must still preserve lifetime, ownership and defined behavior.
...
In a production C++ system, **Return by reference risk** should connect to a concrete ownership, performance, concurrency, API, data, systems, or architecture requirement.
...
- Reproduce the smallest failure involving **Return by reference risk**.
...
1. What is **Return by reference risk**?
...
Create the smallest runnable C++ example demonstrating **Return by reference risk**. Then introduce one realistic misuse, reproduce it using compiler/sanitizer/debugger evidence, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Return by reference risk** in plain English.
