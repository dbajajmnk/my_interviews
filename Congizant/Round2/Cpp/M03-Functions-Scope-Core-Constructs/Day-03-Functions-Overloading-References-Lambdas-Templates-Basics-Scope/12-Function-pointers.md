...
**Function pointers** is the C++ engineering concept **Function pointers**.

---

# 2. Why

Interviewers use **Function pointers** to test whether you understand C++ semantics, ownership, object lifetime, undefined behavior, concurrency, resource safety, and performance trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Function pointers** is about the C++ engineering concept **Function pointers**. In C++, every low-level optimization must still preserve lifetime, ownership and defined behavior.
...
In a production C++ system, **Function pointers** should connect to a concrete ownership, performance, concurrency, API, data, systems, or architecture requirement.
...
- Reproduce the smallest failure involving **Function pointers**.
...
Create the smallest runnable C++ example demonstrating **Function pointers**. Then introduce one realistic misuse, reproduce it using compiler/sanitizer/debugger evidence, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Function pointers** in plain English.
