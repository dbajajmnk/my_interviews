...
**Friend awareness** is the C++ engineering concept **Friend awareness**.

---

# 2. Why

Interviewers use **Friend awareness** to test whether you understand C++ semantics, ownership, object lifetime, undefined behavior, concurrency, resource safety, and performance trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Friend awareness** is about the C++ engineering concept **Friend awareness**. In C++, every low-level optimization must still preserve lifetime, ownership and defined behavior.
...
In a production C++ system, **Friend awareness** should connect to a concrete ownership, performance, concurrency, API, data, systems, or architecture requirement.
...
- Reproduce the smallest failure involving **Friend awareness**.
...
Create the smallest runnable C++ example demonstrating **Friend awareness**. Then introduce one realistic misuse, reproduce it using compiler/sanitizer/debugger evidence, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Friend awareness** in plain English.
