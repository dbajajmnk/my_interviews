...
**Object slicing** is loss of derived state when copied into base object by value.

---

# 2. Why

Interviewers use **Object slicing** to test whether you understand C++ semantics, ownership, object lifetime, undefined behavior, concurrency, resource safety, and performance trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Object slicing** is about loss of derived state when copied into base object by value. In C++, every low-level optimization must still preserve lifetime, ownership and defined behavior.

---

# 4. Engineering Explanation

polymorphic objects should usually be handled by reference/pointer
...
In a production C++ system, **Object slicing** should connect to a concrete ownership, performance, concurrency, API, data, systems, or architecture requirement.
...
- Reproduce the smallest failure involving **Object slicing**.
...
Create the smallest runnable C++ example demonstrating **Object slicing**. Then introduce one realistic misuse, reproduce it using compiler/sanitizer/debugger evidence, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Object slicing** in plain English.
