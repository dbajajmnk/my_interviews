# Topic 03 — pragma once awareness
...
**pragma once awareness** is the C++ engineering concept **pragma once awareness**.

---

# 2. Why

Interviewers use **pragma once awareness** to test whether you understand C++ semantics, ownership, object lifetime, undefined behavior, concurrency, resource safety, and performance trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **pragma once awareness** is about the C++ engineering concept **pragma once awareness**. In C++, every low-level optimization must still preserve lifetime, ownership and defined behavior.
...
In a production C++ system, **pragma once awareness** should connect to a concrete ownership, performance, concurrency, API, data, systems, or architecture requirement.
...
- Reproduce the smallest failure involving **pragma once awareness**.
...
1. What is **pragma once awareness**?
...
Create the smallest runnable C++ example demonstrating **pragma once awareness**. Then introduce one realistic misuse, reproduce it using compiler/sanitizer/debugger evidence, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **pragma once awareness** in plain English.
