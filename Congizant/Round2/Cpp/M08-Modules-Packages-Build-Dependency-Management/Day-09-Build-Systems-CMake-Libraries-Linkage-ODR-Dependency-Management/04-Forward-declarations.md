...
**Forward declarations** is the C++ engineering concept **Forward declarations**.

---

# 2. Why

Interviewers use **Forward declarations** to test whether you understand C++ semantics, ownership, object lifetime, undefined behavior, concurrency, resource safety, and performance trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Forward declarations** is about the C++ engineering concept **Forward declarations**. In C++, every low-level optimization must still preserve lifetime, ownership and defined behavior.
...
In a production C++ system, **Forward declarations** should connect to a concrete ownership, performance, concurrency, API, data, systems, or architecture requirement.
...
- Reproduce the smallest failure involving **Forward declarations**.
...
1. What is **Forward declarations**?
...
Create the smallest runnable C++ example demonstrating **Forward declarations**. Then introduce one realistic misuse, reproduce it using compiler/sanitizer/debugger evidence, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Forward declarations** in plain English.
