# Topic 10 — Name mangling awareness
...
**Name mangling awareness** is the C++ engineering concept **Name mangling awareness**.

---

# 2. Why

Interviewers use **Name mangling awareness** to test whether you understand C++ semantics, ownership, object lifetime, undefined behavior, concurrency, resource safety, and performance trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Name mangling awareness** is about the C++ engineering concept **Name mangling awareness**. In C++, every low-level optimization must still preserve lifetime, ownership and defined behavior.
...
In a production C++ system, **Name mangling awareness** should connect to a concrete ownership, performance, concurrency, API, data, systems, or architecture requirement.
...
- Reproduce the smallest failure involving **Name mangling awareness**.
...
1. What is **Name mangling awareness**?
...
Create the smallest runnable C++ example demonstrating **Name mangling awareness**. Then introduce one realistic misuse, reproduce it using compiler/sanitizer/debugger evidence, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Name mangling awareness** in plain English.
