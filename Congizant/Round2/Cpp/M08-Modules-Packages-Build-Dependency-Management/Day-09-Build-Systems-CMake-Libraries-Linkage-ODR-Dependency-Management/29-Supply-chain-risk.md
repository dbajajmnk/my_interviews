...
**Supply-chain risk** is the C++ engineering concept **Supply-chain risk**.

---

# 2. Why

Interviewers use **Supply-chain risk** to test whether you understand C++ semantics, ownership, object lifetime, undefined behavior, concurrency, resource safety, and performance trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Supply-chain risk** is about the C++ engineering concept **Supply-chain risk**. In C++, every low-level optimization must still preserve lifetime, ownership and defined behavior.
...
In a production C++ system, **Supply-chain risk** should connect to a concrete ownership, performance, concurrency, API, data, systems, or architecture requirement.
...
- Reproduce the smallest failure involving **Supply-chain risk**.
...
Create the smallest runnable C++ example demonstrating **Supply-chain risk**. Then introduce one realistic misuse, reproduce it using compiler/sanitizer/debugger evidence, fix it, and explain the review rule that should catch it.
