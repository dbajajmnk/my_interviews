# Topic 19 — Perfect forwarding awareness
...
**Perfect forwarding awareness** is preserving value category through a generic wrapper.

---

# 2. Why

Interviewers use **Perfect forwarding awareness** to test whether you understand C++ semantics, ownership, object lifetime, undefined behavior, concurrency, resource safety, and performance trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Perfect forwarding awareness** is about preserving value category through a generic wrapper. In C++, every low-level optimization must still preserve lifetime, ownership and defined behavior.

---

# 4. Engineering Explanation

forwarding reference plus std::forward keeps lvalue/rvalue category
...
In a production C++ system, **Perfect forwarding awareness** should connect to a concrete ownership, performance, concurrency, API, data, systems, or architecture requirement.
...
- Reproduce the smallest failure involving **Perfect forwarding awareness**.
...
1. What is **Perfect forwarding awareness**?
...
Create the smallest runnable C++ example demonstrating **Perfect forwarding awareness**. Then introduce one realistic misuse, reproduce it using compiler/sanitizer/debugger evidence, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Perfect forwarding awareness** in plain English.
