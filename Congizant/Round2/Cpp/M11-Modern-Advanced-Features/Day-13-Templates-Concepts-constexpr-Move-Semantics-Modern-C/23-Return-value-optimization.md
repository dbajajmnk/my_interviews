# Topic 23 — Return value optimization
...
**Return value optimization** is the C++ engineering concept **Return value optimization**.

---

# 2. Why

Interviewers use **Return value optimization** to test whether you understand C++ semantics, ownership, object lifetime, undefined behavior, concurrency, resource safety, and performance trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Return value optimization** is about the C++ engineering concept **Return value optimization**. In C++, every low-level optimization must still preserve lifetime, ownership and defined behavior.
...
In a production C++ system, **Return value optimization** should connect to a concrete ownership, performance, concurrency, API, data, systems, or architecture requirement.
...
- Reproduce the smallest failure involving **Return value optimization**.
...
Create the smallest runnable C++ example demonstrating **Return value optimization**. Then introduce one realistic misuse, reproduce it using compiler/sanitizer/debugger evidence, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Return value optimization** in plain English.
