# Topic 21 — Use-after-free diagnosis
...
**Use-after-free diagnosis** is accessing object after lifetime ended.

---

# 2. Why

Interviewers use **Use-after-free diagnosis** to test whether you understand C++ semantics, ownership, object lifetime, undefined behavior, concurrency, resource safety, and performance trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Use-after-free diagnosis** is about accessing object after lifetime ended. In C++, every low-level optimization must still preserve lifetime, ownership and defined behavior.

---

# 4. Engineering Explanation

dangling pointer/reference may appear valid until memory reused; sanitizers are key evidence
...
In a production C++ system, **Use-after-free diagnosis** should connect to a concrete ownership, performance, concurrency, API, data, systems, or architecture requirement.
...
- Reproduce the smallest failure involving **Use-after-free diagnosis**.
...
1. What is **Use-after-free diagnosis**?
...
Create the smallest runnable C++ example demonstrating **Use-after-free diagnosis**. Then introduce one realistic misuse, reproduce it using compiler/sanitizer/debugger evidence, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Use-after-free diagnosis** in plain English.
