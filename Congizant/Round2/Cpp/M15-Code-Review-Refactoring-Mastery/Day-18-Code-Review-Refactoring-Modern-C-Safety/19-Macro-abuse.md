...
**Macro abuse** is the C++ engineering concept **Macro abuse**.

---

# 2. Why

Interviewers use **Macro abuse** to test whether you understand C++ semantics, ownership, object lifetime, undefined behavior, concurrency, resource safety, and performance trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Macro abuse** is about the C++ engineering concept **Macro abuse**. In C++, every low-level optimization must still preserve lifetime, ownership and defined behavior.
...
In a production C++ system, **Macro abuse** should connect to a concrete ownership, performance, concurrency, API, data, systems, or architecture requirement.
...
- Reproduce the smallest failure involving **Macro abuse**.
...
Create the smallest runnable C++ example demonstrating **Macro abuse**. Then introduce one realistic misuse, reproduce it using compiler/sanitizer/debugger evidence, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Macro abuse** in plain English.
