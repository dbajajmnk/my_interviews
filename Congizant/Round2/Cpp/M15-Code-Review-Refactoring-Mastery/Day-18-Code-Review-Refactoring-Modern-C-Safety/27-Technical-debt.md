...
**Technical debt** is the C++ engineering concept **Technical debt**.

---

# 2. Why

Interviewers use **Technical debt** to test whether you understand C++ semantics, ownership, object lifetime, undefined behavior, concurrency, resource safety, and performance trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Technical debt** is about the C++ engineering concept **Technical debt**. In C++, every low-level optimization must still preserve lifetime, ownership and defined behavior.
...
In a production C++ system, **Technical debt** should connect to a concrete ownership, performance, concurrency, API, data, systems, or architecture requirement.
...
- Reproduce the smallest failure involving **Technical debt**.
...
Create the smallest runnable C++ example demonstrating **Technical debt**. Then introduce one realistic misuse, reproduce it using compiler/sanitizer/debugger evidence, fix it, and explain the review rule that should catch it.
