# Topic 02 — Hallucinated standard-library APIs
...
**Hallucinated standard-library APIs** is the C++ engineering concept **Hallucinated standard-library APIs**.

---

# 2. Why

Interviewers use **Hallucinated standard-library APIs** to test whether you understand C++ semantics, ownership, object lifetime, undefined behavior, concurrency, resource safety, and performance trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Hallucinated standard-library APIs** is about the C++ engineering concept **Hallucinated standard-library APIs**. In C++, every low-level optimization must still preserve lifetime, ownership and defined behavior.
...
In a production C++ system, **Hallucinated standard-library APIs** should connect to a concrete ownership, performance, concurrency, API, data, systems, or architecture requirement.
...
- Reproduce the smallest failure involving **Hallucinated standard-library APIs**.
...
1. What is **Hallucinated standard-library APIs**?
...
Create the smallest runnable C++ example demonstrating **Hallucinated standard-library APIs**. Then introduce one realistic misuse, reproduce it using compiler/sanitizer/debugger evidence, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Hallucinated standard-library APIs** in plain English.
