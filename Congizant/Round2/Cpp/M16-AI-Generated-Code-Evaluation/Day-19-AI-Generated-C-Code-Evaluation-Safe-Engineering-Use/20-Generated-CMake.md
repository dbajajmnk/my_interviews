...
**Generated CMake** is target-oriented build configuration system.

---

# 2. Why

Interviewers use **Generated CMake** to test whether you understand C++ semantics, ownership, object lifetime, undefined behavior, concurrency, resource safety, and performance trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Generated CMake** is about target-oriented build configuration system. In C++, every low-level optimization must still preserve lifetime, ownership and defined behavior.
...
In a production C++ system, **Generated CMake** should connect to a concrete ownership, performance, concurrency, API, data, systems, or architecture requirement.
...
- Reproduce the smallest failure involving **Generated CMake**.
...
Create the smallest runnable C++ example demonstrating **Generated CMake**. Then introduce one realistic misuse, reproduce it using compiler/sanitizer/debugger evidence, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Generated CMake** in plain English.
