...
**Performance methodology** is measurement-driven optimization.

---

# 2. Why

Interviewers use **Performance methodology** to test whether you understand C++ semantics, ownership, object lifetime, undefined behavior, concurrency, resource safety, and performance trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Performance methodology** is about measurement-driven optimization. In C++, every low-level optimization must still preserve lifetime, ownership and defined behavior.

---

# 4. Engineering Explanation

profiles, hardware counters and benchmarks identify real bottlenecks
...
In a production C++ system, **Performance methodology** should connect to a concrete ownership, performance, concurrency, API, data, systems, or architecture requirement.
...
Create the smallest runnable C++ example demonstrating **Performance methodology**. Then introduce one realistic misuse, reproduce it using compiler/sanitizer/debugger evidence, fix it, and explain the review rule that should catch it.
