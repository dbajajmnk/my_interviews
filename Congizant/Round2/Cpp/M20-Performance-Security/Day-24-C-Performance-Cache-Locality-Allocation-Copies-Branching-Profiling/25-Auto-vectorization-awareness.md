# Topic 25 — Auto-vectorization awareness
...
**Auto-vectorization awareness** is contiguous dynamic array.

---

# 2. Why

Interviewers use **Auto-vectorization awareness** to test whether you understand C++ semantics, ownership, object lifetime, undefined behavior, concurrency, resource safety, and performance trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Auto-vectorization awareness** is about contiguous dynamic array. In C++, every low-level optimization must still preserve lifetime, ownership and defined behavior.

---

# 4. Engineering Explanation

growth may reallocate and invalidate iterators/references/pointers; reserve can reduce reallocations
...
In a production C++ system, **Auto-vectorization awareness** should connect to a concrete ownership, performance, concurrency, API, data, systems, or architecture requirement.
...
- Reproduce the smallest failure involving **Auto-vectorization awareness**.
...
1. What is **Auto-vectorization awareness**?
...
Create the smallest runnable C++ example demonstrating **Auto-vectorization awareness**. Then introduce one realistic misuse, reproduce it using compiler/sanitizer/debugger evidence, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Auto-vectorization awareness** in plain English.
