# Topic 28 — CMake/package supply-chain risk
...
**CMake/package supply-chain risk** is target-oriented build configuration system.

---

# 2. Why

Interviewers use **CMake/package supply-chain risk** to test whether you understand C++ semantics, ownership, object lifetime, undefined behavior, concurrency, resource safety, and performance trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **CMake/package supply-chain risk** is about target-oriented build configuration system. In C++, every low-level optimization must still preserve lifetime, ownership and defined behavior.

---

# 4. Engineering Explanation

targets carry sources, include paths, compile features and linked dependencies transitively
...
In a production C++ system, **CMake/package supply-chain risk** should connect to a concrete ownership, performance, concurrency, API, data, systems, or architecture requirement.
...
- Reproduce the smallest failure involving **CMake/package supply-chain risk**.
...
1. What is **CMake/package supply-chain risk**?
...
Create the smallest runnable C++ example demonstrating **CMake/package supply-chain risk**. Then introduce one realistic misuse, reproduce it using compiler/sanitizer/debugger evidence, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **CMake/package supply-chain risk** in plain English.
