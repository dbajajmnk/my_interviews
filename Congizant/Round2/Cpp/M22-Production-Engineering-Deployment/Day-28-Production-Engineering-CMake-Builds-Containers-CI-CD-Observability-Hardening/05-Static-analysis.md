...
**Static analysis** is the C++ engineering concept **Static analysis**.

---

# 2. Why

Interviewers use **Static analysis** to test whether you understand C++ semantics, ownership, object lifetime, undefined behavior, concurrency, resource safety, and performance trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Static analysis** is about the C++ engineering concept **Static analysis**. In C++, every low-level optimization must still preserve lifetime, ownership and defined behavior.
...
In a production C++ system, **Static analysis** should connect to a concrete ownership, performance, concurrency, API, data, systems, or architecture requirement.
...
- Reproduce the smallest failure involving **Static analysis**.
...
Create the smallest runnable C++ example demonstrating **Static analysis**. Then introduce one realistic misuse, reproduce it using compiler/sanitizer/debugger evidence, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Static analysis** in plain English.
