# Topic 11 — CMake presets awareness
...
**CMake presets awareness** is target-oriented build configuration system.

---

# 2. Why

Interviewers use **CMake presets awareness** to test whether you understand C++ semantics, ownership, object lifetime, undefined behavior, concurrency, resource safety, and performance trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **CMake presets awareness** is about target-oriented build configuration system. In C++, every low-level optimization must still preserve lifetime, ownership and defined behavior.
...
In a production C++ system, **CMake presets awareness** should connect to a concrete ownership, performance, concurrency, API, data, systems, or architecture requirement.
...
- Reproduce the smallest failure involving **CMake presets awareness**.
...
1. What is **CMake presets awareness**?
...
Create the smallest runnable C++ example demonstrating **CMake presets awareness**. Then introduce one realistic misuse, reproduce it using compiler/sanitizer/debugger evidence, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **CMake presets awareness** in plain English.
