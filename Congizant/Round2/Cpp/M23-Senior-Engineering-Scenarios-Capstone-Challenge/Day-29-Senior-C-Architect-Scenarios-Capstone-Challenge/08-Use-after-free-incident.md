# Topic 08 — Use-after-free incident
...
**Use-after-free incident** is accessing object after lifetime ended.

---

# 2. Why

Interviewers use **Use-after-free incident** to test whether you understand C++ semantics, ownership, object lifetime, undefined behavior, concurrency, resource safety, and performance trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Use-after-free incident** is about accessing object after lifetime ended. In C++, every low-level optimization must still preserve lifetime, ownership and defined behavior.
...
In a production C++ system, **Use-after-free incident** should connect to a concrete ownership, performance, concurrency, API, data, systems, or architecture requirement.
...
- Reproduce the smallest failure involving **Use-after-free incident**.
...
1. What is **Use-after-free incident**?
...
Create the smallest runnable C++ example demonstrating **Use-after-free incident**. Then introduce one realistic misuse, reproduce it using compiler/sanitizer/debugger evidence, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Use-after-free incident** in plain English.
