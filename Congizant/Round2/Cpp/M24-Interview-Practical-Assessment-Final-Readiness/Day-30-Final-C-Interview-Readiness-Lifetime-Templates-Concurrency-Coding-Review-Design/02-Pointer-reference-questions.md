# Topic 02 — Pointer/reference questions
...
**Pointer/reference questions** is the C++ engineering concept **Pointer/reference questions**.

---

# 2. Why

Interviewers use **Pointer/reference questions** to test whether you understand C++ semantics, ownership, object lifetime, undefined behavior, concurrency, resource safety, and performance trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Pointer/reference questions** is about the C++ engineering concept **Pointer/reference questions**. In C++, every low-level optimization must still preserve lifetime, ownership and defined behavior.
...
In a production C++ system, **Pointer/reference questions** should connect to a concrete ownership, performance, concurrency, API, data, systems, or architecture requirement.
...
- Reproduce the smallest failure involving **Pointer/reference questions**.
...
1. What is **Pointer/reference questions**?
...
Create the smallest runnable C++ example demonstrating **Pointer/reference questions**. Then introduce one realistic misuse, reproduce it using compiler/sanitizer/debugger evidence, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Pointer/reference questions** in plain English.
