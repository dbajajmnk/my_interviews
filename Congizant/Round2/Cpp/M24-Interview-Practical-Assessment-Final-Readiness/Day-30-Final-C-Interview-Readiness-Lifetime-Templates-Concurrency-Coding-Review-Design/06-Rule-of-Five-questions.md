# Topic 06 — Rule of Five questions
...
**Rule of Five questions** is special member functions needed when manually owning resources.

---

# 2. Why

Interviewers use **Rule of Five questions** to test whether you understand C++ semantics, ownership, object lifetime, undefined behavior, concurrency, resource safety, and performance trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Rule of Five questions** is about special member functions needed when manually owning resources. In C++, every low-level optimization must still preserve lifetime, ownership and defined behavior.

---

# 4. Engineering Explanation

if a type defines/destructs ownership manually it may need destructor/copy/move constructor and assignments; prefer Rule of Zero
...
```cpp
class Buffer { /* own memory carefully */ };
```
...
In a production C++ system, **Rule of Five questions** should connect to a concrete ownership, performance, concurrency, API, data, systems, or architecture requirement.
...
- Reproduce the smallest failure involving **Rule of Five questions**.
...
1. What is **Rule of Five questions**?
...
Create the smallest runnable C++ example demonstrating **Rule of Five questions**. Then introduce one realistic misuse, reproduce it using compiler/sanitizer/debugger evidence, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Rule of Five questions** in plain English.
