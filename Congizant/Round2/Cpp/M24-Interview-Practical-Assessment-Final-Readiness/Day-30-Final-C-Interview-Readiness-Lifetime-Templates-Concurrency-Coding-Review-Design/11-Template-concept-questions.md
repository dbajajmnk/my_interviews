# Topic 11 — Template/concept questions
...
**Template/concept questions** is compile-time constraint on template parameters.

---

# 2. Why

Interviewers use **Template/concept questions** to test whether you understand C++ semantics, ownership, object lifetime, undefined behavior, concurrency, resource safety, and performance trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Template/concept questions** is about compile-time constraint on template parameters. In C++, every low-level optimization must still preserve lifetime, ownership and defined behavior.

---

# 4. Engineering Explanation

requires clauses make template requirements explicit and diagnostics clearer
...
In a production C++ system, **Template/concept questions** should connect to a concrete ownership, performance, concurrency, API, data, systems, or architecture requirement.
...
- Reproduce the smallest failure involving **Template/concept questions**.
...
1. What is **Template/concept questions**?
...
Create the smallest runnable C++ example demonstrating **Template/concept questions**. Then introduce one realistic misuse, reproduce it using compiler/sanitizer/debugger evidence, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Template/concept questions** in plain English.
