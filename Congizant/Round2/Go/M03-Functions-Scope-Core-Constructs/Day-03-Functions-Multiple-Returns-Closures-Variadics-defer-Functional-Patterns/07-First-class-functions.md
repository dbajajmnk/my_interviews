# Topic 07 — First-class functions
...
**First-class functions** is the Go engineering concept **First-class functions**.

---

# 2. Why

Interviewers use **First-class functions** to test whether you understand Go semantics, ownership, runtime/resource behavior, concurrency correctness, failure handling, and production trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **First-class functions** is about the Go engineering concept **First-class functions**. In Go, prefer the simplest explicit mechanism that preserves correctness, ownership, and operability.
...
In a production Go system, **First-class functions** should connect to a concrete package, API, concurrency, data, networking, runtime, or architecture requirement.
...
- Reproduce the smallest failure involving **First-class functions**.
...
Create the smallest runnable Go example demonstrating **First-class functions**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should have caught it.
