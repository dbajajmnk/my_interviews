# Topic 12 — Functions as Strategy
...
**Functions as Strategy** is the Go engineering concept **Functions as Strategy**.

---

# 2. Why

Interviewers use **Functions as Strategy** to test whether you understand Go semantics, ownership, runtime/resource behavior, concurrency correctness, failure handling, and production trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Functions as Strategy** is about the Go engineering concept **Functions as Strategy**. In Go, prefer the simplest explicit mechanism that preserves correctness, ownership, and operability.
...
In a production Go system, **Functions as Strategy** should connect to a concrete package, API, concurrency, data, networking, runtime, or architecture requirement.
...
- Reproduce the smallest failure involving **Functions as Strategy**.
...
1. What is **Functions as Strategy**?
...
Create the smallest runnable Go example demonstrating **Functions as Strategy**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should have caught it.
...
- [ ] I can define **Functions as Strategy** in plain English.
