...
12. [Functions as Strategy](12-Functions-as-Strategy.md)
13. [Interfaces as behavior contracts](13-Interfaces-as-behavior-contracts.md)
14. [Channels/events vs Observer awareness](14-Channels-events-vs-Observer-awareness.md)
15. [Functional options vs Builder](15-Functional-options-vs-Builder.md)
...
Day 06 keeps the GOJ structure familiar while translating it into Go-native simplicity, explicit errors, ownership, concurrency, runtime, and production reasoning.
...
```text
GoF Behavioral Patterns & Go-Native Pattern Design
├── Language Semantics
├── Toolchain / Runtime
├── Ownership / Resources
├── Concurrency
...
Implement Strategy, State, Chain and Observer-like designs using Go functions/interfaces/channels where appropriate.

---

# 8. Google Interview Drill

Name all 23 GoF patterns, then explain which are rarely useful in Go in their classical class-heavy form.
