...
**errors.New** is the Go engineering concept **errors.New**.

---

# 2. Why

Interviewers use **errors.New** to test whether you understand Go semantics, ownership, runtime/resource behavior, concurrency correctness, failure handling, and production trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **errors.New** is about the Go engineering concept **errors.New**. In Go, prefer the simplest explicit mechanism that preserves correctness, ownership, and operability.
...
In a production Go system, **errors.New** should connect to a concrete package, API, concurrency, data, networking, runtime, or architecture requirement.
...
- Reproduce the smallest failure involving **errors.New**.
...
Create the smallest runnable Go example demonstrating **errors.New**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should have caught it.
...
- [ ] I can define **errors.New** in plain English.
