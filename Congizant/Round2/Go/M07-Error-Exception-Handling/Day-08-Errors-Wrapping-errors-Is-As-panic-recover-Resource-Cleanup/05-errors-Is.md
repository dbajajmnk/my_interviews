...
**errors.Is** is semantic wrapped-error matching.

---

# 2. Why

Interviewers use **errors.Is** to test whether you understand Go semantics, ownership, runtime/resource behavior, concurrency correctness, failure handling, and production trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **errors.Is** is about semantic wrapped-error matching. In Go, prefer the simplest explicit mechanism that preserves correctness, ownership, and operability.

---

# 4. Engineering Explanation

errors.Is traverses unwrap chains and custom Is behavior
...
In a production Go system, **errors.Is** should connect to a concrete package, API, concurrency, data, networking, runtime, or architecture requirement.
...
- Reproduce the smallest failure involving **errors.Is**.
...
Create the smallest runnable Go example demonstrating **errors.Is**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should have caught it.
...
- [ ] I can define **errors.Is** in plain English.
