...
**Sentinel errors** is the Go engineering concept **Sentinel errors**.

---

# 2. Why

Interviewers use **Sentinel errors** to test whether you understand Go semantics, ownership, runtime/resource behavior, concurrency correctness, failure handling, and production trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Sentinel errors** is about the Go engineering concept **Sentinel errors**. In Go, prefer the simplest explicit mechanism that preserves correctness, ownership, and operability.
...
In a production Go system, **Sentinel errors** should connect to a concrete package, API, concurrency, data, networking, runtime, or architecture requirement.
...
- Reproduce the smallest failure involving **Sentinel errors**.
...
Create the smallest runnable Go example demonstrating **Sentinel errors**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should have caught it.
...
- [ ] I can define **Sentinel errors** in plain English.
