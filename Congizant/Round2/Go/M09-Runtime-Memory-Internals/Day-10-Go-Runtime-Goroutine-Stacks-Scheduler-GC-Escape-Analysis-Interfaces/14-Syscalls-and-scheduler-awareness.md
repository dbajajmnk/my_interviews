# Topic 14 — Syscalls and scheduler awareness
...
**Syscalls and scheduler awareness** is runtime scheduling of goroutines on OS threads.

---

# 2. Why

Interviewers use **Syscalls and scheduler awareness** to test whether you understand Go semantics, ownership, runtime/resource behavior, concurrency correctness, failure handling, and production trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Syscalls and scheduler awareness** is about runtime scheduling of goroutines on OS threads. In Go, prefer the simplest explicit mechanism that preserves correctness, ownership, and operability.

---

# 4. Engineering Explanation

the G/P/M model and work stealing are runtime implementation concepts relevant to blocking/scheduling diagnostics
...
In a production Go system, **Syscalls and scheduler awareness** should connect to a concrete package, API, concurrency, data, networking, runtime, or architecture requirement.
...
- Reproduce the smallest failure involving **Syscalls and scheduler awareness**.
...
1. What is **Syscalls and scheduler awareness**?
...
Create the smallest runnable Go example demonstrating **Syscalls and scheduler awareness**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should have caught it.
...
- [ ] I can define **Syscalls and scheduler awareness** in plain English.
