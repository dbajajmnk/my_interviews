# Topic 02 — Goroutine stack vs recursion stack awareness
...
**Goroutine stack vs recursion stack awareness** is lightweight concurrent function managed by Go runtime.

---

# 2. Why

Interviewers use **Goroutine stack vs recursion stack awareness** to test whether you understand Go semantics, ownership, runtime/resource behavior, concurrency correctness, failure handling, and production trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Goroutine stack vs recursion stack awareness** is about lightweight concurrent function managed by Go runtime. In Go, prefer the simplest explicit mechanism that preserves correctness, ownership, and operability.

---

# 4. Engineering Explanation

starting a goroutine transfers lifetime responsibility to the caller/system; result/error/cancellation must be coordinated
...
In a production Go system, **Goroutine stack vs recursion stack awareness** should connect to a concrete package, API, concurrency, data, networking, runtime, or architecture requirement.
...
- Reproduce the smallest failure involving **Goroutine stack vs recursion stack awareness**.
...
1. What is **Goroutine stack vs recursion stack awareness**?
...
Create the smallest runnable Go example demonstrating **Goroutine stack vs recursion stack awareness**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should have caught it.
...
- [ ] I can define **Goroutine stack vs recursion stack awareness** in plain English.
