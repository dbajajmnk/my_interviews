# Topic 13 — Execution trace awareness
...
**Execution trace awareness** is runtime execution trace.

---

# 2. Why

Interviewers use **Execution trace awareness** to test whether you understand Go semantics, ownership, runtime/resource behavior, concurrency correctness, failure handling, and production trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Execution trace awareness** is about runtime execution trace. In Go, prefer the simplest explicit mechanism that preserves correctness, ownership, and operability.

---

# 4. Engineering Explanation

trace exposes scheduler, blocking, syscalls, network and GC timing across goroutines
...
In a production Go system, **Execution trace awareness** should connect to a concrete package, API, concurrency, data, networking, runtime, or architecture requirement.
...
- Reproduce the smallest failure involving **Execution trace awareness**.
...
1. What is **Execution trace awareness**?
...
Create the smallest runnable Go example demonstrating **Execution trace awareness**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should have caught it.
...
- [ ] I can define **Execution trace awareness** in plain English.
