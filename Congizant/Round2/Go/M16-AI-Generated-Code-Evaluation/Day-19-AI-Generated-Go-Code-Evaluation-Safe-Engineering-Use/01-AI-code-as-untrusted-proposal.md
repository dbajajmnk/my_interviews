...
**AI code as untrusted proposal** is the Go engineering concept **AI code as untrusted proposal**.

---

# 2. Why

Interviewers use **AI code as untrusted proposal** to test whether you understand Go semantics, ownership, runtime/resource behavior, concurrency correctness, failure handling, and production trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **AI code as untrusted proposal** is about the Go engineering concept **AI code as untrusted proposal**. In Go, prefer the simplest explicit mechanism that preserves correctness, ownership, and operability.
...
In a production Go system, **AI code as untrusted proposal** should connect to a concrete package, API, concurrency, data, networking, runtime, or architecture requirement.
...
Create the smallest runnable Go example demonstrating **AI code as untrusted proposal**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should have caught it.
