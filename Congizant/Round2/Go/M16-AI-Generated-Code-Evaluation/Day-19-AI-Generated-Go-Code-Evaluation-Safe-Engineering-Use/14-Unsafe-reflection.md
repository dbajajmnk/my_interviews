...
**Unsafe reflection** is the Go engineering concept **Unsafe reflection**.

---

# 2. Why

Interviewers use **Unsafe reflection** to test whether you understand Go semantics, ownership, runtime/resource behavior, concurrency correctness, failure handling, and production trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Unsafe reflection** is about the Go engineering concept **Unsafe reflection**. In Go, prefer the simplest explicit mechanism that preserves correctness, ownership, and operability.
...
In a production Go system, **Unsafe reflection** should connect to a concrete package, API, concurrency, data, networking, runtime, or architecture requirement.
...
- Reproduce the smallest failure involving **Unsafe reflection**.
...
Create the smallest runnable Go example demonstrating **Unsafe reflection**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should have caught it.
...
- [ ] I can define **Unsafe reflection** in plain English.
