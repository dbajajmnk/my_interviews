...
**Performance claims** is measure-first optimization discipline.

---

# 2. Why

Interviewers use **Performance claims** to test whether you understand Go semantics, ownership, runtime/resource behavior, concurrency correctness, failure handling, and production trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Performance claims** is about measure-first optimization discipline. In Go, prefer the simplest explicit mechanism that preserves correctness, ownership, and operability.
...
In a production Go system, **Performance claims** should connect to a concrete package, API, concurrency, data, networking, runtime, or architecture requirement.
...
- Reproduce the smallest failure involving **Performance claims**.
...
Create the smallest runnable Go example demonstrating **Performance claims**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should have caught it.
...
- [ ] I can define **Performance claims** in plain English.
