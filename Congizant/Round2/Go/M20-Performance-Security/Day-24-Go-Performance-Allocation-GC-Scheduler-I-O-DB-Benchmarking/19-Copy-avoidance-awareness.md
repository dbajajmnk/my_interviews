# Topic 19 — Copy avoidance awareness
...
**Copy avoidance awareness** is the Go engineering concept **Copy avoidance awareness**.

---

# 2. Why

Interviewers use **Copy avoidance awareness** to test whether you understand Go semantics, ownership, runtime/resource behavior, concurrency correctness, failure handling, and production trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Copy avoidance awareness** is about the Go engineering concept **Copy avoidance awareness**. In Go, prefer the simplest explicit mechanism that preserves correctness, ownership, and operability.
...
In a production Go system, **Copy avoidance awareness** should connect to a concrete package, API, concurrency, data, networking, runtime, or architecture requirement.
...
- Reproduce the smallest failure involving **Copy avoidance awareness**.
...
1. What is **Copy avoidance awareness**?
...
Create the smallest runnable Go example demonstrating **Copy avoidance awareness**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should have caught it.
...
- [ ] I can define **Copy avoidance awareness** in plain English.
