# Topic 11 — Event-driven migration
...
**Event-driven migration** is incremental system evolution.

---

# 2. Why

Interviewers use **Event-driven migration** to test whether you understand Go semantics, ownership, runtime/resource behavior, concurrency correctness, failure handling, and production trade-offs—not merely syntax.

---

# 3. Plain English

Plain English: **Event-driven migration** is about incremental system evolution. In Go, prefer the simplest explicit mechanism that preserves correctness, ownership, and operability.
...
In a production Go system, **Event-driven migration** should connect to a concrete package, API, concurrency, data, networking, runtime, or architecture requirement.
...
- Reproduce the smallest failure involving **Event-driven migration**.
...
1. What is **Event-driven migration**?
...
Create the smallest runnable Go example demonstrating **Event-driven migration**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should have caught it.
...
- [ ] I can define **Event-driven migration** in plain English.
