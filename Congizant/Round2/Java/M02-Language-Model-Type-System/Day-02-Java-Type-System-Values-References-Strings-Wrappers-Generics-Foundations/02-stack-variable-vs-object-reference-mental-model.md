# Topic 02 — stack variable vs object reference mental model
...
**stack variable vs object reference mental model** is JVM memory ownership and reachability.

---

# 2. Why

Interviewers ask **stack variable vs object reference mental model** to test whether you understand its Java semantics, internal behavior, failure modes, and when its trade-offs are justified—not only its definition.

---

# 3. Plain English

Plain English: **stack variable vs object reference mental model** is about JVM memory ownership and reachability. Use it when the requirement matches that problem; otherwise prefer the simpler Java design.

---

# 4. Engineering Explanation

thread stacks hold frames; heap holds most objects; metaspace stores class metadata; GC follows reachability. Within this day, the closest engineering anchor is **Primitive vs Reference**: Primitive variables contain primitive values; reference variables contain references to objects. Java passes both kinds of variable values by value.
...
- Use **stack variable vs object reference mental model** only when its semantics fit the requirement.
...
1. Memorizing the definition of **stack variable vs object reference mental model** without understanding runtime behavior.
...
- First reproduce the symptom involving **stack variable vs object reference mental model**.
...
- Does **stack variable vs object reference mental model** solve a real requirement or add accidental complexity?
...
- Ask whether AI-generated code uses **stack variable vs object reference mental model** correctly for the project's Java version.
...
1. What is **stack variable vs object reference mental model** in Java?
2. Why would you use **stack variable vs object reference mental model**?
3. How does **stack variable vs object reference mental model** work internally at the level relevant to a Java engineer?
4. What is a common mistake with **stack variable vs object reference mental model**?
5. Where would **stack variable vs object reference mental model** appear in a real production system?
...
Create the smallest Java example that demonstrates **stack variable vs object reference mental model** correctly. Then deliberately introduce one realistic bug or misuse, reproduce it, fix it, and explain the code-review rule that would have caught it.
...
- [ ] I can define **stack variable vs object reference mental model** in plain English.
