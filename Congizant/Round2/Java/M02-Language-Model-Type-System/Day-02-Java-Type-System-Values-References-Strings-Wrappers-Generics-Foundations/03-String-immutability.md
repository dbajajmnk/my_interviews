...
**String immutability** is immutable character-sequence values.

---

# 2. Why

Interviewers ask **String immutability** to test whether you understand its Java semantics, internal behavior, failure modes, and when its trade-offs are justified—not only its definition.

---

# 3. Plain English

Plain English: **String immutability** is about immutable character-sequence values. Use it when the requirement matches that problem; otherwise prefer the simpler Java design.

---

# 4. Engineering Explanation

String literals may be interned; operations create new logical values. Within this day, the closest engineering anchor is **String Immutability**: `String` objects are immutable. Operations such as concatenation create new logical string values; compilers/JIT may optimize implementation details.
...
```java
String name = "java"; boolean same = name.equals("java");
```
...
- String literals may be interned; operations create new logical values
...
- Use **String immutability** only when its semantics fit the requirement.
...
1. Memorizing the definition of **String immutability** without understanding runtime behavior.
...
- First reproduce the symptom involving **String immutability**.
- Primary focus: use `.equals`, inspect concatenation in hot loops, and avoid identity assumptions.
...
- Does **String immutability** solve a real requirement or add accidental complexity?
...
- Ask whether AI-generated code uses **String immutability** correctly for the project's Java version.
...
2. Why would you use **String immutability**?
3. How does **String immutability** work internally at the level relevant to a Java engineer?
4. What is a common mistake with **String immutability**?
5. Where would **String immutability** appear in a real production system?
...
Create the smallest Java example that demonstrates **String immutability** correctly. Then deliberately introduce one realistic bug or misuse, reproduce it, fix it, and explain the code-review rule that would have caught it.
...
- [ ] I can define **String immutability** in plain English.
