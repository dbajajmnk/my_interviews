...
**equals/hashCode** is domain equality and hash-based collection contract.

---

# 2. Why

Interviewers ask **equals/hashCode** to test whether you understand its Java semantics, internal behavior, failure modes, and when its trade-offs are justified—not only its definition.

---

# 3. Plain English

Plain English: **equals/hashCode** is about domain equality and hash-based collection contract. Use it when the requirement matches that problem; otherwise prefer the simpler Java design.

---

# 4. Engineering Explanation

equal objects must have equal hash codes; hash collections use hash + equality. Within this day, the closest engineering anchor is **Primitive vs Reference**: Primitive variables contain primitive values; reference variables contain references to objects. Java passes both kinds of variable values by value.
...
```java
@Override public boolean equals(Object o) { return this == o || /* value check */ false; }
```
...
- equal objects must have equal hash codes; hash collections use hash + equality
...
- Use **equals/hashCode** only when its semantics fit the requirement.
...
1. Memorizing the definition of **equals/hashCode** without understanding runtime behavior.
...
- First reproduce the symptom involving **equals/hashCode**.
- Primary focus: test keys before/after mutation and equality symmetry/transitivity.
...
- Does **equals/hashCode** solve a real requirement or add accidental complexity?
...
- Ask whether AI-generated code uses **equals/hashCode** correctly for the project's Java version.
...
1. What is **equals/hashCode** in Java?
2. Why would you use **equals/hashCode**?
3. How does **equals/hashCode** work internally at the level relevant to a Java engineer?
4. What is a common mistake with **equals/hashCode**?
5. Where would **equals/hashCode** appear in a real production system?
...
Create the smallest Java example that demonstrates **equals/hashCode** correctly. Then deliberately introduce one realistic bug or misuse, reproduce it, fix it, and explain the code-review rule that would have caught it.
...
- [ ] I can define **equals/hashCode** in plain English.
