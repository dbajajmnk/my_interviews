...
**method references** is behavior values targeting single-abstract-method interfaces.

---

# 2. Why

Interviewers ask **method references** to test whether you understand its Java semantics, internal behavior, failure modes, and when its trade-offs are justified—not only its definition.

---

# 3. Plain English

Plain English: **method references** is about behavior values targeting single-abstract-method interfaces. Use it when the requirement matches that problem; otherwise prefer the simpler Java design.

---

# 4. Engineering Explanation

lambda body is compiled to an invokedynamic-based runtime form rather than a simple anonymous-class rewrite. Within this day, the closest engineering anchor is **Method Overloading**: Overloading is resolved at compile time using method signatures and applicable conversions.
...
- Use **method references** only when its semantics fit the requirement.
...
1. Memorizing the definition of **method references** without understanding runtime behavior.
...
- First reproduce the symptom involving **method references**.
...
- Does **method references** solve a real requirement or add accidental complexity?
...
- Ask whether AI-generated code uses **method references** correctly for the project's Java version.
...
1. What is **method references** in Java?
2. Why would you use **method references**?
3. How does **method references** work internally at the level relevant to a Java engineer?
4. What is a common mistake with **method references**?
5. Where would **method references** appear in a real production system?
...
Create the smallest Java example that demonstrates **method references** correctly. Then deliberately introduce one realistic bug or misuse, reproduce it, fix it, and explain the code-review rule that would have caught it.
...
- [ ] I can define **method references** in plain English.
