...
**abstract classes** is contracts and partial abstractions.

---

# 2. Why

Interviewers ask **abstract classes** to test whether you understand its Java semantics, internal behavior, failure modes, and when its trade-offs are justified—not only its definition.

---

# 3. Plain English

Plain English: **abstract classes** is about contracts and partial abstractions. Use it when the requirement matches that problem; otherwise prefer the simpler Java design.

---

# 4. Engineering Explanation

interfaces define capabilities; abstract classes may hold state/shared implementation. Within this day, the closest engineering anchor is **Interface vs Abstract Class**: Interfaces define capability/contract; abstract classes can share state and implementation. Choose based on modeling needs, not slogans.
...
- Use **abstract classes** only when its semantics fit the requirement.
...
1. Memorizing the definition of **abstract classes** without understanding runtime behavior.
...
- First reproduce the symptom involving **abstract classes**.
...
- Does **abstract classes** solve a real requirement or add accidental complexity?
...
- Ask whether AI-generated code uses **abstract classes** correctly for the project's Java version.
...
1. What is **abstract classes** in Java?
2. Why would you use **abstract classes**?
3. How does **abstract classes** work internally at the level relevant to a Java engineer?
4. What is a common mistake with **abstract classes**?
5. Where would **abstract classes** appear in a real production system?
...
Create the smallest Java example that demonstrates **abstract classes** correctly. Then deliberately introduce one realistic bug or misuse, reproduce it, fix it, and explain the code-review rule that would have caught it.
...
- [ ] I can define **abstract classes** in plain English.
