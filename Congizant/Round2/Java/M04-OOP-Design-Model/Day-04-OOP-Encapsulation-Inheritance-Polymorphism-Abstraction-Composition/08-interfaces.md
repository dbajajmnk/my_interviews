...
**interfaces** is contracts and partial abstractions.

---

# 2. Why

Interviewers ask **interfaces** to test whether you understand its Java semantics, internal behavior, failure modes, and when its trade-offs are justified—not only its definition.

---

# 3. Plain English

Plain English: **interfaces** is about contracts and partial abstractions. Use it when the requirement matches that problem; otherwise prefer the simpler Java design.

---

# 4. Engineering Explanation

interfaces define capabilities; abstract classes may hold state/shared implementation. Within this day, the closest engineering anchor is **Encapsulation**: Protect invariants by controlling state transitions rather than exposing fields directly.
...
- Use **interfaces** only when its semantics fit the requirement.
...
1. Memorizing the definition of **interfaces** without understanding runtime behavior.
...
- First reproduce the symptom involving **interfaces**.
...
- Does **interfaces** solve a real requirement or add accidental complexity?
...
- Ask whether AI-generated code uses **interfaces** correctly for the project's Java version.
...
1. What is **interfaces** in Java?
2. Why would you use **interfaces**?
3. How does **interfaces** work internally at the level relevant to a Java engineer?
4. What is a common mistake with **interfaces**?
5. Where would **interfaces** appear in a real production system?
...
Create the smallest Java example that demonstrates **interfaces** correctly. Then deliberately introduce one realistic bug or misuse, reproduce it, fix it, and explain the code-review rule that would have caught it.
