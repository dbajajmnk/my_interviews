...
**records awareness** is concise nominal data carrier.

---

# 2. Why

Interviewers ask **records awareness** to test whether you understand its Java semantics, internal behavior, failure modes, and when its trade-offs are justified—not only its definition.

---

# 3. Plain English

Plain English: **records awareness** is about concise nominal data carrier. Use it when the requirement matches that problem; otherwise prefer the simpler Java design.

---

# 4. Engineering Explanation

compiler generates final component fields, accessors, equality/hashCode/toString; component objects may still be mutable. Within this day, the closest engineering anchor is **Encapsulation**: Protect invariants by controlling state transitions rather than exposing fields directly.
...
- compiler generates final component fields, accessors, equality/hashCode/toString; component objects may still be mutable
...
- Use **records awareness** only when its semantics fit the requirement.
...
1. Memorizing the definition of **records awareness** without understanding runtime behavior.
...
- First reproduce the symptom involving **records awareness**.
- Primary focus: inspect shallow mutability and framework serialization/JPA fit.
...
- Does **records awareness** solve a real requirement or add accidental complexity?
...
- Ask whether AI-generated code uses **records awareness** correctly for the project's Java version.
...
1. What is **records awareness** in Java?
2. Why would you use **records awareness**?
3. How does **records awareness** work internally at the level relevant to a Java engineer?
4. What is a common mistake with **records awareness**?
5. Where would **records awareness** appear in a real production system?
...
Create the smallest Java example that demonstrates **records awareness** correctly. Then deliberately introduce one realistic bug or misuse, reproduce it, fix it, and explain the code-review rule that would have caught it.
...
- [ ] I can define **records awareness** in plain English.
