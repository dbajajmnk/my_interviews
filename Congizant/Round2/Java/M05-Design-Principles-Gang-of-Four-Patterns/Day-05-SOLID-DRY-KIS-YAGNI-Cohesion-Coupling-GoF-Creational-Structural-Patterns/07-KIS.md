...
**KIS** is keeping designs as simple as requirements allow.

---

# 2. Why

Interviewers ask **KIS** to test whether you understand its Java semantics, internal behavior, failure modes, and when its trade-offs are justified—not only its definition.

---

# 3. Plain English

Plain English: **KIS** is about keeping designs as simple as requirements allow. Use it when the requirement matches that problem; otherwise prefer the simpler Java design.

---

# 4. Engineering Explanation

simplicity reduces states, failure modes, and maintenance cost. Within this day, the closest engineering anchor is **SRP**: A module should have one cohesive reason to change—not merely one method.
...
```java
// Prefer a direct, readable design over unused abstraction.
```
...
- simplicity reduces states, failure modes, and maintenance cost
...
- Use **KIS** only when its semantics fit the requirement.
...
1. Memorizing the definition of **KIS** without understanding runtime behavior.
...
- First reproduce the symptom involving **KIS**.
- Primary focus: remove unnecessary layers/patterns after validating requirements.
...
- Does **KIS** solve a real requirement or add accidental complexity?
...
- Ask whether AI-generated code uses **KIS** correctly for the project's Java version.
...
1. What is **KIS** in Java?
2. Why would you use **KIS**?
3. How does **KIS** work internally at the level relevant to a Java engineer?
4. What is a common mistake with **KIS**?
5. Where would **KIS** appear in a real production system?
...
Create the smallest Java example that demonstrates **KIS** correctly. Then deliberately introduce one realistic bug or misuse, reproduce it, fix it, and explain the code-review rule that would have caught it.
...
- [ ] I can define **KIS** in plain English.
