...
**anti-patterns** is the Java engineering concept **anti-patterns** within GoF Behavioral Patterns & Pattern Trade-Off Defense.

---

# 2. Why

Interviewers ask **anti-patterns** to test whether you understand its Java semantics, internal behavior, failure modes, and when its trade-offs are justified—not only its definition.

---

# 3. Plain English

Plain English: **anti-patterns** is about the Java engineering concept **anti-patterns** within GoF Behavioral Patterns & Pattern Trade-Off Defense. Use it when the requirement matches that problem; otherwise prefer the simpler Java design.
...
- Use **anti-patterns** only when its semantics fit the requirement.
...
1. Memorizing the definition of **anti-patterns** without understanding runtime behavior.
...
- First reproduce the symptom involving **anti-patterns**.
- Primary focus: reproduce failures involving anti-patterns, capture runtime/compiler/test evidence, and isolate the smallest failing assumption.
...
- Does **anti-patterns** solve a real requirement or add accidental complexity?
...
- Ask whether AI-generated code uses **anti-patterns** correctly for the project's Java version.
...
1. What is **anti-patterns** in Java?
2. Why would you use **anti-patterns**?
3. How does **anti-patterns** work internally at the level relevant to a Java engineer?
4. What is a common mistake with **anti-patterns**?
5. Where would **anti-patterns** appear in a real production system?
...
Create the smallest Java example that demonstrates **anti-patterns** correctly. Then deliberately introduce one realistic bug or misuse, reproduce it, fix it, and explain the code-review rule that would have caught it.
...
- [ ] I can define **anti-patterns** in plain English.
