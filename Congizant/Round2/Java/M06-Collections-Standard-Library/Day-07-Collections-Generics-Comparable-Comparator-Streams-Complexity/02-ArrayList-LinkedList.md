...
**ArrayList/LinkedList** is resizable array-backed List.

---

# 2. Why

Interviewers ask **ArrayList/LinkedList** to test whether you understand its Java semantics, internal behavior, failure modes, and when its trade-offs are justified—not only its definition.

---

# 3. Plain English

Plain English: **ArrayList/LinkedList** is about resizable array-backed List. Use it when the requirement matches that problem; otherwise prefer the simpler Java design.

---

# 4. Engineering Explanation

indexed access is O(1) average; middle insertion/removal shifts elements. Within this day, the closest engineering anchor is **Collection Choice**: Choose from access pattern: indexed access, uniqueness, key lookup, ordering, priority, FIFO/LIFO.
...
- indexed access is O(1) average; middle insertion/removal shifts elements
...
In a Java/Spring production system, **ArrayList/LinkedList** appears in the context of **Collections, Generics, Comparable/Comparator, Streams & Complexity**. Connect it to the day's project concern: Implement word frequency, LRU-like access reasoning, top-K with PriorityQueue, deduplication with Set, and custom sorting with Comparator. State time/space complexity.
...
- Use **ArrayList/LinkedList** only when its semantics fit the requirement.
...
1. Memorizing the definition of **ArrayList/LinkedList** without understanding runtime behavior.
...
- First reproduce the symptom involving **ArrayList/LinkedList**.
- Primary focus: profile actual access pattern before choosing LinkedList.
...
- Does **ArrayList/LinkedList** solve a real requirement or add accidental complexity?
...
- Ask whether AI-generated code uses **ArrayList/LinkedList** correctly for the project's Java version.
...
1. What is **ArrayList/LinkedList** in Java?
2. Why would you use **ArrayList/LinkedList**?
3. How does **ArrayList/LinkedList** work internally at the level relevant to a Java engineer?
4. What is a common mistake with **ArrayList/LinkedList**?
5. Where would **ArrayList/LinkedList** appear in a real production system?
...
Create the smallest Java example that demonstrates **ArrayList/LinkedList** correctly. Then deliberately introduce one realistic bug or misuse, reproduce it, fix it, and explain the code-review rule that would have caught it.
...
- [ ] I can define **ArrayList/LinkedList** in plain English.
