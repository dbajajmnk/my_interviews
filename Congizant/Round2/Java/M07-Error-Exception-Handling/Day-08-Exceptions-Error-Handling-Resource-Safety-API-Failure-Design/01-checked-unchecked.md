...
**checked/unchecked** is Java throwable taxonomy and recovery contracts.

---

# 2. Why

Interviewers ask **checked/unchecked** to test whether you understand its Java semantics, internal behavior, failure modes, and when its trade-offs are justified—not only its definition.

---

# 3. Plain English

Plain English: **checked/unchecked** is about Java throwable taxonomy and recovery contracts. Use it when the requirement matches that problem; otherwise prefer the simpler Java design.

---

# 4. Engineering Explanation

checked exceptions participate in compile-time handling; runtime exceptions do not require declaration. Within this day, the closest engineering anchor is **Checked vs Unchecked**: Checked exceptions must be declared/handled; runtime exceptions generally represent programming/contract/domain failures that callers may not reasonably recover from locally.
...
- Use **checked/unchecked** only when its semantics fit the requirement.
...
1. Memorizing the definition of **checked/unchecked** without understanding runtime behavior.
...
- First reproduce the symptom involving **checked/unchecked**.
...
- Does **checked/unchecked** solve a real requirement or add accidental complexity?
...
- Ask whether AI-generated code uses **checked/unchecked** correctly for the project's Java version.
...
1. What is **checked/unchecked** in Java?
2. Why would you use **checked/unchecked**?
3. How does **checked/unchecked** work internally at the level relevant to a Java engineer?
4. What is a common mistake with **checked/unchecked**?
5. Where would **checked/unchecked** appear in a real production system?
...
Create the smallest Java example that demonstrates **checked/unchecked** correctly. Then deliberately introduce one realistic bug or misuse, reproduce it, fix it, and explain the code-review rule that would have caught it.
...
- [ ] I can define **checked/unchecked** in plain English.
