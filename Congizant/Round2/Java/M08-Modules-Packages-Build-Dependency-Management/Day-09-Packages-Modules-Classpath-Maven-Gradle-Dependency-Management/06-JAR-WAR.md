...
**JAR/WAR** is Java packaging formats.

---

# 2. Why

Interviewers ask **JAR/WAR** to test whether you understand its Java semantics, internal behavior, failure modes, and when its trade-offs are justified—not only its definition.

---

# 3. Plain English

Plain English: **JAR/WAR** is about Java packaging formats. Use it when the requirement matches that problem; otherwise prefer the simpler Java design.

---

# 4. Engineering Explanation

JAR packages classes/resources; WAR follows web-application packaging conventions. Within this day, the closest engineering anchor is **Packages**: Provide namespace and access boundary; package-private visibility is a useful design tool.
...
- Use **JAR/WAR** only when its semantics fit the requirement.
...
1. Memorizing the definition of **JAR/WAR** without understanding runtime behavior.
...
- First reproduce the symptom involving **JAR/WAR**.
...
- Does **JAR/WAR** solve a real requirement or add accidental complexity?
...
- Ask whether AI-generated code uses **JAR/WAR** correctly for the project's Java version.
...
1. What is **JAR/WAR** in Java?
2. Why would you use **JAR/WAR**?
3. How does **JAR/WAR** work internally at the level relevant to a Java engineer?
4. What is a common mistake with **JAR/WAR**?
5. Where would **JAR/WAR** appear in a real production system?
...
Create the smallest Java example that demonstrates **JAR/WAR** correctly. Then deliberately introduce one realistic bug or misuse, reproduce it, fix it, and explain the code-review rule that would have caught it.
...
- [ ] I can define **JAR/WAR** in plain English.
