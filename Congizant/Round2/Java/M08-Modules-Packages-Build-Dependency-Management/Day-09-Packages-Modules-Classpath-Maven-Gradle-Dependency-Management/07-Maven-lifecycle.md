...
**Maven lifecycle** is convention-based build/dependency lifecycle.

---

# 2. Why

Interviewers ask **Maven lifecycle** to test whether you understand its Java semantics, internal behavior, failure modes, and when its trade-offs are justified—not only its definition.

---

# 3. Plain English

Plain English: **Maven lifecycle** is about convention-based build/dependency lifecycle. Use it when the requirement matches that problem; otherwise prefer the simpler Java design.

---

# 4. Engineering Explanation

plugins bind goals to lifecycle phases and dependencies resolve by scopes/transitives. Within this day, the closest engineering anchor is **Maven**: Convention-based lifecycle: validate/compile/test/package/verify/install/deploy.
...
- plugins bind goals to lifecycle phases and dependencies resolve by scopes/transitives
...
- Use **Maven lifecycle** only when its semantics fit the requirement.
...
1. Memorizing the definition of **Maven lifecycle** without understanding runtime behavior.
...
- First reproduce the symptom involving **Maven lifecycle**.
- Primary focus: run clean build and dependency tree.
...
- Does **Maven lifecycle** solve a real requirement or add accidental complexity?
...
- Ask whether AI-generated code uses **Maven lifecycle** correctly for the project's Java version.
...
1. What is **Maven lifecycle** in Java?
2. Why would you use **Maven lifecycle**?
3. How does **Maven lifecycle** work internally at the level relevant to a Java engineer?
4. What is a common mistake with **Maven lifecycle**?
5. Where would **Maven lifecycle** appear in a real production system?
...
Create the smallest Java example that demonstrates **Maven lifecycle** correctly. Then deliberately introduce one realistic bug or misuse, reproduce it, fix it, and explain the code-review rule that would have caught it.
...
- [ ] I can define **Maven lifecycle** in plain English.
