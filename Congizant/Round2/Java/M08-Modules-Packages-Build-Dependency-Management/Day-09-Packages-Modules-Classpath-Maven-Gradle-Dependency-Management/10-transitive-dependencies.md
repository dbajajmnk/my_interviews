# Topic 10 — transitive dependencies
...
**transitive dependencies** is dependency graph resolution and visibility.

---

# 2. Why

Interviewers ask **transitive dependencies** to test whether you understand its Java semantics, internal behavior, failure modes, and when its trade-offs are justified—not only its definition.

---

# 3. Plain English

Plain English: **transitive dependencies** is about dependency graph resolution and visibility. Use it when the requirement matches that problem; otherwise prefer the simpler Java design.

---

# 4. Engineering Explanation

direct dependencies can pull transitives; conflict mediation determines effective runtime versions. Within this day, the closest engineering anchor is **Packages**: Provide namespace and access boundary; package-private visibility is a useful design tool.
...
- direct dependencies can pull transitives; conflict mediation determines effective runtime versions
...
- Use **transitive dependencies** only when its semantics fit the requirement.
...
1. Memorizing the definition of **transitive dependencies** without understanding runtime behavior.
...
- First reproduce the symptom involving **transitive dependencies**.
- Primary focus: inspect dependency tree and convergence.
...
- Does **transitive dependencies** solve a real requirement or add accidental complexity?
...
- Ask whether AI-generated code uses **transitive dependencies** correctly for the project's Java version.
...
1. What is **transitive dependencies** in Java?
2. Why would you use **transitive dependencies**?
3. How does **transitive dependencies** work internally at the level relevant to a Java engineer?
4. What is a common mistake with **transitive dependencies**?
5. Where would **transitive dependencies** appear in a real production system?
...
Create the smallest Java example that demonstrates **transitive dependencies** correctly. Then deliberately introduce one realistic bug or misuse, reproduce it, fix it, and explain the code-review rule that would have caught it.
...
- [ ] I can define **transitive dependencies** in plain English.
