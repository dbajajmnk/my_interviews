...
**heap/stack/metaspace** is JVM memory ownership and reachability.

---

# 2. Why

Interviewers ask **heap/stack/metaspace** to test whether you understand its Java semantics, internal behavior, failure modes, and when its trade-offs are justified—not only its definition.

---

# 3. Plain English

Plain English: **heap/stack/metaspace** is about JVM memory ownership and reachability. Use it when the requirement matches that problem; otherwise prefer the simpler Java design.
...
- Use **heap/stack/metaspace** only when its semantics fit the requirement.
...
1. Memorizing the definition of **heap/stack/metaspace** without understanding runtime behavior.
...
- First reproduce the symptom involving **heap/stack/metaspace**.
...
- Does **heap/stack/metaspace** solve a real requirement or add accidental complexity?
...
- Ask whether AI-generated code uses **heap/stack/metaspace** correctly for the project's Java version.
...
1. What is **heap/stack/metaspace** in Java?
2. Why would you use **heap/stack/metaspace**?
3. How does **heap/stack/metaspace** work internally at the level relevant to a Java engineer?
4. What is a common mistake with **heap/stack/metaspace**?
5. Where would **heap/stack/metaspace** appear in a real production system?
...
Create the smallest Java example that demonstrates **heap/stack/metaspace** correctly. Then deliberately introduce one realistic bug or misuse, reproduce it, fix it, and explain the code-review rule that would have caught it.
...
- [ ] I can define **heap/stack/metaspace** in plain English.
