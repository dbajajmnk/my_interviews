...
**NIO awareness** is Java packaging formats.

---

# 2. Why

Interviewers ask **NIO awareness** to test whether you understand its Java semantics, internal behavior, failure modes, and when its trade-offs are justified—not only its definition.

---

# 3. Plain English

Plain English: **NIO awareness** is about Java packaging formats. Use it when the requirement matches that problem; otherwise prefer the simpler Java design.

---

# 4. Engineering Explanation

JAR packages classes/resources; WAR follows web-application packaging conventions. Within this day, the closest engineering anchor is **NIO.2**: `Path`/`Files` provide modern filesystem APIs and useful streaming/async capabilities.
...
- Use **NIO awareness** only when its semantics fit the requirement.
...
1. Memorizing the definition of **NIO awareness** without understanding runtime behavior.
...
- First reproduce the symptom involving **NIO awareness**.
...
- Does **NIO awareness** solve a real requirement or add accidental complexity?
...
- Ask whether AI-generated code uses **NIO awareness** correctly for the project's Java version.
...
1. What is **NIO awareness** in Java?
2. Why would you use **NIO awareness**?
3. How does **NIO awareness** work internally at the level relevant to a Java engineer?
4. What is a common mistake with **NIO awareness**?
5. Where would **NIO awareness** appear in a real production system?
...
Create the smallest Java example that demonstrates **NIO awareness** correctly. Then deliberately introduce one realistic bug or misuse, reproduce it, fix it, and explain the code-review rule that would have caught it.
...
- [ ] I can define **NIO awareness** in plain English.
