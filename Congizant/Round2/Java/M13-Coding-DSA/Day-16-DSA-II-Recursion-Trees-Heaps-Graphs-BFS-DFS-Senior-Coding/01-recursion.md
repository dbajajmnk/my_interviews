...
**recursion** is self-referential problem decomposition.

---

# 2. Why

Interviewers ask **recursion** to test whether you understand its Java semantics, internal behavior, failure modes, and when its trade-offs are justified—not only its definition.

---

# 3. Plain English

Plain English: **recursion** is about self-referential problem decomposition. Use it when the requirement matches that problem; otherwise prefer the simpler Java design.

---

# 4. Engineering Explanation

each call creates a stack frame until base case unwinds. Within this day, the closest engineering anchor is **Recursion**: Needs base case, progress, and stack-depth awareness.
...
- each call creates a stack frame until base case unwinds
...
In a Java/Spring production system, **recursion** appears in the context of **DSA II: Recursion, Trees, Heaps, Graphs, BFS/DFS & Senior Coding**. Connect it to the day's project concern: Implement tree depth, level-order traversal, top-K frequent elements, graph reachability, cycle detection, and dependency ordering. State time/space complexity.
...
- Use **recursion** only when its semantics fit the requirement.
...
1. Memorizing the definition of **recursion** without understanding runtime behavior.
...
- First reproduce the symptom involving **recursion**.
- Primary focus: check base case/progress and stack depth.
...
- Does **recursion** solve a real requirement or add accidental complexity?
...
- Ask whether AI-generated code uses **recursion** correctly for the project's Java version.
...
2. Why would you use **recursion**?
3. How does **recursion** work internally at the level relevant to a Java engineer?
4. What is a common mistake with **recursion**?
5. Where would **recursion** appear in a real production system?
...
Create the smallest Java example that demonstrates **recursion** correctly. Then deliberately introduce one realistic bug or misuse, reproduce it, fix it, and explain the code-review rule that would have caught it.
...
- [ ] I can define **recursion** in plain English.
