...
**BST awareness** is Java packaging formats.

---

# 2. Why

Interviewers ask **BST awareness** to test whether you understand its Java semantics, internal behavior, failure modes, and when its trade-offs are justified—not only its definition.

---

# 3. Plain English

Plain English: **BST awareness** is about Java packaging formats. Use it when the requirement matches that problem; otherwise prefer the simpler Java design.

---

# 4. Engineering Explanation

JAR packages classes/resources; WAR follows web-application packaging conventions. Within this day, the closest engineering anchor is **Recursion**: Needs base case, progress, and stack-depth awareness.
...
In a Java/Spring production system, **BST awareness** appears in the context of **DSA II: Recursion, Trees, Heaps, Graphs, BFS/DFS & Senior Coding**. Connect it to the day's project concern: Implement tree depth, level-order traversal, top-K frequent elements, graph reachability, cycle detection, and dependency ordering. State time/space complexity.
...
- Use **BST awareness** only when its semantics fit the requirement.
...
1. Memorizing the definition of **BST awareness** without understanding runtime behavior.
...
- First reproduce the symptom involving **BST awareness**.
...
- Does **BST awareness** solve a real requirement or add accidental complexity?
...
- Ask whether AI-generated code uses **BST awareness** correctly for the project's Java version.
...
1. What is **BST awareness** in Java?
2. Why would you use **BST awareness**?
3. How does **BST awareness** work internally at the level relevant to a Java engineer?
4. What is a common mistake with **BST awareness**?
5. Where would **BST awareness** appear in a real production system?
...
Create the smallest Java example that demonstrates **BST awareness** correctly. Then deliberately introduce one realistic bug or misuse, reproduce it, fix it, and explain the code-review rule that would have caught it.
...
- [ ] I can define **BST awareness** in plain English.
