...
**DFS** is depth-first traversal.

---

# 2. Why

Interviewers ask **DFS** to test whether you understand its Java semantics, internal behavior, failure modes, and when its trade-offs are justified—not only its definition.

---

# 3. Plain English

Plain English: **DFS** is about depth-first traversal. Use it when the requirement matches that problem; otherwise prefer the simpler Java design.

---

# 4. Engineering Explanation

stack/recursion follows a branch before backtracking. Within this day, the closest engineering anchor is **Recursion**: Needs base case, progress, and stack-depth awareness.
...
- stack/recursion follows a branch before backtracking
...
In a Java/Spring production system, **DFS** appears in the context of **DSA II: Recursion, Trees, Heaps, Graphs, BFS/DFS & Senior Coding**. Connect it to the day's project concern: Implement tree depth, level-order traversal, top-K frequent elements, graph reachability, cycle detection, and dependency ordering. State time/space complexity.
...
- Use **DFS** only when its semantics fit the requirement.
...
1. Memorizing the definition of **DFS** without understanding runtime behavior.
...
- First reproduce the symptom involving **DFS**.
- Primary focus: guard cycles and recursion depth.
...
- Does **DFS** solve a real requirement or add accidental complexity?
...
- Ask whether AI-generated code uses **DFS** correctly for the project's Java version.
...
1. What is **DFS** in Java?
2. Why would you use **DFS**?
3. How does **DFS** work internally at the level relevant to a Java engineer?
4. What is a common mistake with **DFS**?
5. Where would **DFS** appear in a real production system?
...
Create the smallest Java example that demonstrates **DFS** correctly. Then deliberately introduce one realistic bug or misuse, reproduce it, fix it, and explain the code-review rule that would have caught it.
