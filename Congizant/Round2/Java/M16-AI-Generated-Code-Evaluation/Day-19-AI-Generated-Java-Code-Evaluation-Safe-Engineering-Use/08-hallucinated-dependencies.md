# Topic 08 — hallucinated dependencies
...
**hallucinated dependencies** is the Java engineering concept **hallucinated dependencies** within AI-Generated Java Code Evaluation & Safe Engineering Use.

---

# 2. Why

Interviewers ask **hallucinated dependencies** to test whether you understand its Java semantics, internal behavior, failure modes, and when its trade-offs are justified—not only its definition.

---

# 3. Plain English

Plain English: **hallucinated dependencies** is about the Java engineering concept **hallucinated dependencies** within AI-Generated Java Code Evaluation & Safe Engineering Use. Use it when the requirement matches that problem; otherwise prefer the simpler Java design.

---

# 4. Engineering Explanation

AI-generated code should be treated like code from an unknown contributor.. Within this day, the closest engineering anchor is **Untrusted Proposal**: AI-generated code should be treated like code from an unknown contributor.
...
```java
// AI-generated code: spot the bug.
private static final Map<String, String> CACHE = new HashMap<>();

public static String get(String key) {
    return CACHE.computeIfAbsent(key, k -> loadRemote(k));
}

// Questions:
// 1. Thread safety?
// 2. Unbounded growth?
// 3. Remote call inside map computation?
// 4. Timeout/failure/cache stampede?
```
...
- AI-generated code should be treated like code from an unknown contributor.
...
- Use **hallucinated dependencies** only when its semantics fit the requirement.
...
1. Memorizing the definition of **hallucinated dependencies** without understanding runtime behavior.
...
- First reproduce the symptom involving **hallucinated dependencies**.
- Primary focus: reproduce failures involving hallucinated dependencies, capture runtime/compiler/test evidence, and isolate the smallest failing assumption.
...
- Does **hallucinated dependencies** solve a real requirement or add accidental complexity?
...
- Ask whether AI-generated code uses **hallucinated dependencies** correctly for the project's Java version.
...
1. What is **hallucinated dependencies** in Java?
2. Why would you use **hallucinated dependencies**?
3. How does **hallucinated dependencies** work internally at the level relevant to a Java engineer?
4. What is a common mistake with **hallucinated dependencies**?
5. Where would **hallucinated dependencies** appear in a real production system?
...
Create the smallest Java example that demonstrates **hallucinated dependencies** correctly. Then deliberately introduce one realistic bug or misuse, reproduce it, fix it, and explain the code-review rule that would have caught it.
...
- [ ] I can define **hallucinated dependencies** in plain English.
