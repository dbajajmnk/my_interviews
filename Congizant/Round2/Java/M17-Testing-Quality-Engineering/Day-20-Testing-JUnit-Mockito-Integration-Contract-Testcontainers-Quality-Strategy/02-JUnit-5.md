...
**JUnit 5** is Java unit-test framework concepts.

---

# 2. Why

Interviewers ask **JUnit 5** to test whether you understand its Java semantics, internal behavior, failure modes, and when its trade-offs are justified—not only its definition.

---

# 3. Plain English

Plain English: **JUnit 5** is about Java unit-test framework concepts. Use it when the requirement matches that problem; otherwise prefer the simpler Java design.
...
- Use **JUnit 5** only when its semantics fit the requirement.
...
1. Memorizing the definition of **JUnit 5** without understanding runtime behavior.
...
- First reproduce the symptom involving **JUnit 5**.
...
- Does **JUnit 5** solve a real requirement or add accidental complexity?
...
- Ask whether AI-generated code uses **JUnit 5** correctly for the project's Java version.
...
1. What is **JUnit 5** in Java?
2. Why would you use **JUnit 5**?
3. How does **JUnit 5** work internally at the level relevant to a Java engineer?
4. What is a common mistake with **JUnit 5**?
5. Where would **JUnit 5** appear in a real production system?
...
Create the smallest Java example that demonstrates **JUnit 5** correctly. Then deliberately introduce one realistic bug or misuse, reproduce it, fix it, and explain the code-review rule that would have caught it.
...
- [ ] I can define **JUnit 5** in plain English.
