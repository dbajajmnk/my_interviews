...
**Mockito** is test doubles for collaboration boundaries.

---

# 2. Why

Interviewers ask **Mockito** to test whether you understand its Java semantics, internal behavior, failure modes, and when its trade-offs are justified—not only its definition.

---

# 3. Plain English

Plain English: **Mockito** is about test doubles for collaboration boundaries. Use it when the requirement matches that problem; otherwise prefer the simpler Java design.
...
- Use **Mockito** only when its semantics fit the requirement.
...
1. Memorizing the definition of **Mockito** without understanding runtime behavior.
...
- First reproduce the symptom involving **Mockito**.
...
- Does **Mockito** solve a real requirement or add accidental complexity?
...
- Ask whether AI-generated code uses **Mockito** correctly for the project's Java version.
...
1. What is **Mockito** in Java?
2. Why would you use **Mockito**?
3. How does **Mockito** work internally at the level relevant to a Java engineer?
4. What is a common mistake with **Mockito**?
5. Where would **Mockito** appear in a real production system?
...
Create the smallest Java example that demonstrates **Mockito** correctly. Then deliberately introduce one realistic bug or misuse, reproduce it, fix it, and explain the code-review rule that would have caught it.
...
- [ ] I can define **Mockito** in plain English.
