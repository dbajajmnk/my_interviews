...
**fakes vs mocks** is test doubles for collaboration boundaries.

---

# 2. Why

Interviewers ask **fakes vs mocks** to test whether you understand its Java semantics, internal behavior, failure modes, and when its trade-offs are justified—not only its definition.

---

# 3. Plain English

Plain English: **fakes vs mocks** is about test doubles for collaboration boundaries. Use it when the requirement matches that problem; otherwise prefer the simpler Java design.

---

# 4. Engineering Explanation

mock records/stubs interactions while fakes provide working lightweight behavior. Within this day, the closest engineering anchor is **Unit Test**: Fast isolated behavior test.
...
- mock records/stubs interactions while fakes provide working lightweight behavior
...
- Use **fakes vs mocks** only when its semantics fit the requirement.
...
1. Memorizing the definition of **fakes vs mocks** without understanding runtime behavior.
...
- First reproduce the symptom involving **fakes vs mocks**.
- Primary focus: avoid mocking the implementation itself.
...
- Does **fakes vs mocks** solve a real requirement or add accidental complexity?
...
- Ask whether AI-generated code uses **fakes vs mocks** correctly for the project's Java version.
...
1. What is **fakes vs mocks** in Java?
2. Why would you use **fakes vs mocks**?
3. How does **fakes vs mocks** work internally at the level relevant to a Java engineer?
4. What is a common mistake with **fakes vs mocks**?
5. Where would **fakes vs mocks** appear in a real production system?
...
Create the smallest Java example that demonstrates **fakes vs mocks** correctly. Then deliberately introduce one realistic bug or misuse, reproduce it, fix it, and explain the code-review rule that would have caught it.
...
- [ ] I can define **fakes vs mocks** in plain English.
