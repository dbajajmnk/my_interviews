...
**IoC/DI** is container-managed dependency wiring.

---

# 2. Why

Interviewers ask **IoC/DI** to test whether you understand its Java semantics, internal behavior, failure modes, and when its trade-offs are justified—not only its definition.

---

# 3. Plain English

Plain English: **IoC/DI** is about container-managed dependency wiring. Use it when the requirement matches that problem; otherwise prefer the simpler Java design.

---

# 4. Engineering Explanation

Spring resolves bean definitions and injects collaborators; proxies may add cross-cutting behavior. Within this day, the closest engineering anchor is **IoC / DI**: Application receives dependencies from container rather than constructing infrastructure directly.
...
```java
@Service class OrderService { OrderService(OrderRepository repo) {} }
```
...
- Spring resolves bean definitions and injects collaborators; proxies may add cross-cutting behavior
...
- Use **IoC/DI** only when its semantics fit the requirement.
...
1. Memorizing the definition of **IoC/DI** without understanding runtime behavior.
...
- First reproduce the symptom involving **IoC/DI**.
- Primary focus: trace bean creation and dependency graph.
...
- Does **IoC/DI** solve a real requirement or add accidental complexity?
...
- Ask whether AI-generated code uses **IoC/DI** correctly for the project's Java version.
...
1. What is **IoC/DI** in Java?
2. Why would you use **IoC/DI**?
3. How does **IoC/DI** work internally at the level relevant to a Java engineer?
4. What is a common mistake with **IoC/DI**?
5. Where would **IoC/DI** appear in a real production system?
...
Create the smallest Java example that demonstrates **IoC/DI** correctly. Then deliberately introduce one realistic bug or misuse, reproduce it, fix it, and explain the code-review rule that would have caught it.
...
- [ ] I can define **IoC/DI** in plain English.
