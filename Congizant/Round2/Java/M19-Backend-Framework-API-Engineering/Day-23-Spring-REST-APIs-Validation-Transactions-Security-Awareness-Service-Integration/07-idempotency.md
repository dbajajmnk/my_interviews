...
server persists/recognizes a client/business idempotency key and returns/reconciles prior outcome. Within this day, the closest engineering anchor is **Idempotency**: State-changing retried requests may require idempotency keys/business uniqueness.
