...
DB isolation/locking/MVCC and commit/rollback preserve specified invariants. Within this day, the closest engineering anchor is **Controller Contract**: Controller maps HTTP contract to application use case; domain logic remains elsewhere.
