...
bounded queues/semaphores/rate limits prevent unbounded in-flight growth. Within this day, the closest engineering anchor is **Timeout**: Every remote call needs bounded waiting.
