...
**Docker** is packaged isolated application runtime.

---

# 2. Why

Interviewers ask **Docker** to test whether you understand its Java semantics, internal behavior, failure modes, and when its trade-offs are justified—not only its definition.

---

# 3. Plain English

Plain English: **Docker** is about packaged isolated application runtime. Use it when the requirement matches that problem; otherwise prefer the simpler Java design.
...
- Use **Docker** only when its semantics fit the requirement.
...
1. Memorizing the definition of **Docker** without understanding runtime behavior.
...
- First reproduce the symptom involving **Docker**.
...
- Does **Docker** solve a real requirement or add accidental complexity?
...
- Ask whether AI-generated code uses **Docker** correctly for the project's Java version.
...
1. What is **Docker** in Java?
2. Why would you use **Docker**?
3. How does **Docker** work internally at the level relevant to a Java engineer?
4. What is a common mistake with **Docker**?
5. Where would **Docker** appear in a real production system?
...
Create the smallest Java example that demonstrates **Docker** correctly. Then deliberately introduce one realistic bug or misuse, reproduce it, fix it, and explain the code-review rule that would have caught it.
...
- [ ] I can define **Docker** in plain English.
