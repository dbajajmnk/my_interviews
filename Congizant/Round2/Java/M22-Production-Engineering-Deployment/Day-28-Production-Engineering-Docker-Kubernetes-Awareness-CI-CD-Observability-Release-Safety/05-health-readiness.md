...
**health/readiness** is orchestrated replica lifecycle and traffic readiness.

---

# 2. Why

Interviewers ask **health/readiness** to test whether you understand its Java semantics, internal behavior, failure modes, and when its trade-offs are justified—not only its definition.

---

# 3. Plain English

Plain English: **health/readiness** is about orchestrated replica lifecycle and traffic readiness. Use it when the requirement matches that problem; otherwise prefer the simpler Java design.

---

# 4. Engineering Explanation

controllers maintain replicas; readiness gates traffic, liveness can trigger restart. Within this day, the closest engineering anchor is **Container**: Packages app/runtime/dependencies with resource boundaries; JVM must respect container CPU/memory constraints.
...
- Use **health/readiness** only when its semantics fit the requirement.
...
1. Memorizing the definition of **health/readiness** without understanding runtime behavior.
...
- First reproduce the symptom involving **health/readiness**.
...
- Does **health/readiness** solve a real requirement or add accidental complexity?
...
- Ask whether AI-generated code uses **health/readiness** correctly for the project's Java version.
...
1. What is **health/readiness** in Java?
2. Why would you use **health/readiness**?
3. How does **health/readiness** work internally at the level relevant to a Java engineer?
4. What is a common mistake with **health/readiness**?
5. Where would **health/readiness** appear in a real production system?
...
Create the smallest Java example that demonstrates **health/readiness** correctly. Then deliberately introduce one realistic bug or misuse, reproduce it, fix it, and explain the code-review rule that would have caught it.
...
- [ ] I can define **health/readiness** in plain English.
