...
**CI/CD** is controlled promotion of a tested artifact into production.

---

# 2. Why

Interviewers ask **CI/CD** to test whether you understand its Java semantics, internal behavior, failure modes, and when its trade-offs are justified—not only its definition.

---

# 3. Plain English

Plain English: **CI/CD** is about controlled promotion of a tested artifact into production. Use it when the requirement matches that problem; otherwise prefer the simpler Java design.

---

# 4. Engineering Explanation

immutable artifacts pass gates; staged rollout limits blast radius; rollback requires compatibility. Within this day, the closest engineering anchor is **CI/CD**: Build/test/scan/package/deploy with immutable artifacts and gates.
...
- Use **CI/CD** only when its semantics fit the requirement.
...
1. Memorizing the definition of **CI/CD** without understanding runtime behavior.
...
- First reproduce the symptom involving **CI/CD**.
...
- Does **CI/CD** solve a real requirement or add accidental complexity?
...
- Ask whether AI-generated code uses **CI/CD** correctly for the project's Java version.
...
1. What is **CI/CD** in Java?
2. Why would you use **CI/CD**?
3. How does **CI/CD** work internally at the level relevant to a Java engineer?
4. What is a common mistake with **CI/CD**?
5. Where would **CI/CD** appear in a real production system?
...
Create the smallest Java example that demonstrates **CI/CD** correctly. Then deliberately introduce one realistic bug or misuse, reproduce it, fix it, and explain the code-review rule that would have caught it.
...
- [ ] I can define **CI/CD** in plain English.
