...
**DR awareness** is Java packaging formats.

---

# 2. Why

Interviewers ask **DR awareness** to test whether you understand its Java semantics, internal behavior, failure modes, and when its trade-offs are justified—not only its definition.

---

# 3. Plain English

Plain English: **DR awareness** is about Java packaging formats. Use it when the requirement matches that problem; otherwise prefer the simpler Java design.

---

# 4. Engineering Explanation

JAR packages classes/resources; WAR follows web-application packaging conventions. Within this day, the closest engineering anchor is **Kubernetes Awareness**: Deployment manages replicas; Service provides discovery; probes control lifecycle/traffic; ConfigMap/Secret separate config.
...
- Use **DR awareness** only when its semantics fit the requirement.
...
1. Memorizing the definition of **DR awareness** without understanding runtime behavior.
...
- First reproduce the symptom involving **DR awareness**.
...
- Does **DR awareness** solve a real requirement or add accidental complexity?
...
- Ask whether AI-generated code uses **DR awareness** correctly for the project's Java version.
...
1. What is **DR awareness** in Java?
2. Why would you use **DR awareness**?
3. How does **DR awareness** work internally at the level relevant to a Java engineer?
4. What is a common mistake with **DR awareness**?
5. Where would **DR awareness** appear in a real production system?
...
Create the smallest Java example that demonstrates **DR awareness** correctly. Then deliberately introduce one realistic bug or misuse, reproduce it, fix it, and explain the code-review rule that would have caught it.
...
- [ ] I can define **DR awareness** in plain English.
