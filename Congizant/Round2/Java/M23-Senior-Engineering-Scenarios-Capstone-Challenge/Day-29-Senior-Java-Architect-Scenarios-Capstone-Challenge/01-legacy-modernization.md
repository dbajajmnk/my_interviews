...
**legacy modernization** is evolution of legacy architecture based on measured pain.

---

# 2. Why

Interviewers ask **legacy modernization** to test whether you understand its Java semantics, internal behavior, failure modes, and when its trade-offs are justified—not only its definition.

---

# 3. Plain English

Plain English: **legacy modernization** is about evolution of legacy architecture based on measured pain. Use it when the requirement matches that problem; otherwise prefer the simpler Java design.

---

# 4. Engineering Explanation

stabilize/test/observe, modularize, then migrate/extract selectively. Within this day, the closest engineering anchor is **Modernization**: Stabilize and modularize before rewriting; use strangler selectively.
...
- Use **legacy modernization** only when its semantics fit the requirement.
...
1. Memorizing the definition of **legacy modernization** without understanding runtime behavior.
...
- First reproduce the symptom involving **legacy modernization**.
...
- Does **legacy modernization** solve a real requirement or add accidental complexity?
...
- Ask whether AI-generated code uses **legacy modernization** correctly for the project's Java version.
...
1. What is **legacy modernization** in Java?
2. Why would you use **legacy modernization**?
3. How does **legacy modernization** work internally at the level relevant to a Java engineer?
4. What is a common mistake with **legacy modernization**?
5. Where would **legacy modernization** appear in a real production system?
...
Create the smallest Java example that demonstrates **legacy modernization** correctly. Then deliberately introduce one realistic bug or misuse, reproduce it, fix it, and explain the code-review rule that would have caught it.
...
- [ ] I can define **legacy modernization** in plain English.
