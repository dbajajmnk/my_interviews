...
**performance incident** is structured production response.

---

# 2. Why

Interviewers ask **performance incident** to test whether you understand its Java semantics, internal behavior, failure modes, and when its trade-offs are justified—not only its definition.

---

# 3. Plain English

Plain English: **performance incident** is about structured production response. Use it when the requirement matches that problem; otherwise prefer the simpler Java design.

---

# 4. Engineering Explanation

containment restores safety while evidence leads to root cause and prevention. Within this day, the closest engineering anchor is **Incident**: Contain impact before long-term redesign.
...
```java
// impact → contain → evidence → fix → verify → prevent
```
...
- containment restores safety while evidence leads to root cause and prevention
...
- Use **performance incident** only when its semantics fit the requirement.
...
1. Memorizing the definition of **performance incident** without understanding runtime behavior.
...
- First reproduce the symptom involving **performance incident**.
- Primary focus: preserve evidence before destructive changes.
...
- Does **performance incident** solve a real requirement or add accidental complexity?
...
- Ask whether AI-generated code uses **performance incident** correctly for the project's Java version.
...
1. What is **performance incident** in Java?
2. Why would you use **performance incident**?
3. How does **performance incident** work internally at the level relevant to a Java engineer?
4. What is a common mistake with **performance incident**?
5. Where would **performance incident** appear in a real production system?
...
Create the smallest Java example that demonstrates **performance incident** correctly. Then deliberately introduce one realistic bug or misuse, reproduce it, fix it, and explain the code-review rule that would have caught it.
...
- [ ] I can define **performance incident** in plain English.
