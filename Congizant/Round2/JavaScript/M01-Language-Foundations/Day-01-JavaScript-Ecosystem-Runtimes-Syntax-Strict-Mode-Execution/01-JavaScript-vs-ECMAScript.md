# Topic 01 — JavaScript vs ECMAScript
...
**JavaScript vs ECMAScript** is distinguishing the language standard from runtime implementations.

---

# 2. Why

Interviewers use **JavaScript vs ECMAScript** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: JavaScript vs ECMAScript means distinguishing the language standard from runtime implementations. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.

---

# 4. Engineering Explanation

ECMAScript defines language semantics; JavaScript is the implementation/ecosystem term used by engines and hosts A senior answer separates **ECMAScript language guarantees**, **browser/Node host behavior**, and **engine/framework implementation details**.
...
- ECMAScript defines language semantics; JavaScript is the implementation/ecosystem term used by engines and hosts
...
In real projects, this matters for runtime capability questions.
...
- Use **JavaScript vs ECMAScript** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **JavaScript vs ECMAScript** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **JavaScript vs ECMAScript**.
...
- Does **JavaScript vs ECMAScript** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **JavaScript vs ECMAScript** is valid for the target runtime and module system.
...
1. What is **JavaScript vs ECMAScript**?
2. Why would you use **JavaScript vs ECMAScript** in JavaScript?
3. How does **JavaScript vs ECMAScript** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **JavaScript vs ECMAScript**?
5. Where does **JavaScript vs ECMAScript** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **JavaScript vs ECMAScript**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **JavaScript vs ECMAScript** in plain English.
