# Topic 02 — Browser vs Node.js runtime
...
**Browser vs Node.js runtime** is distinguishing host runtime capabilities.

---

# 2. Why

Interviewers use **Browser vs Node.js runtime** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Browser vs Node.js runtime means distinguishing host runtime capabilities. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.

---

# 4. Engineering Explanation

both execute ECMAScript, but browsers provide DOM/Web APIs while Node provides server/process/filesystem APIs A senior answer separates **ECMAScript language guarantees**, **browser/Node host behavior**, and **engine/framework implementation details**.
...
- both execute ECMAScript, but browsers provide DOM/Web APIs while Node provides server/process/filesystem APIs
...
In real projects, this matters for portable code and host-specific integrations.
...
- Use **Browser vs Node.js runtime** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Browser vs Node.js runtime** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Browser vs Node.js runtime**.
...
- Does **Browser vs Node.js runtime** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Browser vs Node.js runtime** is valid for the target runtime and module system.
...
1. What is **Browser vs Node.js runtime**?
2. Why would you use **Browser vs Node.js runtime** in JavaScript?
3. How does **Browser vs Node.js runtime** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Browser vs Node.js runtime**?
5. Where does **Browser vs Node.js runtime** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Browser vs Node.js runtime**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Browser vs Node.js runtime** in plain English.
