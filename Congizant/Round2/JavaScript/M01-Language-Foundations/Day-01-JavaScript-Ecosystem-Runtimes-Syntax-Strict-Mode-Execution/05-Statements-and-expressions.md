# Topic 05 — Statements and expressions
...
**Statements and expressions** is minimal Node web framework awareness.

---

# 2. Why

Interviewers use **Statements and expressions** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Statements and expressions means minimal Node web framework awareness. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.

---

# 4. Engineering Explanation

middleware/router stack processes requests; application architecture still depends on your boundaries A senior answer separates **ECMAScript language guarantees**, **browser/Node host behavior**, and **engine/framework implementation details**.
...
- middleware/router stack processes requests; application architecture still depends on your boundaries
...
In real projects, this matters for Node backend interviews.
...
- Use **Statements and expressions** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Statements and expressions** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Statements and expressions**.
...
- Does **Statements and expressions** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Statements and expressions** is valid for the target runtime and module system.
...
1. What is **Statements and expressions**?
2. Why would you use **Statements and expressions** in JavaScript?
3. How does **Statements and expressions** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Statements and expressions**?
5. Where does **Statements and expressions** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Statements and expressions**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Statements and expressions** in plain English.
