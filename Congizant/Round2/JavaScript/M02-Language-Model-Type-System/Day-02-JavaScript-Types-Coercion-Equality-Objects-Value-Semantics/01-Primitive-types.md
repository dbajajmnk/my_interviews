...
**Primitive types** is JavaScript primitive values.

---

# 2. Why

Interviewers use **Primitive types** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Primitive types means JavaScript primitive values. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.

---

# 4. Engineering Explanation

primitives are immutable value types: undefined, null, boolean, number, bigint, string, symbol A senior answer separates **ECMAScript language guarantees**, **browser/Node host behavior**, and **engine/framework implementation details**.
...
- primitives are immutable value types: undefined, null, boolean, number, bigint, string, symbol
...
In real projects, this matters for type/equality questions.
...
- Use **Primitive types** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Primitive types** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Primitive types**.
...
- Does **Primitive types** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Primitive types** is valid for the target runtime and module system.
...
2. Why would you use **Primitive types** in JavaScript?
3. How does **Primitive types** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Primitive types**?
5. Where does **Primitive types** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Primitive types**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Primitive types** in plain English.
