...
**undefined vs null** is two distinct absence-like values.

---

# 2. Why

Interviewers use **undefined vs null** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: undefined vs null means two distinct absence-like values. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.

---

# 4. Engineering Explanation

undefined commonly means missing/uninitialized; null is an explicit null value A senior answer separates **ECMAScript language guarantees**, **browser/Node host behavior**, and **engine/framework implementation details**.
...
```javascript
const missing = undefined; const empty = null;
```
...
- undefined commonly means missing/uninitialized; null is an explicit null value
...
In real projects, this matters for API contracts and validation.
...
- Use **undefined vs null** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **undefined vs null** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **undefined vs null**.
...
- Does **undefined vs null** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **undefined vs null** is valid for the target runtime and module system.
...
1. What is **undefined vs null**?
2. Why would you use **undefined vs null** in JavaScript?
3. How does **undefined vs null** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **undefined vs null**?
5. Where does **undefined vs null** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **undefined vs null**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **undefined vs null** in plain English.
