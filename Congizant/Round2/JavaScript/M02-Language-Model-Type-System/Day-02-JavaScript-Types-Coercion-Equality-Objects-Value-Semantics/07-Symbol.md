...
**Symbol** is unique primitive property-key values.

---

# 2. Why

Interviewers use **Symbol** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Symbol means unique primitive property-key values. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
- Use **Symbol** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Symbol** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Symbol**.
...
- Does **Symbol** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Symbol** is valid for the target runtime and module system.
...
1. What is **Symbol**?
2. Why would you use **Symbol** in JavaScript?
3. How does **Symbol** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Symbol**?
5. Where does **Symbol** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Symbol**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Symbol** in plain English.
