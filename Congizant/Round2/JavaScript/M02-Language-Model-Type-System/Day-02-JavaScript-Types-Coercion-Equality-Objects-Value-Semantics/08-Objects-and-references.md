# Topic 08 — Objects and references
...
**Objects and references** is reference-based object identity and mutation.

---

# 2. Why

Interviewers use **Objects and references** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Objects and references means reference-based object identity and mutation. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
- Use **Objects and references** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Objects and references** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Objects and references**.
...
- Does **Objects and references** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Objects and references** is valid for the target runtime and module system.
...
1. What is **Objects and references**?
2. Why would you use **Objects and references** in JavaScript?
3. How does **Objects and references** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Objects and references**?
5. Where does **Objects and references** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Objects and references**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Objects and references** in plain English.
