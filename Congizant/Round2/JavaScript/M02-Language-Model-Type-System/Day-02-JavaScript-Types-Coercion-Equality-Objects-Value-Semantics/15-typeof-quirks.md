...
**typeof quirks** is runtime primitive/function type operator with historical quirks.

---

# 2. Why

Interviewers use **typeof quirks** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: typeof quirks means runtime primitive/function type operator with historical quirks. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.

---

# 4. Engineering Explanation

`typeof null` is `'object'`; arrays require Array.isArray; functions report `'function'` A senior answer separates **ECMAScript language guarantees**, **browser/Node host behavior**, and **engine/framework implementation details**.
...
- `typeof null` is `'object'`; arrays require Array.isArray; functions report `'function'`
...
In real projects, this matters for runtime type guards.
...
- Use **typeof quirks** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **typeof quirks** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **typeof quirks**.
...
- Does **typeof quirks** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **typeof quirks** is valid for the target runtime and module system.
...
1. What is **typeof quirks**?
2. Why would you use **typeof quirks** in JavaScript?
3. How does **typeof quirks** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **typeof quirks**?
5. Where does **typeof quirks** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **typeof quirks**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **typeof quirks** in plain English.
