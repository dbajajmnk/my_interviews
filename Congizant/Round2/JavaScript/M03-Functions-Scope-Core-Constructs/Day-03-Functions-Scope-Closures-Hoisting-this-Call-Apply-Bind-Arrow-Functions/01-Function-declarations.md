# Topic 01 — Function declarations
...
**Function declarations** is named callable declaration with lexical/hoisting semantics.

---

# 2. Why

Interviewers use **Function declarations** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Function declarations means named callable declaration with lexical/hoisting semantics. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.

---

# 4. Engineering Explanation

declarations are instantiated before execution of their scope A senior answer separates **ECMAScript language guarantees**, **browser/Node host behavior**, and **engine/framework implementation details**.
...
- declarations are instantiated before execution of their scope
...
In real projects, this matters for core function design.
...
- Use **Function declarations** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Function declarations** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Function declarations**.
...
- Does **Function declarations** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Function declarations** is valid for the target runtime and module system.
...
2. Why would you use **Function declarations** in JavaScript?
3. How does **Function declarations** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Function declarations**?
5. Where does **Function declarations** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Function declarations**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Function declarations** in plain English.
