...
**Function expressions** is function value created in an expression.

---

# 2. Why

Interviewers use **Function expressions** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Function expressions means function value created in an expression. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.

---

# 4. Engineering Explanation

the function is created when the expression evaluates and assigned/passed as a value A senior answer separates **ECMAScript language guarantees**, **browser/Node host behavior**, and **engine/framework implementation details**.
...
- the function is created when the expression evaluates and assigned/passed as a value
...
In real projects, this matters for callbacks and modular behavior.
...
- Use **Function expressions** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Function expressions** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Function expressions**.
...
- Does **Function expressions** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Function expressions** is valid for the target runtime and module system.
...
1. What is **Function expressions**?
2. Why would you use **Function expressions** in JavaScript?
3. How does **Function expressions** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Function expressions**?
5. Where does **Function expressions** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Function expressions**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Function expressions** in plain English.
