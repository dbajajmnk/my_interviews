# Topic 10 — let/const block scope
...
**let/const block scope** is the JavaScript concept **let/const block scope** within Functions, Scope, Closures, Hoisting, this, Call/Apply/Bind & Arrow Functions.

---

# 2. Why

Interviewers use **let/const block scope** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: let/const block scope means the JavaScript concept **let/const block scope** within Functions, Scope, Closures, Hoisting, this, Call/Apply/Bind & Arrow Functions. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
In JavaScript applications, **let/const block scope** should be connected to a concrete runtime, API, correctness, debugging, performance, or maintainability requirement.
...
- Use **let/const block scope** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **let/const block scope** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **let/const block scope**.
...
- Does **let/const block scope** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **let/const block scope** is valid for the target runtime and module system.
...
1. What is **let/const block scope**?
2. Why would you use **let/const block scope** in JavaScript?
3. How does **let/const block scope** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **let/const block scope**?
5. Where does **let/const block scope** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **let/const block scope**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **let/const block scope** in plain English.
