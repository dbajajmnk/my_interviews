...
**call** is explicitly invoking a function with a chosen `this` and arguments.

---

# 2. Why

Interviewers use **call** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: call means explicitly invoking a function with a chosen `this` and arguments. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
- Use **call** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **call** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **call**.
...
- Does **call** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **call** is valid for the target runtime and module system.
...
1. What is **call**?
2. Why would you use **call** in JavaScript?
3. How does **call** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **call**?
5. Where does **call** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **call**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **call** in plain English.
