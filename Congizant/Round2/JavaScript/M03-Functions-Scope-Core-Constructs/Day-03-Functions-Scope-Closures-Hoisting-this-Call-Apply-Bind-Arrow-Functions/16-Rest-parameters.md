...
**Rest parameters** is collecting remaining arguments/elements.

---

# 2. Why

Interviewers use **Rest parameters** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Rest parameters means collecting remaining arguments/elements. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
- Use **Rest parameters** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Rest parameters** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Rest parameters**.
...
- Does **Rest parameters** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Rest parameters** is valid for the target runtime and module system.
...
2. Why would you use **Rest parameters** in JavaScript?
3. How does **Rest parameters** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Rest parameters**?
5. Where does **Rest parameters** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Rest parameters**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Rest parameters** in plain English.
