...
**Spread syntax** is expanding iterable/object properties into a new expression.

---

# 2. Why

Interviewers use **Spread syntax** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Spread syntax means expanding iterable/object properties into a new expression. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.

---

# 4. Engineering Explanation

spread performs shallow copying/expansion and does not deep-clone A senior answer separates **ECMAScript language guarantees**, **browser/Node host behavior**, and **engine/framework implementation details**.
...
- spread performs shallow copying/expansion and does not deep-clone
...
In real projects, this matters for immutable-style updates.
...
- Use **Spread syntax** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Spread syntax** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Spread syntax**.
...
- Does **Spread syntax** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Spread syntax** is valid for the target runtime and module system.
...
1. What is **Spread syntax**?
2. Why would you use **Spread syntax** in JavaScript?
3. How does **Spread syntax** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Spread syntax**?
5. Where does **Spread syntax** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Spread syntax**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Spread syntax** in plain English.
