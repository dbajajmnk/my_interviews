...
**Object literals** is reference-based object identity and mutation.

---

# 2. Why

Interviewers use **Object literals** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Object literals means reference-based object identity and mutation. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
- Use **Object literals** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Object literals** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Object literals**.
...
- Does **Object literals** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Object literals** is valid for the target runtime and module system.
...
2. Why would you use **Object literals** in JavaScript?
3. How does **Object literals** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Object literals**?
5. Where does **Object literals** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Object literals**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Object literals** in plain English.
