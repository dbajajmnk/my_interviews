...
**Object.create** is reference-based object identity and mutation.

---

# 2. Why

Interviewers use **Object.create** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Object.create means reference-based object identity and mutation. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
- Use **Object.create** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Object.create** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Object.create**.
...
- Does **Object.create** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Object.create** is valid for the target runtime and module system.
...
2. Why would you use **Object.create** in JavaScript?
3. How does **Object.create** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Object.create**?
5. Where does **Object.create** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Object.create**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Object.create** in plain English.
