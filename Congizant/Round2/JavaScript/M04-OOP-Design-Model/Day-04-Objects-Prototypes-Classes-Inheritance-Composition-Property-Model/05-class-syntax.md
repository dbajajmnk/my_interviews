...
**class syntax** is syntax over JavaScript's prototype-based object model.

---

# 2. Why

Interviewers use **class syntax** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: class syntax means syntax over JavaScript's prototype-based object model. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.

---

# 4. Engineering Explanation

class methods live on prototype; `extends` links prototype chains and constructors A senior answer separates **ECMAScript language guarantees**, **browser/Node host behavior**, and **engine/framework implementation details**.
...
- class methods live on prototype; `extends` links prototype chains and constructors
...
In real projects, this matters for OOP-style modeling.
...
- Use **class syntax** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **class syntax** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **class syntax**.
...
- Does **class syntax** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **class syntax** is valid for the target runtime and module system.
...
1. What is **class syntax**?
2. Why would you use **class syntax** in JavaScript?
3. How does **class syntax** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **class syntax**?
5. Where does **class syntax** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **class syntax**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **class syntax** in plain English.
