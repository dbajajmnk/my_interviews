...
**extends and super** is the JavaScript concept **extends and super** within Objects, Prototypes, Classes, Inheritance, Composition & Property Model.

---

# 2. Why

Interviewers use **extends and super** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: extends and super means the JavaScript concept **extends and super** within Objects, Prototypes, Classes, Inheritance, Composition & Property Model. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
In JavaScript applications, **extends and super** should be connected to a concrete runtime, API, correctness, debugging, performance, or maintainability requirement.
...
- Use **extends and super** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **extends and super** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **extends and super**.
...
- Does **extends and super** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **extends and super** is valid for the target runtime and module system.
...
1. What is **extends and super**?
2. Why would you use **extends and super** in JavaScript?
3. How does **extends and super** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **extends and super**?
5. Where does **extends and super** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **extends and super**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **extends and super** in plain English.
