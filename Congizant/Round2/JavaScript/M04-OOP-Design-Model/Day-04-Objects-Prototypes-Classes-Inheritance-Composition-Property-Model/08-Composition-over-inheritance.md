# Topic 08 — Composition over inheritance
...
**Composition over inheritance** is the JavaScript concept **Composition over inheritance** within Objects, Prototypes, Classes, Inheritance, Composition & Property Model.

---

# 2. Why

Interviewers use **Composition over inheritance** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Composition over inheritance means the JavaScript concept **Composition over inheritance** within Objects, Prototypes, Classes, Inheritance, Composition & Property Model. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
In JavaScript applications, **Composition over inheritance** should be connected to a concrete runtime, API, correctness, debugging, performance, or maintainability requirement.
...
- Use **Composition over inheritance** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Composition over inheritance** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Composition over inheritance**.
...
- Does **Composition over inheritance** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Composition over inheritance** is valid for the target runtime and module system.
...
2. Why would you use **Composition over inheritance** in JavaScript?
3. How does **Composition over inheritance** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Composition over inheritance**?
5. Where does **Composition over inheritance** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Composition over inheritance**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
