...
**Property descriptors** is metadata controlling property behavior.

---

# 2. Why

Interviewers use **Property descriptors** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Property descriptors means metadata controlling property behavior. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.

---

# 4. Engineering Explanation

descriptors define value/get/set plus writable/enumerable/configurable flags A senior answer separates **ECMAScript language guarantees**, **browser/Node host behavior**, and **engine/framework implementation details**.
...
- descriptors define value/get/set plus writable/enumerable/configurable flags
...
In real projects, this matters for framework/meta-programming.
...
- Use **Property descriptors** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Property descriptors** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Property descriptors**.
...
- Does **Property descriptors** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Property descriptors** is valid for the target runtime and module system.
...
1. What is **Property descriptors**?
2. Why would you use **Property descriptors** in JavaScript?
3. How does **Property descriptors** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Property descriptors**?
5. Where does **Property descriptors** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Property descriptors**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Property descriptors** in plain English.
