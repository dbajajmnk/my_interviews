...
**DRY** is the JavaScript concept **DRY** within SOLID, DRY, KIS, YAGNI & GoF Creational/Structural Patterns in JavaScript.

---

# 2. Why

Interviewers use **DRY** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: DRY means the JavaScript concept **DRY** within SOLID, DRY, KIS, YAGNI & GoF Creational/Structural Patterns in JavaScript. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
In JavaScript applications, **DRY** should be connected to a concrete runtime, API, correctness, debugging, performance, or maintainability requirement.
...
- Use **DRY** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **DRY** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **DRY**.
...
- Does **DRY** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **DRY** is valid for the target runtime and module system.
...
1. What is **DRY**?
2. Why would you use **DRY** in JavaScript?
3. How does **DRY** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **DRY**?
5. Where does **DRY** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **DRY**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
