...
**Set** is unique-value collection.

---

# 2. Why

Interviewers use **Set** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Set means unique-value collection. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
- Use **Set** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Set** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Set**.
...
- Does **Set** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Set** is valid for the target runtime and module system.
...
1. What is **Set**?
2. Why would you use **Set** in JavaScript?
3. How does **Set** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Set**?
5. Where does **Set** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Set**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Set** in plain English.
