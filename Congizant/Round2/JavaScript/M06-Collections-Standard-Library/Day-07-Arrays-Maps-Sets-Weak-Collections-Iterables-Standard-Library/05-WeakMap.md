...
**WeakMap** is key/value collection supporting arbitrary key types and insertion order.

---

# 2. Why

Interviewers use **WeakMap** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: WeakMap means key/value collection supporting arbitrary key types and insertion order. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
- Use **WeakMap** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **WeakMap** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **WeakMap**.
...
- Does **WeakMap** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **WeakMap** is valid for the target runtime and module system.
...
1. What is **WeakMap**?
2. Why would you use **WeakMap** in JavaScript?
3. How does **WeakMap** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **WeakMap**?
5. Where does **WeakMap** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **WeakMap**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **WeakMap** in plain English.
