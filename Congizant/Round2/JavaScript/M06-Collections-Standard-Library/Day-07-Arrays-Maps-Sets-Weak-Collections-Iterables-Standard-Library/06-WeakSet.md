...
**WeakSet** is unique-value collection.

---

# 2. Why

Interviewers use **WeakSet** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: WeakSet means unique-value collection. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
- Use **WeakSet** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **WeakSet** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **WeakSet**.
...
- Does **WeakSet** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **WeakSet** is valid for the target runtime and module system.
...
1. What is **WeakSet**?
2. Why would you use **WeakSet** in JavaScript?
3. How does **WeakSet** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **WeakSet**?
5. Where does **WeakSet** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **WeakSet**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **WeakSet** in plain English.
