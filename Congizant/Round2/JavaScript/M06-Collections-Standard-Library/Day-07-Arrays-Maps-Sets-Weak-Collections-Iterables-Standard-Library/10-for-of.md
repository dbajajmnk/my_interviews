...
**for...of** is iterating values from an iterable.

---

# 2. Why

Interviewers use **for...of** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: for...of means iterating values from an iterable. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.

---

# 4. Engineering Explanation

for...of consumes iterator protocol A senior answer separates **ECMAScript language guarantees**, **browser/Node host behavior**, and **engine/framework implementation details**.
...
- for...of consumes iterator protocol
...
In real projects, this matters for arrays/maps/sets/generators.
...
- Use **for...of** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **for...of** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **for...of**.
...
- Does **for...of** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **for...of** is valid for the target runtime and module system.
...
1. What is **for...of**?
2. Why would you use **for...of** in JavaScript?
3. How does **for...of** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **for...of**?
5. Where does **for...of** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **for...of**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **for...of** in plain English.
