...
**Optional chaining** is the JavaScript concept **Optional chaining** within Arrays, Maps, Sets, Weak Collections, Iterables & Standard Library.
...
Plain English: Optional chaining means the JavaScript concept **Optional chaining** within Arrays, Maps, Sets, Weak Collections, Iterables & Standard Library. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
