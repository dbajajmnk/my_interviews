...
**Nullish coalescing** is two distinct absence-like values.

---

# 2. Why

Interviewers use **Nullish coalescing** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Nullish coalescing means two distinct absence-like values. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
- Use **Nullish coalescing** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Nullish coalescing** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Nullish coalescing**.
...
- Does **Nullish coalescing** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Nullish coalescing** is valid for the target runtime and module system.
...
2. Why would you use **Nullish coalescing** in JavaScript?
3. How does **Nullish coalescing** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Nullish coalescing**?
5. Where does **Nullish coalescing** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Nullish coalescing**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Nullish coalescing** in plain English.
