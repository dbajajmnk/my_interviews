...
**import and export** is the JavaScript concept **import and export** within ES Modules, CommonJS, npm, package.json, SemVer, Lockfiles & Build Tooling.

---

# 2. Why

Interviewers use **import and export** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: import and export means the JavaScript concept **import and export** within ES Modules, CommonJS, npm, package.json, SemVer, Lockfiles & Build Tooling. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
In JavaScript applications, **import and export** should be connected to a concrete runtime, API, correctness, debugging, performance, or maintainability requirement.
...
- Use **import and export** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **import and export** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **import and export**.
...
- Does **import and export** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **import and export** is valid for the target runtime and module system.
...
2. Why would you use **import and export** in JavaScript?
3. How does **import and export** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **import and export**?
5. Where does **import and export** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **import and export**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **import and export** in plain English.
