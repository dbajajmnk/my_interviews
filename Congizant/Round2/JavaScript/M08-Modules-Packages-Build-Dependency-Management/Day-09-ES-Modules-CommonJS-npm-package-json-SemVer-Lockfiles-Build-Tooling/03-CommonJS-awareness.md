...
**CommonJS awareness** is Node's historical require/module.exports system.

---

# 2. Why

Interviewers use **CommonJS awareness** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: CommonJS awareness means Node's historical require/module.exports system. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
- Use **CommonJS awareness** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **CommonJS awareness** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **CommonJS awareness**.
...
- Does **CommonJS awareness** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **CommonJS awareness** is valid for the target runtime and module system.
...
1. What is **CommonJS awareness**?
2. Why would you use **CommonJS awareness** in JavaScript?
3. How does **CommonJS awareness** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **CommonJS awareness**?
5. Where does **CommonJS awareness** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **CommonJS awareness**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **CommonJS awareness** in plain English.
