# Topic 04 — ESM vs CommonJS interoperability
...
**ESM vs CommonJS interoperability** is Node's historical require/module.exports system.

---

# 2. Why

Interviewers use **ESM vs CommonJS interoperability** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: ESM vs CommonJS interoperability means Node's historical require/module.exports system. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.

---

# 4. Engineering Explanation

modules execute through Node's CommonJS loader and are cached by resolved filename A senior answer separates **ECMAScript language guarantees**, **browser/Node host behavior**, and **engine/framework implementation details**.
...
- modules execute through Node's CommonJS loader and are cached by resolved filename
...
In real projects, this matters for legacy Node interop.
...
- Use **ESM vs CommonJS interoperability** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **ESM vs CommonJS interoperability** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **ESM vs CommonJS interoperability**.
...
- Does **ESM vs CommonJS interoperability** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **ESM vs CommonJS interoperability** is valid for the target runtime and module system.
...
1. What is **ESM vs CommonJS interoperability**?
2. Why would you use **ESM vs CommonJS interoperability** in JavaScript?
3. How does **ESM vs CommonJS interoperability** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **ESM vs CommonJS interoperability**?
5. Where does **ESM vs CommonJS interoperability** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **ESM vs CommonJS interoperability**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **ESM vs CommonJS interoperability** in plain English.
