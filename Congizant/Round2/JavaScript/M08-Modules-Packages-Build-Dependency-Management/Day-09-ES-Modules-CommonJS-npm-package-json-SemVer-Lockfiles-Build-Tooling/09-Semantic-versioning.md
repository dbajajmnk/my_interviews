...
**Semantic versioning** is version compatibility convention.

---

# 2. Why

Interviewers use **Semantic versioning** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Semantic versioning means version compatibility convention. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.

---

# 4. Engineering Explanation

major/minor/patch communicate intended compatibility; ranges can admit newer versions A senior answer separates **ECMAScript language guarantees**, **browser/Node host behavior**, and **engine/framework implementation details**.
...
- major/minor/patch communicate intended compatibility; ranges can admit newer versions
...
In real projects, this matters for dependency risk.
...
- Use **Semantic versioning** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Semantic versioning** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Semantic versioning**.
...
- Does **Semantic versioning** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Semantic versioning** is valid for the target runtime and module system.
...
2. Why would you use **Semantic versioning** in JavaScript?
3. How does **Semantic versioning** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Semantic versioning**?
5. Where does **Semantic versioning** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Semantic versioning**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Semantic versioning** in plain English.
