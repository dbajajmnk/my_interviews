# Topic 19 — Dependency supply-chain risk
...
**Dependency supply-chain risk** is the JavaScript concept **Dependency supply-chain risk** within ES Modules, CommonJS, npm, package.json, SemVer, Lockfiles & Build Tooling.

---

# 2. Why

Interviewers use **Dependency supply-chain risk** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Dependency supply-chain risk means the JavaScript concept **Dependency supply-chain risk** within ES Modules, CommonJS, npm, package.json, SemVer, Lockfiles & Build Tooling. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
In JavaScript applications, **Dependency supply-chain risk** should be connected to a concrete runtime, API, correctness, debugging, performance, or maintainability requirement.
...
- Use **Dependency supply-chain risk** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Dependency supply-chain risk** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Dependency supply-chain risk**.
...
- Does **Dependency supply-chain risk** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Dependency supply-chain risk** is valid for the target runtime and module system.
...
1. What is **Dependency supply-chain risk**?
2. Why would you use **Dependency supply-chain risk** in JavaScript?
3. How does **Dependency supply-chain risk** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Dependency supply-chain risk**?
5. Where does **Dependency supply-chain risk** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Dependency supply-chain risk**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Dependency supply-chain risk** in plain English.
