...
**Execution contexts** is runtime context for code execution and bindings.

---

# 2. Why

Interviewers use **Execution contexts** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Execution contexts means runtime context for code execution and bindings. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.

---

# 4. Engineering Explanation

calls/modules/scripts create execution contexts associated with lexical environments A senior answer separates **ECMAScript language guarantees**, **browser/Node host behavior**, and **engine/framework implementation details**.
...
- calls/modules/scripts create execution contexts associated with lexical environments
...
In real projects, this matters for scope/runtime reasoning.
...
- Use **Execution contexts** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Execution contexts** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Execution contexts**.
...
- Does **Execution contexts** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Execution contexts** is valid for the target runtime and module system.
...
1. What is **Execution contexts**?
2. Why would you use **Execution contexts** in JavaScript?
3. How does **Execution contexts** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Execution contexts**?
5. Where does **Execution contexts** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Execution contexts**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Execution contexts** in plain English.
