# Topic 05 — Reachability and garbage collection
...
**Reachability and garbage collection** is automatic reclamation of unreachable objects.

---

# 2. Why

Interviewers use **Reachability and garbage collection** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Reachability and garbage collection means automatic reclamation of unreachable objects. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.

---

# 4. Engineering Explanation

engines trace reachability from roots using implementation-specific collectors A senior answer separates **ECMAScript language guarantees**, **browser/Node host behavior**, and **engine/framework implementation details**.
...
- engines trace reachability from roots using implementation-specific collectors
...
In real projects, this matters for memory management.
...
- Use **Reachability and garbage collection** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Reachability and garbage collection** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Reachability and garbage collection**.
...
- Does **Reachability and garbage collection** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Reachability and garbage collection** is valid for the target runtime and module system.
...
1. What is **Reachability and garbage collection**?
2. Why would you use **Reachability and garbage collection** in JavaScript?
3. How does **Reachability and garbage collection** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Reachability and garbage collection**?
5. Where does **Reachability and garbage collection** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Reachability and garbage collection**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Reachability and garbage collection** in plain English.
