...
**Memory leaks** is unintended retention of reachable objects/resources.

---

# 2. Why

Interviewers use **Memory leaks** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Memory leaks means unintended retention of reachable objects/resources. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
- Use **Memory leaks** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Memory leaks** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Memory leaks**.
...
- Does **Memory leaks** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Memory leaks** is valid for the target runtime and module system.
...
1. What is **Memory leaks**?
2. Why would you use **Memory leaks** in JavaScript?
3. How does **Memory leaks** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Memory leaks**?
5. Where does **Memory leaks** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Memory leaks**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Memory leaks** in plain English.
