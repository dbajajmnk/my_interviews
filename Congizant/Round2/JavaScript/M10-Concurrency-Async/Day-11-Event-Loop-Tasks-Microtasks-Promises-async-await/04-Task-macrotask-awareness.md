# Topic 04 — Task/macrotask awareness
...
**Task/macrotask awareness** is the JavaScript concept **Task/macrotask awareness** within Event Loop, Tasks, Microtasks, Promises & async/await.

---

# 2. Why

Interviewers use **Task/macrotask awareness** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Task/macrotask awareness means the JavaScript concept **Task/macrotask awareness** within Event Loop, Tasks, Microtasks, Promises & async/await. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
In JavaScript applications, **Task/macrotask awareness** should be connected to a concrete runtime, API, correctness, debugging, performance, or maintainability requirement.
...
- Use **Task/macrotask awareness** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Task/macrotask awareness** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Task/macrotask awareness**.
...
- Does **Task/macrotask awareness** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Task/macrotask awareness** is valid for the target runtime and module system.
...
1. What is **Task/macrotask awareness**?
2. Why would you use **Task/macrotask awareness** in JavaScript?
3. How does **Task/macrotask awareness** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Task/macrotask awareness**?
5. Where does **Task/macrotask awareness** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Task/macrotask awareness**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Task/macrotask awareness** in plain English.
