...
**Starvation awareness** is the JavaScript concept **Starvation awareness** within Event Loop, Tasks, Microtasks, Promises & async/await.

---

# 2. Why

Interviewers use **Starvation awareness** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Starvation awareness means the JavaScript concept **Starvation awareness** within Event Loop, Tasks, Microtasks, Promises & async/await. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
In JavaScript applications, **Starvation awareness** should be connected to a concrete runtime, API, correctness, debugging, performance, or maintainability requirement.
...
- Use **Starvation awareness** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Starvation awareness** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Starvation awareness**.
...
- Does **Starvation awareness** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Starvation awareness** is valid for the target runtime and module system.
...
1. What is **Starvation awareness**?
2. Why would you use **Starvation awareness** in JavaScript?
3. How does **Starvation awareness** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Starvation awareness**?
5. Where does **Starvation awareness** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Starvation awareness**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Starvation awareness** in plain English.
