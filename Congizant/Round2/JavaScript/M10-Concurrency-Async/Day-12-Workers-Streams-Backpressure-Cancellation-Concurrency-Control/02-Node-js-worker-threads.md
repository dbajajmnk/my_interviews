# Topic 02 — Node.js worker_threads
...
**Node.js worker_threads** is Node threads for JavaScript CPU work and shared memory options.

---

# 2. Why

Interviewers use **Node.js worker_threads** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Node.js worker_threads means Node threads for JavaScript CPU work and shared memory options. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.

---

# 4. Engineering Explanation

workers run separate JS isolates/threads and communicate via messages/shared buffers A senior answer separates **ECMAScript language guarantees**, **browser/Node host behavior**, and **engine/framework implementation details**.
...
- workers run separate JS isolates/threads and communicate via messages/shared buffers
...
In real projects, this matters for CPU-bound processing.
...
- Use **Node.js worker_threads** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Node.js worker_threads** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Node.js worker_threads**.
...
- Does **Node.js worker_threads** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Node.js worker_threads** is valid for the target runtime and module system.
...
1. What is **Node.js worker_threads**?
2. Why would you use **Node.js worker_threads** in JavaScript?
3. How does **Node.js worker_threads** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Node.js worker_threads**?
5. Where does **Node.js worker_threads** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Node.js worker_threads**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Node.js worker_threads** in plain English.
