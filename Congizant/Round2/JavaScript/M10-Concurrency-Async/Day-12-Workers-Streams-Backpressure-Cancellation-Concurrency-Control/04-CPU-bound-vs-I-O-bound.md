# Topic 04 — CPU-bound vs I/O-bound
...
**CPU-bound vs I/O-bound** is the JavaScript concept **CPU-bound vs I/O-bound** within Workers, Streams, Backpressure, Cancellation & Concurrency Control.

---

# 2. Why

Interviewers use **CPU-bound vs I/O-bound** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: CPU-bound vs I/O-bound means the JavaScript concept **CPU-bound vs I/O-bound** within Workers, Streams, Backpressure, Cancellation & Concurrency Control. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
In JavaScript applications, **CPU-bound vs I/O-bound** should be connected to a concrete runtime, API, correctness, debugging, performance, or maintainability requirement.
...
- Use **CPU-bound vs I/O-bound** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **CPU-bound vs I/O-bound** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **CPU-bound vs I/O-bound**.
...
- Does **CPU-bound vs I/O-bound** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **CPU-bound vs I/O-bound** is valid for the target runtime and module system.
...
1. What is **CPU-bound vs I/O-bound**?
2. Why would you use **CPU-bound vs I/O-bound** in JavaScript?
3. How does **CPU-bound vs I/O-bound** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **CPU-bound vs I/O-bound**?
5. Where does **CPU-bound vs I/O-bound** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **CPU-bound vs I/O-bound**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **CPU-bound vs I/O-bound** in plain English.
