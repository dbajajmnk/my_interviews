...
**Cancellation** is cooperative cancellation signal.

---

# 2. Why

Interviewers use **Cancellation** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Cancellation means cooperative cancellation signal. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
- Use **Cancellation** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Cancellation** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Cancellation**.
...
- Does **Cancellation** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Cancellation** is valid for the target runtime and module system.
...
2. Why would you use **Cancellation** in JavaScript?
3. How does **Cancellation** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Cancellation**?
5. Where does **Cancellation** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Cancellation**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Cancellation** in plain English.
