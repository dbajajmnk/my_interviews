...
**Custom iterables** is the JavaScript concept **Custom iterables** within Generators, Iterators, Proxy, Reflect, Symbols & Advanced Language Features.

---

# 2. Why

Interviewers use **Custom iterables** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Custom iterables means the JavaScript concept **Custom iterables** within Generators, Iterators, Proxy, Reflect, Symbols & Advanced Language Features. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
In JavaScript applications, **Custom iterables** should be connected to a concrete runtime, API, correctness, debugging, performance, or maintainability requirement.
...
- Use **Custom iterables** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Custom iterables** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Custom iterables**.
...
- Does **Custom iterables** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Custom iterables** is valid for the target runtime and module system.
...
1. What is **Custom iterables**?
2. Why would you use **Custom iterables** in JavaScript?
3. How does **Custom iterables** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Custom iterables**?
5. Where does **Custom iterables** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Custom iterables**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Custom iterables** in plain English.
