...
**Reflect** is standard functions for fundamental object operations.

---

# 2. Why

Interviewers use **Reflect** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Reflect means standard functions for fundamental object operations. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.

---

# 4. Engineering Explanation

Reflect methods align with Proxy traps and return explicit results for many operations A senior answer separates **ECMAScript language guarantees**, **browser/Node host behavior**, and **engine/framework implementation details**.
...
- Reflect methods align with Proxy traps and return explicit results for many operations
...
In real projects, this matters for meta-programming.
...
- Use **Reflect** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Reflect** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Reflect**.
...
- Does **Reflect** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Reflect** is valid for the target runtime and module system.
...
1. What is **Reflect**?
2. Why would you use **Reflect** in JavaScript?
3. How does **Reflect** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Reflect**?
5. Where does **Reflect** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Reflect**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Reflect** in plain English.
