...
**Private class fields** is the JavaScript concept **Private class fields** within Generators, Iterators, Proxy, Reflect, Symbols & Advanced Language Features.

---

# 2. Why

Interviewers use **Private class fields** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Private class fields means the JavaScript concept **Private class fields** within Generators, Iterators, Proxy, Reflect, Symbols & Advanced Language Features. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
In JavaScript applications, **Private class fields** should be connected to a concrete runtime, API, correctness, debugging, performance, or maintainability requirement.
...
- Use **Private class fields** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Private class fields** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Private class fields**.
...
- Does **Private class fields** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Private class fields** is valid for the target runtime and module system.
...
1. What is **Private class fields**?
2. Why would you use **Private class fields** in JavaScript?
3. How does **Private class fields** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Private class fields**?
5. Where does **Private class fields** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Private class fields**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Private class fields** in plain English.
