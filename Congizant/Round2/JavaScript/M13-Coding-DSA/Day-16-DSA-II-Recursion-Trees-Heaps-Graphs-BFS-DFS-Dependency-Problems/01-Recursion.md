...
**Recursion** is the JavaScript concept **Recursion** within DSA II: Recursion, Trees, Heaps, Graphs, BFS/DFS & Dependency Problems.

---

# 2. Why

Interviewers use **Recursion** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Recursion means the JavaScript concept **Recursion** within DSA II: Recursion, Trees, Heaps, Graphs, BFS/DFS & Dependency Problems. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
In JavaScript applications, **Recursion** should be connected to a concrete runtime, API, correctness, debugging, performance, or maintainability requirement.
...
- Use **Recursion** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Recursion** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Recursion**.
...
- Does **Recursion** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Recursion** is valid for the target runtime and module system.
...
1. What is **Recursion**?
2. Why would you use **Recursion** in JavaScript?
3. How does **Recursion** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Recursion**?
5. Where does **Recursion** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Recursion**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
