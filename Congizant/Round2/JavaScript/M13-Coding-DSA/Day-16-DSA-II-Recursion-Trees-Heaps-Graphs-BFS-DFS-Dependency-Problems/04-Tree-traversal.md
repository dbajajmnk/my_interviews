...
**Tree traversal** is the JavaScript concept **Tree traversal** within DSA II: Recursion, Trees, Heaps, Graphs, BFS/DFS & Dependency Problems.

---

# 2. Why

Interviewers use **Tree traversal** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Tree traversal means the JavaScript concept **Tree traversal** within DSA II: Recursion, Trees, Heaps, Graphs, BFS/DFS & Dependency Problems. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
In JavaScript applications, **Tree traversal** should be connected to a concrete runtime, API, correctness, debugging, performance, or maintainability requirement.
...
- Use **Tree traversal** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Tree traversal** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Tree traversal**.
...
- Does **Tree traversal** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Tree traversal** is valid for the target runtime and module system.
...
2. Why would you use **Tree traversal** in JavaScript?
3. How does **Tree traversal** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Tree traversal**?
5. Where does **Tree traversal** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Tree traversal**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Tree traversal** in plain English.
