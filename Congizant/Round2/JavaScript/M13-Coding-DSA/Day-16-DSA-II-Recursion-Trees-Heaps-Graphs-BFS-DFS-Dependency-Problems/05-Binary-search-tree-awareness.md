# Topic 05 — Binary search tree awareness
...
**Binary search tree awareness** is the JavaScript concept **Binary search tree awareness** within DSA II: Recursion, Trees, Heaps, Graphs, BFS/DFS & Dependency Problems.

---

# 2. Why

Interviewers use **Binary search tree awareness** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Binary search tree awareness means the JavaScript concept **Binary search tree awareness** within DSA II: Recursion, Trees, Heaps, Graphs, BFS/DFS & Dependency Problems. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
In JavaScript applications, **Binary search tree awareness** should be connected to a concrete runtime, API, correctness, debugging, performance, or maintainability requirement.
...
- Use **Binary search tree awareness** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Binary search tree awareness** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Binary search tree awareness**.
...
- Does **Binary search tree awareness** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Binary search tree awareness** is valid for the target runtime and module system.
...
1. What is **Binary search tree awareness**?
2. Why would you use **Binary search tree awareness** in JavaScript?
3. How does **Binary search tree awareness** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Binary search tree awareness**?
5. Where does **Binary search tree awareness** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Binary search tree awareness**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Binary search tree awareness** in plain English.
