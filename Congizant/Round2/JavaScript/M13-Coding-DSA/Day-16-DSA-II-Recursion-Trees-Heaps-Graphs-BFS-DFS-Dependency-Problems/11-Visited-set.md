...
**Visited set** is unique-value collection.

---

# 2. Why

Interviewers use **Visited set** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Visited set means unique-value collection. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
- Use **Visited set** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Visited set** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Visited set**.
...
- Does **Visited set** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Visited set** is valid for the target runtime and module system.
...
1. What is **Visited set**?
2. Why would you use **Visited set** in JavaScript?
3. How does **Visited set** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Visited set**?
5. Where does **Visited set** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Visited set**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Visited set** in plain English.
