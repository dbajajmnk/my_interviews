# Topic 15 — Iterative vs recursive traversal
...
**Iterative vs recursive traversal** is the JavaScript concept **Iterative vs recursive traversal** within DSA II: Recursion, Trees, Heaps, Graphs, BFS/DFS & Dependency Problems.

---

# 2. Why

Interviewers use **Iterative vs recursive traversal** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Iterative vs recursive traversal means the JavaScript concept **Iterative vs recursive traversal** within DSA II: Recursion, Trees, Heaps, Graphs, BFS/DFS & Dependency Problems. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
In JavaScript applications, **Iterative vs recursive traversal** should be connected to a concrete runtime, API, correctness, debugging, performance, or maintainability requirement.
...
- Use **Iterative vs recursive traversal** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Iterative vs recursive traversal** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Iterative vs recursive traversal**.
...
- Does **Iterative vs recursive traversal** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Iterative vs recursive traversal** is valid for the target runtime and module system.
...
1. What is **Iterative vs recursive traversal**?
2. Why would you use **Iterative vs recursive traversal** in JavaScript?
3. How does **Iterative vs recursive traversal** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Iterative vs recursive traversal**?
5. Where does **Iterative vs recursive traversal** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Iterative vs recursive traversal**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Iterative vs recursive traversal** in plain English.
