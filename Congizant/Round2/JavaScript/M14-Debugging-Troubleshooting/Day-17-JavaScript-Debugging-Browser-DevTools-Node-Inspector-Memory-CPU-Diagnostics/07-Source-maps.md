...
**Source maps** is key/value collection supporting arbitrary key types and insertion order.

---

# 2. Why

Interviewers use **Source maps** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Source maps means key/value collection supporting arbitrary key types and insertion order. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
- Use **Source maps** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Source maps** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Source maps**.
...
- Does **Source maps** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Source maps** is valid for the target runtime and module system.
...
1. What is **Source maps**?
2. Why would you use **Source maps** in JavaScript?
3. How does **Source maps** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Source maps**?
5. Where does **Source maps** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Source maps**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Source maps** in plain English.
