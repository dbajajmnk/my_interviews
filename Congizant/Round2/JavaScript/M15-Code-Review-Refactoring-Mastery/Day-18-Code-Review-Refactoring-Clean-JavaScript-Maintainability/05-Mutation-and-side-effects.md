# Topic 05 — Mutation and side effects
...
**Mutation and side effects** is the JavaScript concept **Mutation and side effects** within Code Review, Refactoring, Clean JavaScript & Maintainability.

---

# 2. Why

Interviewers use **Mutation and side effects** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Mutation and side effects means the JavaScript concept **Mutation and side effects** within Code Review, Refactoring, Clean JavaScript & Maintainability. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
In JavaScript applications, **Mutation and side effects** should be connected to a concrete runtime, API, correctness, debugging, performance, or maintainability requirement.
...
- Use **Mutation and side effects** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Mutation and side effects** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Mutation and side effects**.
...
- Does **Mutation and side effects** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Mutation and side effects** is valid for the target runtime and module system.
...
1. What is **Mutation and side effects**?
2. Why would you use **Mutation and side effects** in JavaScript?
3. How does **Mutation and side effects** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Mutation and side effects**?
5. Where does **Mutation and side effects** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Mutation and side effects**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Mutation and side effects** in plain English.
