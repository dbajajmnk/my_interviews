# Topic 11 — Promise anti-patterns
...
**Promise anti-patterns** is async control-flow correctness.

---

# 2. Why

Interviewers use **Promise anti-patterns** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Promise anti-patterns means async control-flow correctness. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.

---

# 4. Engineering Explanation

forgotten await/return can detach failures and race subsequent work A senior answer separates **ECMAScript language guarantees**, **browser/Node host behavior**, and **engine/framework implementation details**.
...
- forgotten await/return can detach failures and race subsequent work
...
In real projects, this matters for production correctness.
...
- Use **Promise anti-patterns** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Promise anti-patterns** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Promise anti-patterns**.
...
- Does **Promise anti-patterns** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Promise anti-patterns** is valid for the target runtime and module system.
...
1. What is **Promise anti-patterns**?
2. Why would you use **Promise anti-patterns** in JavaScript?
3. How does **Promise anti-patterns** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Promise anti-patterns**?
5. Where does **Promise anti-patterns** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Promise anti-patterns**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Promise anti-patterns** in plain English.
