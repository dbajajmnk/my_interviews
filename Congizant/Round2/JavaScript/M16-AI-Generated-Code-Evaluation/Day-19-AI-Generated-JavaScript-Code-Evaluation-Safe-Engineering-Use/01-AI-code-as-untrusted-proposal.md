# Topic 01 — AI code as untrusted proposal
...
**AI code as untrusted proposal** is treating model output as untrusted engineering input.

---

# 2. Why

Interviewers use **AI code as untrusted proposal** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: AI code as untrusted proposal means treating model output as untrusted engineering input. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.

---

# 4. Engineering Explanation

LLMs generate plausible code, not guaranteed-valid/runtime-safe code A senior answer separates **ECMAScript language guarantees**, **browser/Node host behavior**, and **engine/framework implementation details**.
...
```javascript
// compile/run/test/review before merge
```
...
- LLMs generate plausible code, not guaranteed-valid/runtime-safe code
...
In real projects, this matters for AI-assisted development.
...
- Use **AI code as untrusted proposal** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **AI code as untrusted proposal** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **AI code as untrusted proposal**.
...
- Does **AI code as untrusted proposal** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **AI code as untrusted proposal** is valid for the target runtime and module system.
...
1. What is **AI code as untrusted proposal**?
2. Why would you use **AI code as untrusted proposal** in JavaScript?
3. How does **AI code as untrusted proposal** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **AI code as untrusted proposal**?
5. Where does **AI code as untrusted proposal** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **AI code as untrusted proposal**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **AI code as untrusted proposal** in plain English.
