# Topic 03 — Syntax/runtime compatibility
...
**Syntax/runtime compatibility** is the JavaScript concept **Syntax/runtime compatibility** within AI-Generated JavaScript Code Evaluation & Safe Engineering Use.

---

# 2. Why

Interviewers use **Syntax/runtime compatibility** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Syntax/runtime compatibility means the JavaScript concept **Syntax/runtime compatibility** within AI-Generated JavaScript Code Evaluation & Safe Engineering Use. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
In JavaScript applications, **Syntax/runtime compatibility** should be connected to a concrete runtime, API, correctness, debugging, performance, or maintainability requirement.
...
- Use **Syntax/runtime compatibility** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Syntax/runtime compatibility** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Syntax/runtime compatibility**.
...
- Does **Syntax/runtime compatibility** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Syntax/runtime compatibility** is valid for the target runtime and module system.
...
1. What is **Syntax/runtime compatibility**?
2. Why would you use **Syntax/runtime compatibility** in JavaScript?
3. How does **Syntax/runtime compatibility** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Syntax/runtime compatibility**?
5. Where does **Syntax/runtime compatibility** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Syntax/runtime compatibility**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Syntax/runtime compatibility** in plain English.
