# Topic 05 — Hallucinated browser/Node APIs
...
**Hallucinated browser/Node APIs** is the JavaScript concept **Hallucinated browser/Node APIs** within AI-Generated JavaScript Code Evaluation & Safe Engineering Use.

---

# 2. Why

Interviewers use **Hallucinated browser/Node APIs** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Hallucinated browser/Node APIs means the JavaScript concept **Hallucinated browser/Node APIs** within AI-Generated JavaScript Code Evaluation & Safe Engineering Use. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
In JavaScript applications, **Hallucinated browser/Node APIs** should be connected to a concrete runtime, API, correctness, debugging, performance, or maintainability requirement.
...
- Use **Hallucinated browser/Node APIs** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Hallucinated browser/Node APIs** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Hallucinated browser/Node APIs**.
...
- Does **Hallucinated browser/Node APIs** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Hallucinated browser/Node APIs** is valid for the target runtime and module system.
...
1. What is **Hallucinated browser/Node APIs**?
2. Why would you use **Hallucinated browser/Node APIs** in JavaScript?
3. How does **Hallucinated browser/Node APIs** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Hallucinated browser/Node APIs**?
5. Where does **Hallucinated browser/Node APIs** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Hallucinated browser/Node APIs**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Hallucinated browser/Node APIs** in plain English.
