...
2. [Requirement verification](02-Requirement-verification.md)
3. [Syntax/runtime compatibility](03-Syntax-runtime-compatibility.md)
4. [Hallucinated packages](04-Hallucinated-packages.md)
5. [Hallucinated browser/Node APIs](05-Hallucinated-browser-Node-APIs.md)
6. [Async correctness](06-Async-correctness.md)
7. [Promise handling](07-Promise-handling.md)
8. [Security review](08-Security-review.md)
9. [Prototype pollution risk](09-Prototype-pollution-risk.md)
10. [XSS risk](10-XSS-risk.md)
11. [Dependency risk](11-Dependency-risk.md)
12. [Generated tests](12-Generated-tests.md)
13. [Generated regex risk](13-Generated-regex-risk.md)
14. [Generated SQL/shell/config](14-Generated-SQL-shell-config.md)
15. [Performance review](15-Performance-review.md)
16. [Human approval](16-Human-approval.md)

---

# 2. Real-Life Analogy

AI-generated code is a patch from an unknown but talented contributor: useful, never exempt from tests and review.
...
```text
AI Proposal → Runtime/API Verify → Security/Async Review → Tests → Accept/Repair/Reject
```
...
```text
AI-Generated JavaScript Code Evaluation & Safe Engineering Use
...
Evaluate AI-generated snippets for a fetch wrapper, Express route, Promise concurrency helper, DOM renderer, and SQL query. Mark Accept/Repair/Reject.

---

# 8. Google Interview Drill

AI generates an Express route that takes `userId` from the request and returns that user's records without resource authorization. Explain why syntactically valid code is still unsafe.
