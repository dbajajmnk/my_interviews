# Topic 07 — Parameterized/table tests
...
**Parameterized/table tests** is the JavaScript concept **Parameterized/table tests** within Testing: Node Test Runner, Jest/Vitest Awareness, Mocks, Integration, Contract & E2E.

---

# 2. Why

Interviewers use **Parameterized/table tests** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Parameterized/table tests means the JavaScript concept **Parameterized/table tests** within Testing: Node Test Runner, Jest/Vitest Awareness, Mocks, Integration, Contract & E2E. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
In JavaScript applications, **Parameterized/table tests** should be connected to a concrete runtime, API, correctness, debugging, performance, or maintainability requirement.
...
- Use **Parameterized/table tests** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Parameterized/table tests** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Parameterized/table tests**.
...
- Does **Parameterized/table tests** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Parameterized/table tests** is valid for the target runtime and module system.
...
1. What is **Parameterized/table tests**?
2. Why would you use **Parameterized/table tests** in JavaScript?
3. How does **Parameterized/table tests** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Parameterized/table tests**?
5. Where does **Parameterized/table tests** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Parameterized/table tests**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Parameterized/table tests** in plain English.
