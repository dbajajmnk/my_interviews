...
**Stubs** is the JavaScript concept **Stubs** within Testing: Node Test Runner, Jest/Vitest Awareness, Mocks, Integration, Contract & E2E.

---

# 2. Why

Interviewers use **Stubs** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Stubs means the JavaScript concept **Stubs** within Testing: Node Test Runner, Jest/Vitest Awareness, Mocks, Integration, Contract & E2E. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
In JavaScript applications, **Stubs** should be connected to a concrete runtime, API, correctness, debugging, performance, or maintainability requirement.
...
- Use **Stubs** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Stubs** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Stubs**.
...
- Does **Stubs** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Stubs** is valid for the target runtime and module system.
...
1. What is **Stubs**?
2. Why would you use **Stubs** in JavaScript?
3. How does **Stubs** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Stubs**?
5. Where does **Stubs** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Stubs**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Stubs** in plain English.
