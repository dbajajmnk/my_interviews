...
**Fakes** is the JavaScript concept **Fakes** within Testing: Node Test Runner, Jest/Vitest Awareness, Mocks, Integration, Contract & E2E.

---

# 2. Why

Interviewers use **Fakes** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Fakes means the JavaScript concept **Fakes** within Testing: Node Test Runner, Jest/Vitest Awareness, Mocks, Integration, Contract & E2E. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
In JavaScript applications, **Fakes** should be connected to a concrete runtime, API, correctness, debugging, performance, or maintainability requirement.
...
- Use **Fakes** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Fakes** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Fakes**.
...
- Does **Fakes** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Fakes** is valid for the target runtime and module system.
...
1. What is **Fakes**?
2. Why would you use **Fakes** in JavaScript?
3. How does **Fakes** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Fakes**?
5. Where does **Fakes** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Fakes**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Fakes** in plain English.
