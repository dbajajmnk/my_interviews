...
**Integration tests** is the JavaScript concept **Integration tests** within Testing: Node Test Runner, Jest/Vitest Awareness, Mocks, Integration, Contract & E2E.

---

# 2. Why

Interviewers use **Integration tests** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Integration tests means the JavaScript concept **Integration tests** within Testing: Node Test Runner, Jest/Vitest Awareness, Mocks, Integration, Contract & E2E. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
In JavaScript applications, **Integration tests** should be connected to a concrete runtime, API, correctness, debugging, performance, or maintainability requirement.
...
- Use **Integration tests** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Integration tests** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Integration tests**.
...
- Does **Integration tests** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Integration tests** is valid for the target runtime and module system.
...
1. What is **Integration tests**?
2. Why would you use **Integration tests** in JavaScript?
3. How does **Integration tests** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Integration tests**?
5. Where does **Integration tests** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Integration tests**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
