...
**Contract tests** is the JavaScript concept **Contract tests** within Testing: Node Test Runner, Jest/Vitest Awareness, Mocks, Integration, Contract & E2E.

---

# 2. Why

Interviewers use **Contract tests** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Contract tests means the JavaScript concept **Contract tests** within Testing: Node Test Runner, Jest/Vitest Awareness, Mocks, Integration, Contract & E2E. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
In JavaScript applications, **Contract tests** should be connected to a concrete runtime, API, correctness, debugging, performance, or maintainability requirement.
...
- Use **Contract tests** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Contract tests** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Contract tests**.
...
- Does **Contract tests** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Contract tests** is valid for the target runtime and module system.
...
1. What is **Contract tests**?
2. Why would you use **Contract tests** in JavaScript?
3. How does **Contract tests** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Contract tests**?
5. Where does **Contract tests** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Contract tests**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
