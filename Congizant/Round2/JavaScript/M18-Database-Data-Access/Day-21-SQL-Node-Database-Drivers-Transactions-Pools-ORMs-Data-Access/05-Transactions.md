...
**Transactions** is database atomicity boundary.

---

# 2. Why

Interviewers use **Transactions** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Transactions means database atomicity boundary. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
- Use **Transactions** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Transactions** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Transactions**.
...
- Does **Transactions** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Transactions** is valid for the target runtime and module system.
...
2. Why would you use **Transactions** in JavaScript?
3. How does **Transactions** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Transactions**?
5. Where does **Transactions** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Transactions**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
