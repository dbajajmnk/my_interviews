...
**ORM awareness** is the JavaScript concept **ORM awareness** within SQL, Node Database Drivers, Transactions, Pools, ORMs & Data Access.

---

# 2. Why

Interviewers use **ORM awareness** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: ORM awareness means the JavaScript concept **ORM awareness** within SQL, Node Database Drivers, Transactions, Pools, ORMs & Data Access. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
In JavaScript applications, **ORM awareness** should be connected to a concrete runtime, API, correctness, debugging, performance, or maintainability requirement.
...
- Use **ORM awareness** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **ORM awareness** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **ORM awareness**.
...
- Does **ORM awareness** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **ORM awareness** is valid for the target runtime and module system.
...
1. What is **ORM awareness**?
2. Why would you use **ORM awareness** in JavaScript?
3. How does **ORM awareness** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **ORM awareness**?
5. Where does **ORM awareness** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **ORM awareness**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **ORM awareness** in plain English.
