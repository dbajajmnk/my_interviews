...
**Express awareness** is minimal Node web framework awareness.

---

# 2. Why

Interviewers use **Express awareness** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Express awareness means minimal Node web framework awareness. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
- Use **Express awareness** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Express awareness** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Express awareness**.
...
- Does **Express awareness** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Express awareness** is valid for the target runtime and module system.
...
1. What is **Express awareness**?
2. Why would you use **Express awareness** in JavaScript?
3. How does **Express awareness** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Express awareness**?
5. Where does **Express awareness** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Express awareness**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Express awareness** in plain English.
