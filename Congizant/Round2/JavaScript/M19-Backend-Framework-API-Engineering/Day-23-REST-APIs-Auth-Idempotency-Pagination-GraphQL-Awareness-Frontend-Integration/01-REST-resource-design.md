...
**REST resource design** is collecting remaining arguments/elements.

---

# 2. Why

Interviewers use **REST resource design** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: REST resource design means collecting remaining arguments/elements. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.

---

# 4. Engineering Explanation

rest syntax gathers values into an array-like Array in parameters/destructuring A senior answer separates **ECMAScript language guarantees**, **browser/Node host behavior**, and **engine/framework implementation details**.
...
- rest syntax gathers values into an array-like Array in parameters/destructuring
...
In real projects, this matters for variadic APIs.
...
- Use **REST resource design** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **REST resource design** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **REST resource design**.
...
- Does **REST resource design** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **REST resource design** is valid for the target runtime and module system.
...
1. What is **REST resource design**?
2. Why would you use **REST resource design** in JavaScript?
3. How does **REST resource design** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **REST resource design**?
5. Where does **REST resource design** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **REST resource design**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **REST resource design** in plain English.
