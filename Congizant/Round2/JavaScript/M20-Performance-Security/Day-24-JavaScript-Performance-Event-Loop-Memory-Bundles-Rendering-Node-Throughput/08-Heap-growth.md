...
**Heap growth** is runtime memory for objects/functions/closures.

---

# 2. Why

Interviewers use **Heap growth** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Heap growth means runtime memory for objects/functions/closures. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
- Use **Heap growth** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Heap growth** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Heap growth**.
...
- Does **Heap growth** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Heap growth** is valid for the target runtime and module system.
...
1. What is **Heap growth**?
2. Why would you use **Heap growth** in JavaScript?
3. How does **Heap growth** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Heap growth**?
5. Where does **Heap growth** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Heap growth**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Heap growth** in plain English.
