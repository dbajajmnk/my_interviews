...
**Prototype pollution** is attacker modification of object prototype-related properties.

---

# 2. Why

Interviewers use **Prototype pollution** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Prototype pollution means attacker modification of object prototype-related properties. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
- Use **Prototype pollution** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Prototype pollution** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Prototype pollution**.
...
- Does **Prototype pollution** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Prototype pollution** is valid for the target runtime and module system.
...
2. Why would you use **Prototype pollution** in JavaScript?
3. How does **Prototype pollution** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Prototype pollution**?
5. Where does **Prototype pollution** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Prototype pollution**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Prototype pollution** in plain English.
