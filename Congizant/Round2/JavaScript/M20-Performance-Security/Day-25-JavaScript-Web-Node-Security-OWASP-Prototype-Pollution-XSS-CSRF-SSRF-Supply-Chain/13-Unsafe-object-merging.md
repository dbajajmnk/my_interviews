# Topic 13 — Unsafe object merging
...
**Unsafe object merging** is reference-based object identity and mutation.

---

# 2. Why

Interviewers use **Unsafe object merging** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Unsafe object merging means reference-based object identity and mutation. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
- Use **Unsafe object merging** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Unsafe object merging** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Unsafe object merging**.
...
- Does **Unsafe object merging** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Unsafe object merging** is valid for the target runtime and module system.
...
1. What is **Unsafe object merging**?
2. Why would you use **Unsafe object merging** in JavaScript?
3. How does **Unsafe object merging** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Unsafe object merging**?
5. Where does **Unsafe object merging** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Unsafe object merging**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Unsafe object merging** in plain English.
