# Topic 03 — Non-functional requirements
...
**Non-functional requirements** is the JavaScript concept **Non-functional requirements** within System Design with JavaScript/Node: Scalability, Caching, Messaging & Service Boundaries.

---

# 2. Why

Interviewers use **Non-functional requirements** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Non-functional requirements means the JavaScript concept **Non-functional requirements** within System Design with JavaScript/Node: Scalability, Caching, Messaging & Service Boundaries. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
In JavaScript applications, **Non-functional requirements** should be connected to a concrete runtime, API, correctness, debugging, performance, or maintainability requirement.
...
- Use **Non-functional requirements** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Non-functional requirements** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Non-functional requirements**.
...
- Does **Non-functional requirements** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Non-functional requirements** is valid for the target runtime and module system.
...
1. What is **Non-functional requirements**?
2. Why would you use **Non-functional requirements** in JavaScript?
3. How does **Non-functional requirements** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Non-functional requirements**?
5. Where does **Non-functional requirements** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Non-functional requirements**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Non-functional requirements** in plain English.
