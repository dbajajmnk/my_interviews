...
**Jitter** is runtime compilation/optimization of hot code.

---

# 2. Why

Interviewers use **Jitter** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Jitter means runtime compilation/optimization of hot code. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
- Use **Jitter** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Jitter** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Jitter**.
...
- Does **Jitter** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Jitter** is valid for the target runtime and module system.
...
1. What is **Jitter**?
2. Why would you use **Jitter** in JavaScript?
3. How does **Jitter** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Jitter**?
5. Where does **Jitter** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Jitter**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Jitter** in plain English.
