...
**Kubernetes awareness** is orchestration awareness for replicas/network/lifecycle.

---

# 2. Why

Interviewers use **Kubernetes awareness** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Kubernetes awareness means orchestration awareness for replicas/network/lifecycle. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.

---

# 4. Engineering Explanation

Deployment/Service/probes/config/resources automate desired-state operations A senior answer separates **ECMAScript language guarantees**, **browser/Node host behavior**, and **engine/framework implementation details**.
...
- Deployment/Service/probes/config/resources automate desired-state operations
...
In real projects, this matters for production.
...
- Use **Kubernetes awareness** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Kubernetes awareness** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Kubernetes awareness**.
...
- Does **Kubernetes awareness** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Kubernetes awareness** is valid for the target runtime and module system.
...
1. What is **Kubernetes awareness**?
2. Why would you use **Kubernetes awareness** in JavaScript?
3. How does **Kubernetes awareness** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Kubernetes awareness**?
5. Where does **Kubernetes awareness** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Kubernetes awareness**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Kubernetes awareness** in plain English.
