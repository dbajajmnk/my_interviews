# Topic 09 — Readiness vs liveness
...
**Readiness vs liveness** is distinguishing ability to serve traffic from need to restart process.

---

# 2. Why

Interviewers use **Readiness vs liveness** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Readiness vs liveness means distinguishing ability to serve traffic from need to restart process. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
- Use **Readiness vs liveness** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Readiness vs liveness** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Readiness vs liveness**.
...
- Does **Readiness vs liveness** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Readiness vs liveness** is valid for the target runtime and module system.
...
1. What is **Readiness vs liveness**?
2. Why would you use **Readiness vs liveness** in JavaScript?
3. How does **Readiness vs liveness** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Readiness vs liveness**?
5. Where does **Readiness vs liveness** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Readiness vs liveness**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Readiness vs liveness** in plain English.
