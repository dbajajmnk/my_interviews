...
**SLI/SLO/SLA** is measured reliability signal, target, and external commitment.

---

# 2. Why

Interviewers use **SLI/SLO/SLA** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: SLI/SLO/SLA means measured reliability signal, target, and external commitment. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
- Use **SLI/SLO/SLA** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **SLI/SLO/SLA** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **SLI/SLO/SLA**.
...
- Does **SLI/SLO/SLA** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **SLI/SLO/SLA** is valid for the target runtime and module system.
...
1. What is **SLI/SLO/SLA**?
2. Why would you use **SLI/SLO/SLA** in JavaScript?
3. How does **SLI/SLO/SLA** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **SLI/SLO/SLA**?
5. Where does **SLI/SLO/SLA** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **SLI/SLO/SLA**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **SLI/SLO/SLA** in plain English.
