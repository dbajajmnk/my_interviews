...
**Backup/restore** is collecting remaining arguments/elements.

---

# 2. Why

Interviewers use **Backup/restore** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Backup/restore means collecting remaining arguments/elements. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
- Use **Backup/restore** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Backup/restore** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Backup/restore**.
...
- Does **Backup/restore** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Backup/restore** is valid for the target runtime and module system.
...
1. What is **Backup/restore**?
2. Why would you use **Backup/restore** in JavaScript?
3. How does **Backup/restore** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Backup/restore**?
5. Where does **Backup/restore** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Backup/restore**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Backup/restore** in plain English.
