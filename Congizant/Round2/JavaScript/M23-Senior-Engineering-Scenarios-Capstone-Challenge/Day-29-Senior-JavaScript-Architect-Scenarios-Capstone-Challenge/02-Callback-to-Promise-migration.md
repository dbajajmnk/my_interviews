# Topic 02 — Callback-to-Promise migration
...
**Callback-to-Promise migration** is explicitly invoking a function with a chosen `this` and arguments.

---

# 2. Why

Interviewers use **Callback-to-Promise migration** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Callback-to-Promise migration means explicitly invoking a function with a chosen `this` and arguments. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
- Use **Callback-to-Promise migration** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Callback-to-Promise migration** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Callback-to-Promise migration**.
...
- Does **Callback-to-Promise migration** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Callback-to-Promise migration** is valid for the target runtime and module system.
...
1. What is **Callback-to-Promise migration**?
2. Why would you use **Callback-to-Promise migration** in JavaScript?
3. How does **Callback-to-Promise migration** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Callback-to-Promise migration**?
5. Where does **Callback-to-Promise migration** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Callback-to-Promise migration**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **Callback-to-Promise migration** in plain English.
