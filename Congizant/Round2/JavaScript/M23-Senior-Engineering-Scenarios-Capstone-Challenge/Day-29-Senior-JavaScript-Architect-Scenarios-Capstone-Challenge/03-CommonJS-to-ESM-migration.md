# Topic 03 — CommonJS-to-ESM migration
...
**CommonJS-to-ESM migration** is Node's historical require/module.exports system.

---

# 2. Why

Interviewers use **CommonJS-to-ESM migration** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: CommonJS-to-ESM migration means Node's historical require/module.exports system. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
- Use **CommonJS-to-ESM migration** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **CommonJS-to-ESM migration** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **CommonJS-to-ESM migration**.
...
- Does **CommonJS-to-ESM migration** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **CommonJS-to-ESM migration** is valid for the target runtime and module system.
...
1. What is **CommonJS-to-ESM migration**?
2. Why would you use **CommonJS-to-ESM migration** in JavaScript?
3. How does **CommonJS-to-ESM migration** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **CommonJS-to-ESM migration**?
5. Where does **CommonJS-to-ESM migration** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **CommonJS-to-ESM migration**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
...
- [ ] I can define **CommonJS-to-ESM migration** in plain English.
