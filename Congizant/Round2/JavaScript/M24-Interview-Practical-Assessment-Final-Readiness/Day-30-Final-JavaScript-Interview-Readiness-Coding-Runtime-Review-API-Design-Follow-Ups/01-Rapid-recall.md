...
**Rapid recall** is explicitly invoking a function with a chosen `this` and arguments.

---

# 2. Why

Interviewers use **Rapid recall** to test whether you understand actual JavaScript semantics, host/runtime boundaries, failure modes, and engineering trade-offs—not only syntax.

---

# 3. Plain English

Plain English: Rapid recall means explicitly invoking a function with a chosen `this` and arguments. Use it when it solves the stated problem; do not add complexity simply because the feature or pattern exists.
...
- Use **Rapid recall** because a requirement needs it, not because it is fashionable.
...
1. Memorizing **Rapid recall** as trivia without understanding its language/runtime semantics.
...
- Reproduce the smallest failing case involving **Rapid recall**.
...
- Does **Rapid recall** improve correctness or does it hide behavior?
...
- Verify that AI-generated use of **Rapid recall** is valid for the target runtime and module system.
...
1. What is **Rapid recall**?
2. Why would you use **Rapid recall** in JavaScript?
3. How does **Rapid recall** work internally at the level relevant to an engineer?
4. What is one common bug or misconception with **Rapid recall**?
5. Where does **Rapid recall** appear in a real browser/Node system?
...
Create the smallest runnable JavaScript example that demonstrates **Rapid recall**. Then deliberately introduce one realistic misuse, reproduce it, fix it, and explain the review rule that would have caught it.
