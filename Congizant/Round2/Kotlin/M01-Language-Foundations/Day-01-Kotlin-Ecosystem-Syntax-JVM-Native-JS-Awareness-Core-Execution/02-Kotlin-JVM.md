...
**Kotlin/JVM** is the Kotlin engineering concept **Kotlin/JVM**.

---

# 2. Why

Interviewers use **Kotlin/JVM** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Kotlin/JVM** is about the Kotlin engineering concept **Kotlin/JVM**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Kotlin/JVM** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Kotlin/JVM**.
...
- Does **Kotlin/JVM** solve a real requirement?
...
Create the smallest runnable Kotlin example demonstrating **Kotlin/JVM**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Kotlin/JVM** in plain English.
