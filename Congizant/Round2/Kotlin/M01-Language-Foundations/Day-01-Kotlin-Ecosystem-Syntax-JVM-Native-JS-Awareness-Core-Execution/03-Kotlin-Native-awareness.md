# Topic 03 — Kotlin/Native awareness
...
**Kotlin/Native awareness** is the Kotlin engineering concept **Kotlin/Native awareness**.

---

# 2. Why

Interviewers use **Kotlin/Native awareness** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Kotlin/Native awareness** is about the Kotlin engineering concept **Kotlin/Native awareness**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Kotlin/Native awareness** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Kotlin/Native awareness**.
...
- Does **Kotlin/Native awareness** solve a real requirement?
...
1. What is **Kotlin/Native awareness**?
...
Create the smallest runnable Kotlin example demonstrating **Kotlin/Native awareness**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Kotlin/Native awareness** in plain English.
