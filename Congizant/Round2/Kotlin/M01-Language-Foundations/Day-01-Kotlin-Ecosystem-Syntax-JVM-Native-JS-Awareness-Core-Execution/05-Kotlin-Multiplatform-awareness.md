# Topic 05 — Kotlin Multiplatform awareness
...
**Kotlin Multiplatform awareness** is the Kotlin engineering concept **Kotlin Multiplatform awareness**.

---

# 2. Why

Interviewers use **Kotlin Multiplatform awareness** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Kotlin Multiplatform awareness** is about the Kotlin engineering concept **Kotlin Multiplatform awareness**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Kotlin Multiplatform awareness** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Kotlin Multiplatform awareness**.
...
- Does **Kotlin Multiplatform awareness** solve a real requirement?
...
1. What is **Kotlin Multiplatform awareness**?
...
Create the smallest runnable Kotlin example demonstrating **Kotlin Multiplatform awareness**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Kotlin Multiplatform awareness** in plain English.
