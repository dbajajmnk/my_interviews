...
**val vs var** is the Kotlin engineering concept **val vs var**.

---

# 2. Why

Interviewers use **val vs var** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **val vs var** is about the Kotlin engineering concept **val vs var**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **val vs var** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **val vs var**.
...
- Does **val vs var** solve a real requirement?
...
Create the smallest runnable Kotlin example demonstrating **val vs var**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **val vs var** in plain English.
