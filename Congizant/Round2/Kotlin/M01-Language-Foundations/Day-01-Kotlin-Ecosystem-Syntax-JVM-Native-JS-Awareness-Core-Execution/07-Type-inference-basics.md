# Topic 07 — Type inference basics
...
**Type inference basics** is the Kotlin engineering concept **Type inference basics**.

---

# 2. Why

Interviewers use **Type inference basics** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Type inference basics** is about the Kotlin engineering concept **Type inference basics**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Type inference basics** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Type inference basics**.
...
- Does **Type inference basics** solve a real requirement?
...
1. What is **Type inference basics**?
...
Create the smallest runnable Kotlin example demonstrating **Type inference basics**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Type inference basics** in plain English.
