...
**String templates** is the Kotlin engineering concept **String templates**.

---

# 2. Why

Interviewers use **String templates** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **String templates** is about the Kotlin engineering concept **String templates**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **String templates** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **String templates**.
...
- Does **String templates** solve a real requirement?
...
Create the smallest runnable Kotlin example demonstrating **String templates**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **String templates** in plain English.
