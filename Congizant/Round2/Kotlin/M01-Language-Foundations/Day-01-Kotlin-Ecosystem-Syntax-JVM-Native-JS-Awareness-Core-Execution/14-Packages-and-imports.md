...
**Packages and imports** is the Kotlin engineering concept **Packages and imports**.

---

# 2. Why

Interviewers use **Packages and imports** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Packages and imports** is about the Kotlin engineering concept **Packages and imports**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Packages and imports** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Packages and imports**.
...
- Does **Packages and imports** solve a real requirement?
...
1. What is **Packages and imports**?
...
Create the smallest runnable Kotlin example demonstrating **Packages and imports**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Packages and imports** in plain English.
