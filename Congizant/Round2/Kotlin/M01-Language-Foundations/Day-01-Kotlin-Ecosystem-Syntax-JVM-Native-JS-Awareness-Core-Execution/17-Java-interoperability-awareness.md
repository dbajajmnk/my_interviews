# Topic 17 — Java interoperability awareness
...
**Java interoperability awareness** is calling Java and exposing Kotlin APIs to Java.

---

# 2. Why

Interviewers use **Java interoperability awareness** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Java interoperability awareness** is about calling Java and exposing Kotlin APIs to Java. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.

---

# 4. Engineering Explanation

compiler maps Kotlin constructs to JVM signatures and synthetic helpers; nullability/default args/SAMs need boundary awareness
...
In a Kotlin/JVM production system, **Java interoperability awareness** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Java interoperability awareness**.
...
- Does **Java interoperability awareness** solve a real requirement?
...
1. What is **Java interoperability awareness**?
...
Create the smallest runnable Kotlin example demonstrating **Java interoperability awareness**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Java interoperability awareness** in plain English.
