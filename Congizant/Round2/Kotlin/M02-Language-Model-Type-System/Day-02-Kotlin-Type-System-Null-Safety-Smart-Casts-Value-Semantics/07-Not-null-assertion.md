...
**Not-null assertion** is forcing a nullable value to be treated as non-null.

---

# 2. Why

Interviewers use **Not-null assertion** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Not-null assertion** is about forcing a nullable value to be treated as non-null. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.

---

# 4. Engineering Explanation

`!!` throws KotlinNullPointerException if the value is null and should be rare
...
In a Kotlin/JVM production system, **Not-null assertion** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Not-null assertion**.
...
- Does **Not-null assertion** solve a real requirement?
...
Create the smallest runnable Kotlin example demonstrating **Not-null assertion**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Not-null assertion** in plain English.
