...
**Named arguments** is the Kotlin engineering concept **Named arguments**.

---

# 2. Why

Interviewers use **Named arguments** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Named arguments** is about the Kotlin engineering concept **Named arguments**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Named arguments** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Named arguments**.
...
- Does **Named arguments** solve a real requirement?
...
Create the smallest runnable Kotlin example demonstrating **Named arguments**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Named arguments** in plain English.
