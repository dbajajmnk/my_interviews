...
**Primary constructors** is the Kotlin engineering concept **Primary constructors**.

---

# 2. Why

Interviewers use **Primary constructors** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Primary constructors** is about the Kotlin engineering concept **Primary constructors**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Primary constructors** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Primary constructors**.
...
- Does **Primary constructors** solve a real requirement?
...
1. What is **Primary constructors**?
...
Create the smallest runnable Kotlin example demonstrating **Primary constructors**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Primary constructors** in plain English.
