# Topic 03 — Secondary constructors
...
**Secondary constructors** is the Kotlin engineering concept **Secondary constructors**.

---

# 2. Why

Interviewers use **Secondary constructors** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Secondary constructors** is about the Kotlin engineering concept **Secondary constructors**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Secondary constructors** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Secondary constructors**.
...
- Does **Secondary constructors** solve a real requirement?
...
1. What is **Secondary constructors**?
...
Create the smallest runnable Kotlin example demonstrating **Secondary constructors**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Secondary constructors** in plain English.
