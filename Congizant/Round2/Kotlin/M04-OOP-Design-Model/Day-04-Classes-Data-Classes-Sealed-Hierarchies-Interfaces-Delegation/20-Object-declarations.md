...
**Object declarations** is language-level singleton declaration.

---

# 2. Why

Interviewers use **Object declarations** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Object declarations** is about language-level singleton declaration. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.

---

# 4. Engineering Explanation

object is initialized lazily/thread-safely on JVM according to language/JVM compilation semantics
...
In a Kotlin/JVM production system, **Object declarations** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Object declarations**.
...
- Does **Object declarations** solve a real requirement?
...
Create the smallest runnable Kotlin example demonstrating **Object declarations**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Object declarations** in plain English.
