...
**Cohesion and coupling** is the Kotlin engineering concept **Cohesion and coupling**.

---

# 2. Why

Interviewers use **Cohesion and coupling** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Cohesion and coupling** is about the Kotlin engineering concept **Cohesion and coupling**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Cohesion and coupling** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Does **Cohesion and coupling** solve a real requirement?
...
Create the smallest runnable Kotlin example demonstrating **Cohesion and coupling**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
