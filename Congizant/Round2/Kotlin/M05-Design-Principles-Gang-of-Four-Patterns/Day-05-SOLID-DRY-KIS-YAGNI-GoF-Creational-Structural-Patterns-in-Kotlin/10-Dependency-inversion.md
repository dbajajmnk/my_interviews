...
**Dependency inversion** is the Kotlin engineering concept **Dependency inversion**.

---

# 2. Why

Interviewers use **Dependency inversion** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Dependency inversion** is about the Kotlin engineering concept **Dependency inversion**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Dependency inversion** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Does **Dependency inversion** solve a real requirement?
...
Create the smallest runnable Kotlin example demonstrating **Dependency inversion**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
