...
**Pattern trade-off defense** is the Kotlin engineering concept **Pattern trade-off defense**.

---

# 2. Why

Interviewers use **Pattern trade-off defense** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Pattern trade-off defense** is about the Kotlin engineering concept **Pattern trade-off defense**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Pattern trade-off defense** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Does **Pattern trade-off defense** solve a real requirement?
...
Create the smallest runnable Kotlin example demonstrating **Pattern trade-off defense**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
