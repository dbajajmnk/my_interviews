...
Day 05 keeps the GOJ structure familiar while translating it into Kotlin-native language, JVM, coroutine, and backend engineering decisions.
...
```text
Change Pressure → SOLID/Pattern → Kotlin-Native Abstraction → Trade-Off
```
...
```text
SOLID, DRY, KIS, YAGNI & GoF Creational/Structural Patterns in Kotlin
├── Kotlin Semantics
...
Refactor a service that constructs concrete dependencies; implement Kotlin-native examples of core creational/structural patterns.

---

# 8. Google Interview Drill

Remove patterns that functions, delegation, sealed types or data classes make unnecessary.
