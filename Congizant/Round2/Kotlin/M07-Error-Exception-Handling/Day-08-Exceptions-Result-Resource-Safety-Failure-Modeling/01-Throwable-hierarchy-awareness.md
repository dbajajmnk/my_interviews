# Topic 01 — Throwable hierarchy awareness
...
**Throwable hierarchy awareness** is the Kotlin engineering concept **Throwable hierarchy awareness**.

---

# 2. Why

Interviewers use **Throwable hierarchy awareness** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Throwable hierarchy awareness** is about the Kotlin engineering concept **Throwable hierarchy awareness**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Throwable hierarchy awareness** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Throwable hierarchy awareness**.
...
- Does **Throwable hierarchy awareness** solve a real requirement?
...
1. What is **Throwable hierarchy awareness**?
...
Create the smallest runnable Kotlin example demonstrating **Throwable hierarchy awareness**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Throwable hierarchy awareness** in plain English.
