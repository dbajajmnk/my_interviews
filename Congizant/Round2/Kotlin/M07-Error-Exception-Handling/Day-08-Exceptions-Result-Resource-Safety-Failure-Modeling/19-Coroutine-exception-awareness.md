# Topic 19 — Coroutine exception awareness
...
**Coroutine exception awareness** is the Kotlin engineering concept **Coroutine exception awareness**.

---

# 2. Why

Interviewers use **Coroutine exception awareness** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Coroutine exception awareness** is about the Kotlin engineering concept **Coroutine exception awareness**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Coroutine exception awareness** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Coroutine exception awareness**.
...
- Does **Coroutine exception awareness** solve a real requirement?
...
1. What is **Coroutine exception awareness**?
...
Create the smallest runnable Kotlin example demonstrating **Coroutine exception awareness**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Coroutine exception awareness** in plain English.
