# Topic 05 — Gradle Kotlin DSL awareness
...
**Gradle Kotlin DSL awareness** is build/dependency automation.

---

# 2. Why

Interviewers use **Gradle Kotlin DSL awareness** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Gradle Kotlin DSL awareness** is about build/dependency automation. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Gradle Kotlin DSL awareness** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Gradle Kotlin DSL awareness**.
...
- Does **Gradle Kotlin DSL awareness** solve a real requirement?
...
1. What is **Gradle Kotlin DSL awareness**?
...
Create the smallest runnable Kotlin example demonstrating **Gradle Kotlin DSL awareness**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Gradle Kotlin DSL awareness** in plain English.
