# Topic 09 — implementation vs api awareness
...
**implementation vs api awareness** is the Kotlin engineering concept **implementation vs api awareness**.

---

# 2. Why

Interviewers use **implementation vs api awareness** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **implementation vs api awareness** is about the Kotlin engineering concept **implementation vs api awareness**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **implementation vs api awareness** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **implementation vs api awareness**.
...
- Does **implementation vs api awareness** solve a real requirement?
...
1. What is **implementation vs api awareness**?
...
Create the smallest runnable Kotlin example demonstrating **implementation vs api awareness**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **implementation vs api awareness** in plain English.
