# Topic 10 — testImplementation awareness
...
**testImplementation awareness** is the Kotlin engineering concept **testImplementation awareness**.

---

# 2. Why

Interviewers use **testImplementation awareness** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **testImplementation awareness** is about the Kotlin engineering concept **testImplementation awareness**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **testImplementation awareness** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **testImplementation awareness**.
...
- Does **testImplementation awareness** solve a real requirement?
...
1. What is **testImplementation awareness**?
...
Create the smallest runnable Kotlin example demonstrating **testImplementation awareness**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **testImplementation awareness** in plain English.
