# Topic 11 — Version catalogs awareness
...
**Version catalogs awareness** is the Kotlin engineering concept **Version catalogs awareness**.

---

# 2. Why

Interviewers use **Version catalogs awareness** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Version catalogs awareness** is about the Kotlin engineering concept **Version catalogs awareness**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Version catalogs awareness** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Version catalogs awareness**.
...
- Does **Version catalogs awareness** solve a real requirement?
...
1. What is **Version catalogs awareness**?
...
Create the smallest runnable Kotlin example demonstrating **Version catalogs awareness**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Version catalogs awareness** in plain English.
