# Topic 14 — Source sets awareness
...
**Source sets awareness** is the Kotlin engineering concept **Source sets awareness**.

---

# 2. Why

Interviewers use **Source sets awareness** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Source sets awareness** is about the Kotlin engineering concept **Source sets awareness**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Source sets awareness** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Source sets awareness**.
...
- Does **Source sets awareness** solve a real requirement?
...
1. What is **Source sets awareness**?
...
Create the smallest runnable Kotlin example demonstrating **Source sets awareness**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Source sets awareness** in plain English.
