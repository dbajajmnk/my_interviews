# Topic 16 — Java toolchain awareness
...
**Java toolchain awareness** is the Kotlin engineering concept **Java toolchain awareness**.

---

# 2. Why

Interviewers use **Java toolchain awareness** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Java toolchain awareness** is about the Kotlin engineering concept **Java toolchain awareness**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Java toolchain awareness** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Java toolchain awareness**.
...
- Does **Java toolchain awareness** solve a real requirement?
...
1. What is **Java toolchain awareness**?
...
Create the smallest runnable Kotlin example demonstrating **Java toolchain awareness**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Java toolchain awareness** in plain English.
