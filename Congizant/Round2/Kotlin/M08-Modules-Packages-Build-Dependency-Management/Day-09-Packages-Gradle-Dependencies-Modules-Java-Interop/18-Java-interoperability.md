# Topic 18 — Java interoperability
...
**Java interoperability** is calling Java and exposing Kotlin APIs to Java.

---

# 2. Why

Interviewers use **Java interoperability** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Java interoperability** is about calling Java and exposing Kotlin APIs to Java. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Java interoperability** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Java interoperability**.
...
- Does **Java interoperability** solve a real requirement?
...
1. What is **Java interoperability**?
...
Create the smallest runnable Kotlin example demonstrating **Java interoperability**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Java interoperability** in plain English.
