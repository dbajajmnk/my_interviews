# Topic 02 — Decompilation awareness
...
**Decompilation awareness** is the Kotlin engineering concept **Decompilation awareness**.

---

# 2. Why

Interviewers use **Decompilation awareness** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Decompilation awareness** is about the Kotlin engineering concept **Decompilation awareness**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Decompilation awareness** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Decompilation awareness**.
...
- Does **Decompilation awareness** solve a real requirement?
...
1. What is **Decompilation awareness**?
...
Create the smallest runnable Kotlin example demonstrating **Decompilation awareness**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Decompilation awareness** in plain English.
