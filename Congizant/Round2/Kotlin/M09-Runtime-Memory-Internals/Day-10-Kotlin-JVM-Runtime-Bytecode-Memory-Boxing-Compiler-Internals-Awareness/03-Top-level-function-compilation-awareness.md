# Topic 03 — Top-level function compilation awareness
...
**Top-level function compilation awareness** is the Kotlin engineering concept **Top-level function compilation awareness**.

---

# 2. Why

Interviewers use **Top-level function compilation awareness** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Top-level function compilation awareness** is about the Kotlin engineering concept **Top-level function compilation awareness**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Top-level function compilation awareness** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Top-level function compilation awareness**.
...
- Does **Top-level function compilation awareness** solve a real requirement?
...
1. What is **Top-level function compilation awareness**?
...
Create the smallest runnable Kotlin example demonstrating **Top-level function compilation awareness**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Top-level function compilation awareness** in plain English.
