# Topic 04 — Companion/object compilation awareness
...
**Companion/object compilation awareness** is object associated with a class rather than Java static members.

---

# 2. Why

Interviewers use **Companion/object compilation awareness** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Companion/object compilation awareness** is about object associated with a class rather than Java static members. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.

---

# 4. Engineering Explanation

compiler emits companion machinery; @JvmStatic may generate Java-friendly static bridge
...
```kotlin
class C { companion object { fun create()=C() } }
```
...
In a Kotlin/JVM production system, **Companion/object compilation awareness** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Companion/object compilation awareness**.
...
- Does **Companion/object compilation awareness** solve a real requirement?
...
1. What is **Companion/object compilation awareness**?
...
Create the smallest runnable Kotlin example demonstrating **Companion/object compilation awareness**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Companion/object compilation awareness** in plain English.
