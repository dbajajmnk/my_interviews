# Topic 05 — Data class generated members
...
**Data class generated members** is value-oriented class with generated members.

---

# 2. Why

Interviewers use **Data class generated members** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Data class generated members** is about value-oriented class with generated members. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.

---

# 4. Engineering Explanation

compiler generates equals/hashCode/toString/componentN/copy based on primary constructor properties
...
In a Kotlin/JVM production system, **Data class generated members** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Data class generated members**.
...
- Does **Data class generated members** solve a real requirement?
...
1. What is **Data class generated members**?
...
Create the smallest runnable Kotlin example demonstrating **Data class generated members**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Data class generated members** in plain English.
