# Topic 10 — Boxing and unboxing awareness
...
**Boxing and unboxing awareness** is wrapping primitive-like values in objects when generics/nullability/runtime representation requires it.

---

# 2. Why

Interviewers use **Boxing and unboxing awareness** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Boxing and unboxing awareness** is about wrapping primitive-like values in objects when generics/nullability/runtime representation requires it. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.

---

# 4. Engineering Explanation

JVM representation can differ between `Int` and `Int?` or generic `T`
...
In a Kotlin/JVM production system, **Boxing and unboxing awareness** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Boxing and unboxing awareness**.
...
- Does **Boxing and unboxing awareness** solve a real requirement?
...
1. What is **Boxing and unboxing awareness**?
...
Create the smallest runnable Kotlin example demonstrating **Boxing and unboxing awareness**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Boxing and unboxing awareness** in plain English.
