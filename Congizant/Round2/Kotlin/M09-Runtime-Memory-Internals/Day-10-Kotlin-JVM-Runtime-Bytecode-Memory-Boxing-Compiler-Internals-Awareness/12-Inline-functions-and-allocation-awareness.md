# Topic 12 — Inline functions and allocation awareness
...
**Inline functions and allocation awareness** is request to inline function body at call sites subject to compiler constraints.

---

# 2. Why

Interviewers use **Inline functions and allocation awareness** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Inline functions and allocation awareness** is about request to inline function body at call sites subject to compiler constraints. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.

---

# 4. Engineering Explanation

especially useful for higher-order APIs to reduce lambda allocations and enable reified types
...
In a Kotlin/JVM production system, **Inline functions and allocation awareness** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Inline functions and allocation awareness**.
...
- Does **Inline functions and allocation awareness** solve a real requirement?
...
1. What is **Inline functions and allocation awareness**?
...
Create the smallest runnable Kotlin example demonstrating **Inline functions and allocation awareness**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Inline functions and allocation awareness** in plain English.
