# Topic 15 — Class loading awareness
...
**Class loading awareness** is the Kotlin engineering concept **Class loading awareness**.

---

# 2. Why

Interviewers use **Class loading awareness** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Class loading awareness** is about the Kotlin engineering concept **Class loading awareness**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Class loading awareness** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Class loading awareness**.
...
- Does **Class loading awareness** solve a real requirement?
...
1. What is **Class loading awareness**?
...
Create the smallest runnable Kotlin example demonstrating **Class loading awareness**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Class loading awareness** in plain English.
