# Topic 16 — Reflection cost awareness
...
**Reflection cost awareness** is the Kotlin engineering concept **Reflection cost awareness**.

---

# 2. Why

Interviewers use **Reflection cost awareness** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Reflection cost awareness** is about the Kotlin engineering concept **Reflection cost awareness**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Reflection cost awareness** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Reflection cost awareness**.
...
- Does **Reflection cost awareness** solve a real requirement?
...
1. What is **Reflection cost awareness**?
...
Create the smallest runnable Kotlin example demonstrating **Reflection cost awareness**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Reflection cost awareness** in plain English.
