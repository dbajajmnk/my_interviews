# Topic 03 — Continuation awareness
...
**Continuation awareness** is the Kotlin engineering concept **Continuation awareness**.

---

# 2. Why

Interviewers use **Continuation awareness** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Continuation awareness** is about the Kotlin engineering concept **Continuation awareness**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Continuation awareness** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Continuation awareness**.
...
- Does **Continuation awareness** solve a real requirement?
...
1. What is **Continuation awareness**?
...
Create the smallest runnable Kotlin example demonstrating **Continuation awareness**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Continuation awareness** in plain English.
