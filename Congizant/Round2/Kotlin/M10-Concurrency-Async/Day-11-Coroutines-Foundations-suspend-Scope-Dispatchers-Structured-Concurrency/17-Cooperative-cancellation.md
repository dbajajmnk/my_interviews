# Topic 17 — Cooperative cancellation
...
**Cooperative cancellation** is the Kotlin engineering concept **Cooperative cancellation**.

---

# 2. Why

Interviewers use **Cooperative cancellation** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Cooperative cancellation** is about the Kotlin engineering concept **Cooperative cancellation**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Cooperative cancellation** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Cooperative cancellation**.
...
- Does **Cooperative cancellation** solve a real requirement?
...
1. What is **Cooperative cancellation**?
...
Create the smallest runnable Kotlin example demonstrating **Cooperative cancellation**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Cooperative cancellation** in plain English.
