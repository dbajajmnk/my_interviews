# Topic 20 — SupervisorJob awareness
...
**SupervisorJob awareness** is the Kotlin engineering concept **SupervisorJob awareness**.

---

# 2. Why

Interviewers use **SupervisorJob awareness** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **SupervisorJob awareness** is about the Kotlin engineering concept **SupervisorJob awareness**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **SupervisorJob awareness** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **SupervisorJob awareness**.
...
- Does **SupervisorJob awareness** solve a real requirement?
...
1. What is **SupervisorJob awareness**?
...
Create the smallest runnable Kotlin example demonstrating **SupervisorJob awareness**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **SupervisorJob awareness** in plain English.
