# Topic 22 — Coroutine exception propagation
...
**Coroutine exception propagation** is the Kotlin engineering concept **Coroutine exception propagation**.

---

# 2. Why

Interviewers use **Coroutine exception propagation** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Coroutine exception propagation** is about the Kotlin engineering concept **Coroutine exception propagation**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Coroutine exception propagation** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Coroutine exception propagation**.
...
- Does **Coroutine exception propagation** solve a real requirement?
...
1. What is **Coroutine exception propagation**?
...
Create the smallest runnable Kotlin example demonstrating **Coroutine exception propagation**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Coroutine exception propagation** in plain English.
