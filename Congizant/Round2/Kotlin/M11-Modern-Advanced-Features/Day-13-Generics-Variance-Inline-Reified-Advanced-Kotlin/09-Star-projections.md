...
**Star projections** is the Kotlin engineering concept **Star projections**.

---

# 2. Why

Interviewers use **Star projections** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Star projections** is about the Kotlin engineering concept **Star projections**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Star projections** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Star projections**.
...
- Does **Star projections** solve a real requirement?
...
Create the smallest runnable Kotlin example demonstrating **Star projections**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Star projections** in plain English.
