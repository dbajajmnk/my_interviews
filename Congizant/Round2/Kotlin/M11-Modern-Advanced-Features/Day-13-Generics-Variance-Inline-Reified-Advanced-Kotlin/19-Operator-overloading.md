...
**Operator overloading** is the Kotlin engineering concept **Operator overloading**.

---

# 2. Why

Interviewers use **Operator overloading** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Operator overloading** is about the Kotlin engineering concept **Operator overloading**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Operator overloading** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Operator overloading**.
...
- Does **Operator overloading** solve a real requirement?
...
Create the smallest runnable Kotlin example demonstrating **Operator overloading**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Operator overloading** in plain English.
