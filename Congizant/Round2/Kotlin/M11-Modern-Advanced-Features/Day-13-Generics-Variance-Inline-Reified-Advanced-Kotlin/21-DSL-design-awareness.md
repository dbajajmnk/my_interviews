...
**DSL design awareness** is the Kotlin engineering concept **DSL design awareness**.

---

# 2. Why

Interviewers use **DSL design awareness** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **DSL design awareness** is about the Kotlin engineering concept **DSL design awareness**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **DSL design awareness** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **DSL design awareness**.
...
- Does **DSL design awareness** solve a real requirement?
...
1. What is **DSL design awareness**?
...
Create the smallest runnable Kotlin example demonstrating **DSL design awareness**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **DSL design awareness** in plain English.
