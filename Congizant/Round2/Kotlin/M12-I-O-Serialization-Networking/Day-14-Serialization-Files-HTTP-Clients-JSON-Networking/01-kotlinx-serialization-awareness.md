# Topic 01 — kotlinx.serialization awareness
...
**kotlinx.serialization awareness** is encoding/decoding typed data to external representation.

---

# 2. Why

Interviewers use **kotlinx.serialization awareness** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **kotlinx.serialization awareness** is about encoding/decoding typed data to external representation. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **kotlinx.serialization awareness** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **kotlinx.serialization awareness**.
...
- Does **kotlinx.serialization awareness** solve a real requirement?
...
1. What is **kotlinx.serialization awareness**?
...
Create the smallest runnable Kotlin example demonstrating **kotlinx.serialization awareness**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **kotlinx.serialization awareness** in plain English.
