# Topic 02 — Serializable annotation awareness
...
**Serializable annotation awareness** is the Kotlin engineering concept **Serializable annotation awareness**.

---

# 2. Why

Interviewers use **Serializable annotation awareness** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Serializable annotation awareness** is about the Kotlin engineering concept **Serializable annotation awareness**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Serializable annotation awareness** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Serializable annotation awareness**.
...
- Does **Serializable annotation awareness** solve a real requirement?
...
1. What is **Serializable annotation awareness**?
...
Create the smallest runnable Kotlin example demonstrating **Serializable annotation awareness**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Serializable annotation awareness** in plain English.
