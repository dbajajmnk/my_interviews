# Topic 05 — Unknown fields awareness
...
**Unknown fields awareness** is the Kotlin engineering concept **Unknown fields awareness**.

---

# 2. Why

Interviewers use **Unknown fields awareness** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Unknown fields awareness** is about the Kotlin engineering concept **Unknown fields awareness**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Unknown fields awareness** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Unknown fields awareness**.
...
- Does **Unknown fields awareness** solve a real requirement?
...
1. What is **Unknown fields awareness**?
...
Create the smallest runnable Kotlin example demonstrating **Unknown fields awareness**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Unknown fields awareness** in plain English.
