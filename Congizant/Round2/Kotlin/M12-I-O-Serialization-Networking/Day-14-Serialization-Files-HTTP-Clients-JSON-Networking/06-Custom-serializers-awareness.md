# Topic 06 — Custom serializers awareness
...
**Custom serializers awareness** is the Kotlin engineering concept **Custom serializers awareness**.

---

# 2. Why

Interviewers use **Custom serializers awareness** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Custom serializers awareness** is about the Kotlin engineering concept **Custom serializers awareness**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Custom serializers awareness** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Custom serializers awareness**.
...
- Does **Custom serializers awareness** solve a real requirement?
...
1. What is **Custom serializers awareness**?
...
Create the smallest runnable Kotlin example demonstrating **Custom serializers awareness**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Custom serializers awareness** in plain English.
