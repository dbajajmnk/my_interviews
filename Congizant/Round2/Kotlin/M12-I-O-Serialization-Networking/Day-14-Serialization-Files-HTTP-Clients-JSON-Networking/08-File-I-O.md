...
**File I/O** is the Kotlin engineering concept **File I/O**.

---

# 2. Why

Interviewers use **File I/O** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **File I/O** is about the Kotlin engineering concept **File I/O**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **File I/O** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **File I/O**.
...
- Does **File I/O** solve a real requirement?
...
Create the smallest runnable Kotlin example demonstrating **File I/O**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **File I/O** in plain English.
