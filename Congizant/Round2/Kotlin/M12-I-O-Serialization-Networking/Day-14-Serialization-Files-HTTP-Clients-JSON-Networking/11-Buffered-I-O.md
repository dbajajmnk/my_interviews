...
**Buffered I/O** is the Kotlin engineering concept **Buffered I/O**.

---

# 2. Why

Interviewers use **Buffered I/O** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Buffered I/O** is about the Kotlin engineering concept **Buffered I/O**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Buffered I/O** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Buffered I/O**.
...
- Does **Buffered I/O** solve a real requirement?
...
Create the smallest runnable Kotlin example demonstrating **Buffered I/O**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Buffered I/O** in plain English.
