# Topic 13 — Ktor client awareness
...
**Ktor client awareness** is Kotlin-first asynchronous server/client framework.

---

# 2. Why

Interviewers use **Ktor client awareness** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Ktor client awareness** is about Kotlin-first asynchronous server/client framework. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Ktor client awareness** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Ktor client awareness**.
...
- Does **Ktor client awareness** solve a real requirement?
...
1. What is **Ktor client awareness**?
...
Create the smallest runnable Kotlin example demonstrating **Ktor client awareness**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Ktor client awareness** in plain English.
