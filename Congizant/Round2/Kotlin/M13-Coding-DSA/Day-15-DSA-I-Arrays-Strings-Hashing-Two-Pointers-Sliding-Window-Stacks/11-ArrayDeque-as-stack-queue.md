# Topic 11 — ArrayDeque as stack/queue
...
**ArrayDeque as stack/queue** is the Kotlin engineering concept **ArrayDeque as stack/queue**.

---

# 2. Why

Interviewers use **ArrayDeque as stack/queue** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **ArrayDeque as stack/queue** is about the Kotlin engineering concept **ArrayDeque as stack/queue**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **ArrayDeque as stack/queue** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **ArrayDeque as stack/queue**.
...
- Does **ArrayDeque as stack/queue** solve a real requirement?
...
1. What is **ArrayDeque as stack/queue**?
...
Create the smallest runnable Kotlin example demonstrating **ArrayDeque as stack/queue**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **ArrayDeque as stack/queue** in plain English.
