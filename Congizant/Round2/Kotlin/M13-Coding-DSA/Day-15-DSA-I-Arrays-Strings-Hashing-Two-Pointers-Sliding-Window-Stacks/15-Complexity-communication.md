# Topic 15 — Complexity communication
...
**Complexity communication** is the Kotlin engineering concept **Complexity communication**.

---

# 2. Why

Interviewers use **Complexity communication** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Complexity communication** is about the Kotlin engineering concept **Complexity communication**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Complexity communication** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Does **Complexity communication** solve a real requirement?
...
Create the smallest runnable Kotlin example demonstrating **Complexity communication**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
