...
15. [Complexity communication](15-Complexity-communication.md)

---

# 2. Real-Life Analogy

Day 15 keeps the GOJ structure familiar while translating it into Kotlin-native language, JVM, coroutine, and backend engineering decisions.
...
```text
Clarify → brute force → hash/pointer/window → code → tests/complexity
```
...
Solve Two Sum, longest substring, valid parentheses and a window problem in Kotlin.

---

# 8. Google Interview Drill

Derive O(n) sliding-window solution and defend the invariant.
