...
6. [PriorityQueue/heap awareness](06-PriorityQueue-heap-awareness.md)
7. [Top-K](07-Top-K.md)
...
14. [V and E complexity](14-V-and-E-complexity.md)
...
Day 16 keeps the GOJ structure familiar while translating it into Kotlin-native language, JVM, coroutine, and backend engineering decisions.
...
Implement tree depth, BFS, graph reachability, cycle detection and topological order.

---

# 8. Google Interview Drill

Detect cycles and produce build order for service dependencies.
