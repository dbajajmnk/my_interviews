# Topic 02 — IDE debugger awareness
...
**IDE debugger awareness** is the Kotlin engineering concept **IDE debugger awareness**.

---

# 2. Why

Interviewers use **IDE debugger awareness** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **IDE debugger awareness** is about the Kotlin engineering concept **IDE debugger awareness**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **IDE debugger awareness** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **IDE debugger awareness**.
...
- Does **IDE debugger awareness** solve a real requirement?
...
1. What is **IDE debugger awareness**?
...
Create the smallest runnable Kotlin example demonstrating **IDE debugger awareness**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **IDE debugger awareness** in plain English.
