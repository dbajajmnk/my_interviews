...
**Deadlock diagnosis** is the Kotlin engineering concept **Deadlock diagnosis**.

---

# 2. Why

Interviewers use **Deadlock diagnosis** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Deadlock diagnosis** is about the Kotlin engineering concept **Deadlock diagnosis**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Deadlock diagnosis** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Does **Deadlock diagnosis** solve a real requirement?
...
Create the smallest runnable Kotlin example demonstrating **Deadlock diagnosis**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
