...
**Inheritance abuse** is the Kotlin engineering concept **Inheritance abuse**.

---

# 2. Why

Interviewers use **Inheritance abuse** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Inheritance abuse** is about the Kotlin engineering concept **Inheritance abuse**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Inheritance abuse** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Does **Inheritance abuse** solve a real requirement?
...
Create the smallest runnable Kotlin example demonstrating **Inheritance abuse**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
