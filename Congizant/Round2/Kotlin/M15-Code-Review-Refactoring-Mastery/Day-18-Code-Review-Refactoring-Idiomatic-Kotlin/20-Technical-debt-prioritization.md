# Topic 20 — Technical debt prioritization
...
**Technical debt prioritization** is the Kotlin engineering concept **Technical debt prioritization**.

---

# 2. Why

Interviewers use **Technical debt prioritization** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Technical debt prioritization** is about the Kotlin engineering concept **Technical debt prioritization**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Technical debt prioritization** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Technical debt prioritization**.
...
- Does **Technical debt prioritization** solve a real requirement?
...
Create the smallest runnable Kotlin example demonstrating **Technical debt prioritization**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
