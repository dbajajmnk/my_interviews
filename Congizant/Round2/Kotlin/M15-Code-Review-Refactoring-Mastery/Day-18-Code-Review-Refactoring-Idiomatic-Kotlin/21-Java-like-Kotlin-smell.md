# Topic 21 — Java-like Kotlin smell
...
**Java-like Kotlin smell** is the Kotlin engineering concept **Java-like Kotlin smell**.

---

# 2. Why

Interviewers use **Java-like Kotlin smell** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Java-like Kotlin smell** is about the Kotlin engineering concept **Java-like Kotlin smell**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Java-like Kotlin smell** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Java-like Kotlin smell**.
...
- Does **Java-like Kotlin smell** solve a real requirement?
...
1. What is **Java-like Kotlin smell**?
...
Create the smallest runnable Kotlin example demonstrating **Java-like Kotlin smell**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Java-like Kotlin smell** in plain English.
