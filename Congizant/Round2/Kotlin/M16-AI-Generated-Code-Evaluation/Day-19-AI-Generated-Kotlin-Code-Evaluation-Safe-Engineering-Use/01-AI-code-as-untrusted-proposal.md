...
**AI code as untrusted proposal** is treating generated Kotlin as untrusted source.

---

# 2. Why

Interviewers use **AI code as untrusted proposal** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **AI code as untrusted proposal** is about treating generated Kotlin as untrusted source. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.

---

# 4. Engineering Explanation

compile/test/review generated APIs, Gradle coordinates, coroutine semantics and framework usage
...
In a Kotlin/JVM production system, **AI code as untrusted proposal** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Does **AI code as untrusted proposal** solve a real requirement?
...
Create the smallest runnable Kotlin example demonstrating **AI code as untrusted proposal**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
