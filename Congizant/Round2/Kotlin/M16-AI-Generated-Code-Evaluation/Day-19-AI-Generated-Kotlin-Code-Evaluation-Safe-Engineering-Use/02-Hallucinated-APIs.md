...
**Hallucinated APIs** is the Kotlin engineering concept **Hallucinated APIs**.

---

# 2. Why

Interviewers use **Hallucinated APIs** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Hallucinated APIs** is about the Kotlin engineering concept **Hallucinated APIs**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Hallucinated APIs** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Hallucinated APIs**.
...
- Does **Hallucinated APIs** solve a real requirement?
...
Create the smallest runnable Kotlin example demonstrating **Hallucinated APIs**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Hallucinated APIs** in plain English.
