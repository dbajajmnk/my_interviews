# Topic 03 — Hallucinated Gradle dependencies
...
**Hallucinated Gradle dependencies** is build/dependency automation.

---

# 2. Why

Interviewers use **Hallucinated Gradle dependencies** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Hallucinated Gradle dependencies** is about build/dependency automation. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.

---

# 4. Engineering Explanation

Gradle resolves dependency graphs, compiles Kotlin through plugins/tasks and packages artifacts
...
In a Kotlin/JVM production system, **Hallucinated Gradle dependencies** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Hallucinated Gradle dependencies**.
...
- Does **Hallucinated Gradle dependencies** solve a real requirement?
...
1. What is **Hallucinated Gradle dependencies**?
...
Create the smallest runnable Kotlin example demonstrating **Hallucinated Gradle dependencies**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Hallucinated Gradle dependencies** in plain English.
