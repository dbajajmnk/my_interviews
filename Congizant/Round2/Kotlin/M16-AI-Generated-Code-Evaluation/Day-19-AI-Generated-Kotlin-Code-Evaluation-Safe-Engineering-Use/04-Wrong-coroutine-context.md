# Topic 04 — Wrong coroutine context
...
**Wrong coroutine context** is the Kotlin engineering concept **Wrong coroutine context**.

---

# 2. Why

Interviewers use **Wrong coroutine context** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Wrong coroutine context** is about the Kotlin engineering concept **Wrong coroutine context**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Wrong coroutine context** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Wrong coroutine context**.
...
- Does **Wrong coroutine context** solve a real requirement?
...
1. What is **Wrong coroutine context**?
...
Create the smallest runnable Kotlin example demonstrating **Wrong coroutine context**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Wrong coroutine context** in plain English.
