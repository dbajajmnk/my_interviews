...
**Platform type misuse** is Java-interoperability type with relaxed nullability information.

---

# 2. Why

Interviewers use **Platform type misuse** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Platform type misuse** is about Java-interoperability type with relaxed nullability information. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Platform type misuse** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Platform type misuse**.
...
- Does **Platform type misuse** solve a real requirement?
...
1. What is **Platform type misuse**?
...
Create the smallest runnable Kotlin example demonstrating **Platform type misuse**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Platform type misuse** in plain English.
