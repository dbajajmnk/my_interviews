# Topic 11 — Java interop mistakes
...
**Java interop mistakes** is calling Java and exposing Kotlin APIs to Java.

---

# 2. Why

Interviewers use **Java interop mistakes** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Java interop mistakes** is about calling Java and exposing Kotlin APIs to Java. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Java interop mistakes** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Java interop mistakes**.
...
- Does **Java interop mistakes** solve a real requirement?
...
1. What is **Java interop mistakes**?
...
Create the smallest runnable Kotlin example demonstrating **Java interop mistakes**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Java interop mistakes** in plain English.
