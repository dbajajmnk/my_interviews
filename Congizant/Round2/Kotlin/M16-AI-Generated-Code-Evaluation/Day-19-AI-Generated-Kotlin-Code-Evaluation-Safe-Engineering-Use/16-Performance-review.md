...
**Performance review** is measurement-driven runtime optimization.

---

# 2. Why

Interviewers use **Performance review** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Performance review** is about measurement-driven runtime optimization. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Performance review** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Performance review**.
...
- Does **Performance review** solve a real requirement?
...
Create the smallest runnable Kotlin example demonstrating **Performance review**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
