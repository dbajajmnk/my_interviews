# Topic 01 — kotlin.test awareness
...
**kotlin.test awareness** is the Kotlin engineering concept **kotlin.test awareness**.

---

# 2. Why

Interviewers use **kotlin.test awareness** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **kotlin.test awareness** is about the Kotlin engineering concept **kotlin.test awareness**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **kotlin.test awareness** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **kotlin.test awareness**.
...
- Does **kotlin.test awareness** solve a real requirement?
...
1. What is **kotlin.test awareness**?
...
Create the smallest runnable Kotlin example demonstrating **kotlin.test awareness**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **kotlin.test awareness** in plain English.
