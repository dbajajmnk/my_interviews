...
**MockK awareness** is Kotlin-oriented mocking library awareness.

---

# 2. Why

Interviewers use **MockK awareness** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **MockK awareness** is about Kotlin-oriented mocking library awareness. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.

---

# 4. Engineering Explanation

mocks can stub/verify calls but overuse couples tests to implementation
...
In a Kotlin/JVM production system, **MockK awareness** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **MockK awareness**.
...
- Does **MockK awareness** solve a real requirement?
...
Create the smallest runnable Kotlin example demonstrating **MockK awareness**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **MockK awareness** in plain English.
