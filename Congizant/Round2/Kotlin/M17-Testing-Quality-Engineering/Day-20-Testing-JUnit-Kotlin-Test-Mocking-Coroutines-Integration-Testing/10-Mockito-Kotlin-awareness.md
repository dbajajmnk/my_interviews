# Topic 10 — Mockito-Kotlin awareness
...
**Mockito-Kotlin awareness** is the Kotlin engineering concept **Mockito-Kotlin awareness**.

---

# 2. Why

Interviewers use **Mockito-Kotlin awareness** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Mockito-Kotlin awareness** is about the Kotlin engineering concept **Mockito-Kotlin awareness**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Mockito-Kotlin awareness** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Mockito-Kotlin awareness**.
...
- Does **Mockito-Kotlin awareness** solve a real requirement?
...
1. What is **Mockito-Kotlin awareness**?
...
Create the smallest runnable Kotlin example demonstrating **Mockito-Kotlin awareness**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Mockito-Kotlin awareness** in plain English.
