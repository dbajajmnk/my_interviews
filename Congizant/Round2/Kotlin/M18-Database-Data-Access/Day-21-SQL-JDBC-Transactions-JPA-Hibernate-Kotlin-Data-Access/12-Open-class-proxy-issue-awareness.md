# Topic 12 — Open class/proxy issue awareness
...
**Open class/proxy issue awareness** is the Kotlin engineering concept **Open class/proxy issue awareness**.

---

# 2. Why

Interviewers use **Open class/proxy issue awareness** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Open class/proxy issue awareness** is about the Kotlin engineering concept **Open class/proxy issue awareness**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Open class/proxy issue awareness** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Open class/proxy issue awareness**.
...
- Does **Open class/proxy issue awareness** solve a real requirement?
...
1. What is **Open class/proxy issue awareness**?
...
Create the smallest runnable Kotlin example demonstrating **Open class/proxy issue awareness**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Open class/proxy issue awareness** in plain English.
