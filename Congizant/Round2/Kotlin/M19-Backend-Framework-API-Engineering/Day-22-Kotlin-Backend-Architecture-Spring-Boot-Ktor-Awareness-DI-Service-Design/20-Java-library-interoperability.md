# Topic 20 — Java library interoperability
...
**Java library interoperability** is the Kotlin engineering concept **Java library interoperability**.

---

# 2. Why

Interviewers use **Java library interoperability** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Java library interoperability** is about the Kotlin engineering concept **Java library interoperability**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Java library interoperability** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Java library interoperability**.
...
- Does **Java library interoperability** solve a real requirement?
...
1. What is **Java library interoperability**?
...
Create the smallest runnable Kotlin example demonstrating **Java library interoperability**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Java library interoperability** in plain English.
