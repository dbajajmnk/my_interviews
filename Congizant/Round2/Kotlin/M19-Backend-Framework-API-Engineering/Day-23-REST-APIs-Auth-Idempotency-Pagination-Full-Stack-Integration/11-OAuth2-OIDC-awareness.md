# Topic 11 — OAuth2/OIDC awareness
...
**OAuth2/OIDC awareness** is the Kotlin engineering concept **OAuth2/OIDC awareness**.

---

# 2. Why

Interviewers use **OAuth2/OIDC awareness** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **OAuth2/OIDC awareness** is about the Kotlin engineering concept **OAuth2/OIDC awareness**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **OAuth2/OIDC awareness** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Does **OAuth2/OIDC awareness** solve a real requirement?
...
Create the smallest runnable Kotlin example demonstrating **OAuth2/OIDC awareness**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
