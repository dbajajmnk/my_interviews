# Topic 19 — Generated clients awareness
...
**Generated clients awareness** is the Kotlin engineering concept **Generated clients awareness**.

---

# 2. Why

Interviewers use **Generated clients awareness** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Generated clients awareness** is about the Kotlin engineering concept **Generated clients awareness**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Generated clients awareness** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Generated clients awareness**.
...
- Does **Generated clients awareness** solve a real requirement?
...
1. What is **Generated clients awareness**?
...
Create the smallest runnable Kotlin example demonstrating **Generated clients awareness**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Generated clients awareness** in plain English.
