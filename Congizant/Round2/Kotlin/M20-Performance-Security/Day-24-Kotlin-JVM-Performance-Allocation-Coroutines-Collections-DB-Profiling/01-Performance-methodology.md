...
**Performance methodology** is measurement-driven runtime optimization.

---

# 2. Why

Interviewers use **Performance methodology** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Performance methodology** is about measurement-driven runtime optimization. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.

---

# 4. Engineering Explanation

JVM/coroutine/DB/allocation costs require profiling and workload evidence
...
In a Kotlin/JVM production system, **Performance methodology** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Performance methodology**.
...
- Does **Performance methodology** solve a real requirement?
...
Create the smallest runnable Kotlin example demonstrating **Performance methodology**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
