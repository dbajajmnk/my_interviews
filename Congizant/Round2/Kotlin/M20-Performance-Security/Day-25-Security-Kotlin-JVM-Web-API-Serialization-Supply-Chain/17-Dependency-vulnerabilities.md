# Topic 17 — Dependency vulnerabilities
...
**Dependency vulnerabilities** is the Kotlin engineering concept **Dependency vulnerabilities**.

---

# 2. Why

Interviewers use **Dependency vulnerabilities** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Dependency vulnerabilities** is about the Kotlin engineering concept **Dependency vulnerabilities**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Dependency vulnerabilities** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Does **Dependency vulnerabilities** solve a real requirement?
...
Create the smallest runnable Kotlin example demonstrating **Dependency vulnerabilities**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
