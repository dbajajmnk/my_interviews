...
**System-design method** is progressive architecture from requirements and constraints.

---

# 2. Why

Interviewers use **System-design method** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **System-design method** is about progressive architecture from requirements and constraints. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.

---

# 4. Engineering Explanation

start with simplest coherent service/data model then add cache/events/service split for real bottlenecks
...
```kotlin
// requirements -> baseline -> bottleneck -> evolve
```
...
In a Kotlin/JVM production system, **System-design method** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **System-design method**.
...
- Does **System-design method** solve a real requirement?
...
Create the smallest runnable Kotlin example demonstrating **System-design method**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
