...
**Capacity estimation** is the Kotlin engineering concept **Capacity estimation**.

---

# 2. Why

Interviewers use **Capacity estimation** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Capacity estimation** is about the Kotlin engineering concept **Capacity estimation**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Capacity estimation** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Does **Capacity estimation** solve a real requirement?
...
Create the smallest runnable Kotlin example demonstrating **Capacity estimation**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
