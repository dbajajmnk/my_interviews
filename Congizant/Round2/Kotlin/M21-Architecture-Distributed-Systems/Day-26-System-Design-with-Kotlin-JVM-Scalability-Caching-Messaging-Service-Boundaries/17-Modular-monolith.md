...
**Modular monolith** is the Kotlin engineering concept **Modular monolith**.

---

# 2. Why

Interviewers use **Modular monolith** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Modular monolith** is about the Kotlin engineering concept **Modular monolith**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Modular monolith** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Does **Modular monolith** solve a real requirement?
...
Create the smallest runnable Kotlin example demonstrating **Modular monolith**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
