...
5. [Stateless Kotlin services](05-Stateless-Kotlin-services.md)
6. [Load balancing](06-Load-balancing.md)
7. [Caching](07-Caching.md)
8. [Rate limiting](08-Rate-limiting.md)
9. [SQL vs NoSQL trade-offs](09-SQL-vs-NoSQL-trade-offs.md)
10. [Replication awareness](10-Replication-awareness.md)
11. [Partitioning awareness](11-Partitioning-awareness.md)
12. [Queues](12-Queues.md)
13. [Events](13-Events.md)
14. [Messaging](14-Messaging.md)
15. [Idempotent consumers](15-Idempotent-consumers.md)
16. [Outbox pattern](16-Outbox-pattern.md)
17. [Modular monolith](17-Modular-monolith.md)
18. [Microservices](18-Microservices.md)
19. [Service boundaries](19-Service-boundaries.md)
20. [Consistency trade-offs](20-Consistency-trade-offs.md)
21. [Coroutine use in distributed systems](21-Coroutine-use-in-distributed-systems.md)
...
Day 26 keeps the GOJ structure familiar while translating it into Kotlin-native language, JVM, coroutine, and backend engineering decisions.
...
```text
Requirements → baseline Kotlin service → bottleneck → cache/events/service split
```
...
```text
System Design with Kotlin/JVM: Scalability, Caching, Messaging & Service Boundaries
├── Kotlin Semantics
...
Design a URL shortener and order-processing service using a simple baseline first.

---

# 8. Google Interview Drill

Reject premature microservices/Kafka and define real extraction triggers.
