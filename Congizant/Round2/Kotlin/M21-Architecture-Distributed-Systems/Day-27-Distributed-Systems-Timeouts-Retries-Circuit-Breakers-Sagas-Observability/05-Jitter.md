...
**Jitter** is the Kotlin engineering concept **Jitter**.

---

# 2. Why

Interviewers use **Jitter** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Jitter** is about the Kotlin engineering concept **Jitter**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Jitter** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Does **Jitter** solve a real requirement?
...
Create the smallest runnable Kotlin example demonstrating **Jitter**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
