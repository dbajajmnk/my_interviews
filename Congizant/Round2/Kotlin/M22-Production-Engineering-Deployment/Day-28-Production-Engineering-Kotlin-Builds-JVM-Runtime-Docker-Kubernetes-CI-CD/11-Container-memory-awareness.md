# Topic 11 — Container memory awareness
...
**Container memory awareness** is the Kotlin engineering concept **Container memory awareness**.

---

# 2. Why

Interviewers use **Container memory awareness** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Container memory awareness** is about the Kotlin engineering concept **Container memory awareness**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Container memory awareness** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Container memory awareness**.
...
- Does **Container memory awareness** solve a real requirement?
...
1. What is **Container memory awareness**?
...
Create the smallest runnable Kotlin example demonstrating **Container memory awareness**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Container memory awareness** in plain English.
