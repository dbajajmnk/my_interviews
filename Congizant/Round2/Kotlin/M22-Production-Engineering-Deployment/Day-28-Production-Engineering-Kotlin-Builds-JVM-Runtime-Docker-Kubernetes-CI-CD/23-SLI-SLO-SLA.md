...
**SLI/SLO/SLA** is the Kotlin engineering concept **SLI/SLO/SLA**.

---

# 2. Why

Interviewers use **SLI/SLO/SLA** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **SLI/SLO/SLA** is about the Kotlin engineering concept **SLI/SLO/SLA**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **SLI/SLO/SLA** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **SLI/SLO/SLA**.
...
- Does **SLI/SLO/SLA** solve a real requirement?
...
Create the smallest runnable Kotlin example demonstrating **SLI/SLO/SLA**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
