# Topic 01 — Java-to-Kotlin migration
...
**Java-to-Kotlin migration** is incremental system evolution.

---

# 2. Why

Interviewers use **Java-to-Kotlin migration** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Java-to-Kotlin migration** is about incremental system evolution. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Java-to-Kotlin migration** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Java-to-Kotlin migration**.
...
- Does **Java-to-Kotlin migration** solve a real requirement?
...
1. What is **Java-to-Kotlin migration**?
...
Create the smallest runnable Kotlin example demonstrating **Java-to-Kotlin migration**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Java-to-Kotlin migration** in plain English.
