# Topic 02 — Mixed Java/Kotlin codebase
...
**Mixed Java/Kotlin codebase** is the Kotlin engineering concept **Mixed Java/Kotlin codebase**.

---

# 2. Why

Interviewers use **Mixed Java/Kotlin codebase** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Mixed Java/Kotlin codebase** is about the Kotlin engineering concept **Mixed Java/Kotlin codebase**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Mixed Java/Kotlin codebase** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Mixed Java/Kotlin codebase**.
...
- Does **Mixed Java/Kotlin codebase** solve a real requirement?
...
1. What is **Mixed Java/Kotlin codebase**?
...
Create the smallest runnable Kotlin example demonstrating **Mixed Java/Kotlin codebase**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Mixed Java/Kotlin codebase** in plain English.
