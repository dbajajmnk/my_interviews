# Topic 03 — Nullability migration
...
**Nullability migration** is incremental system evolution.

---

# 2. Why

Interviewers use **Nullability migration** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Nullability migration** is about incremental system evolution. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Nullability migration** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Nullability migration**.
...
- Does **Nullability migration** solve a real requirement?
...
1. What is **Nullability migration**?
...
Create the smallest runnable Kotlin example demonstrating **Nullability migration**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Nullability migration** in plain English.
