# Topic 06 — Spring Java to Kotlin migration awareness
...
**Spring Java to Kotlin migration awareness** is Spring framework/Boot usage from Kotlin.

---

# 2. Why

Interviewers use **Spring Java to Kotlin migration awareness** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Spring Java to Kotlin migration awareness** is about Spring framework/Boot usage from Kotlin. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.

---

# 4. Engineering Explanation

constructor injection, Kotlin nullability and coroutines can integrate, but Spring proxy/runtime semantics still apply
...
```kotlin
@Service class OrderService(private val repo:Repo)
```
...
In a Kotlin/JVM production system, **Spring Java to Kotlin migration awareness** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Spring Java to Kotlin migration awareness**.
...
- Does **Spring Java to Kotlin migration awareness** solve a real requirement?
...
1. What is **Spring Java to Kotlin migration awareness**?
...
Create the smallest runnable Kotlin example demonstrating **Spring Java to Kotlin migration awareness**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Spring Java to Kotlin migration awareness** in plain English.
