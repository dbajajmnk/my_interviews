...
**Performance incident** is measurement-driven runtime optimization.

---

# 2. Why

Interviewers use **Performance incident** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Performance incident** is about measurement-driven runtime optimization. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Performance incident** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Performance incident**.
...
- Does **Performance incident** solve a real requirement?
...
Create the smallest runnable Kotlin example demonstrating **Performance incident**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
