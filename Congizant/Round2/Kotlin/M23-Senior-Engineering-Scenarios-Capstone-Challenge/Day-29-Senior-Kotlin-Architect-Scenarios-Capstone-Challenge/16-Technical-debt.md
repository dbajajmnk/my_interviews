...
**Technical debt** is the Kotlin engineering concept **Technical debt**.

---

# 2. Why

Interviewers use **Technical debt** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Technical debt** is about the Kotlin engineering concept **Technical debt**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Technical debt** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Does **Technical debt** solve a real requirement?
...
Create the smallest runnable Kotlin example demonstrating **Technical debt**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
