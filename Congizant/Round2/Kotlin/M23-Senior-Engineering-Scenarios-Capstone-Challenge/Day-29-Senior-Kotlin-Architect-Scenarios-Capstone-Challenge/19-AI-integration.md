...
**AI integration** is the Kotlin engineering concept **AI integration**.

---

# 2. Why

Interviewers use **AI integration** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **AI integration** is about the Kotlin engineering concept **AI integration**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **AI integration** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Does **AI integration** solve a real requirement?
...
Create the smallest runnable Kotlin example demonstrating **AI integration**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
