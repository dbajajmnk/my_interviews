# Topic 02 — Null-safety questions
...
**Null-safety questions** is the Kotlin engineering concept **Null-safety questions**.

---

# 2. Why

Interviewers use **Null-safety questions** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Null-safety questions** is about the Kotlin engineering concept **Null-safety questions**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Null-safety questions** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Null-safety questions**.
...
- Does **Null-safety questions** solve a real requirement?
...
1. What is **Null-safety questions**?
...
Create the smallest runnable Kotlin example demonstrating **Null-safety questions**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Null-safety questions** in plain English.
