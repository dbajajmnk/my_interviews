# Topic 03 — Extension/scope-function questions
...
**Extension/scope-function questions** is the Kotlin engineering concept **Extension/scope-function questions**.

---

# 2. Why

Interviewers use **Extension/scope-function questions** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Extension/scope-function questions** is about the Kotlin engineering concept **Extension/scope-function questions**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Extension/scope-function questions** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Extension/scope-function questions**.
...
- Does **Extension/scope-function questions** solve a real requirement?
...
1. What is **Extension/scope-function questions**?
...
Create the smallest runnable Kotlin example demonstrating **Extension/scope-function questions**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Extension/scope-function questions** in plain English.
