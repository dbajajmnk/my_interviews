# Topic 04 — Data/sealed class questions
...
**Data/sealed class questions** is closed hierarchy known to compiler within allowed scope.

---

# 2. Why

Interviewers use **Data/sealed class questions** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Data/sealed class questions** is about closed hierarchy known to compiler within allowed scope. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Data/sealed class questions** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Reproduce the smallest failure involving **Data/sealed class questions**.
...
- Does **Data/sealed class questions** solve a real requirement?
...
1. What is **Data/sealed class questions**?
...
Create the smallest runnable Kotlin example demonstrating **Data/sealed class questions**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
...
- [ ] I can define **Data/sealed class questions** in plain English.
