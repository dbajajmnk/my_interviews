...
**Coding challenge** is the Kotlin engineering concept **Coding challenge**.

---

# 2. Why

Interviewers use **Coding challenge** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Coding challenge** is about the Kotlin engineering concept **Coding challenge**. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Coding challenge** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Does **Coding challenge** solve a real requirement?
...
Create the smallest runnable Kotlin example demonstrating **Coding challenge**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
