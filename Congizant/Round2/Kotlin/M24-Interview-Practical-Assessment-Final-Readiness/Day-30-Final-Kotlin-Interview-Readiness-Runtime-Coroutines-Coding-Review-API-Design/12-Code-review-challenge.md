# Topic 12 — Code review challenge
...
**Code review challenge** is risk-based examination of change intent and behavior.

---

# 2. Why

Interviewers use **Code review challenge** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **Code review challenge** is about risk-based examination of change intent and behavior. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **Code review challenge** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Does **Code review challenge** solve a real requirement?
...
Create the smallest runnable Kotlin example demonstrating **Code review challenge**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
