# Topic 16 — System-design challenge
...
**System-design challenge** is progressive architecture from requirements and constraints.

---

# 2. Why

Interviewers use **System-design challenge** to test whether you understand Kotlin semantics, JVM/platform behavior, failure modes, and engineering trade-offs rather than only syntax.

---

# 3. Plain English

Plain English: **System-design challenge** is about progressive architecture from requirements and constraints. Use it when the requirement matches the problem; prefer simpler Kotlin when extra abstraction is not justified.
...
In a Kotlin/JVM production system, **System-design challenge** should connect to a real domain, coroutine, JVM, API, data, Android/backend, or architecture requirement.
...
- Does **System-design challenge** solve a real requirement?
...
Create the smallest runnable Kotlin example demonstrating **System-design challenge**. Then introduce one realistic misuse, reproduce the failure, fix it, and explain the review rule that should catch it.
