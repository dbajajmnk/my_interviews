# Topic 14 — Optional dependencies
...
**Optional dependencies** is explicit maybe-value enum.

# 2. Why

Interviewers use **Optional dependencies** to test Rust ownership/type guarantees, runtime costs, concurrency/async behavior, error modeling, security and production trade-offs.
...
Use **Optional dependencies** where it solves a real Rust systems, backend, async, data, safety or performance problem. **Evidence First:** conceptual examples are not project claims.
...
1. What is **Optional dependencies**?
...
Create a minimal runnable Rust example for **Optional dependencies**, introduce one realistic misuse, reproduce it with evidence, repair it and state the review rule.
