# Topic 12 — 'static lifetime awareness
...
**'static lifetime awareness** is compile-time relationship among references.

# 2. Why

Interviewers use **'static lifetime awareness** to test Rust ownership/type guarantees, runtime costs, concurrency/async behavior, error modeling, security and production trade-offs.
...
Use **'static lifetime awareness** where it solves a real Rust systems, backend, async, data, safety or performance problem. **Evidence First:** conceptual examples are not project claims.
...
1. What is **'static lifetime awareness**?
...
Create a minimal runnable Rust example for **'static lifetime awareness**, introduce one realistic misuse, reproduce it with evidence, repair it and state the review rule.
