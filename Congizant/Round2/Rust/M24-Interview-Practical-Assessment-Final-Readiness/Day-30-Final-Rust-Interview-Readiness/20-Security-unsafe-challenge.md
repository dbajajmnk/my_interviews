# Topic 20 — Security/unsafe challenge
...
**Security/unsafe challenge** is trusted boundary for operations compiler cannot prove safe.

# 2. Why

Interviewers use **Security/unsafe challenge** to test Rust ownership/type guarantees, runtime costs, concurrency/async behavior, error modeling, security and production trade-offs.
...
Use **Security/unsafe challenge** where it solves a real Rust systems, backend, async, data, safety or performance problem. **Evidence First:** conceptual examples are not project claims.
...
1. What is **Security/unsafe challenge**?
...
Create a minimal runnable Rust example for **Security/unsafe challenge**, introduce one realistic misuse, reproduce it with evidence, repair it and state the review rule.
