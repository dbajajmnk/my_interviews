# Topic 01 — TypeScript vs JavaScript
...
**TypeScript vs JavaScript** is adding static analysis and type tooling on top of JavaScript.

---

# 2. Why

Interviewers use **TypeScript vs JavaScript** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **TypeScript vs JavaScript** means adding static analysis and type tooling on top of JavaScript. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.

---

# 4. Engineering Explanation

TypeScript accepts JavaScript syntax plus type syntax, checks it, and emits JavaScript for a target runtime
...
In real TypeScript systems, this matters for language/tooling boundaries.
...
- Reproduce the smallest case involving **TypeScript vs JavaScript**.
...
1. What is **TypeScript vs JavaScript**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **TypeScript vs JavaScript**?
5. Where would you use **TypeScript vs JavaScript** in a real system?
...
Create the smallest strict TypeScript example demonstrating **TypeScript vs JavaScript**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **TypeScript vs JavaScript** in plain English.
