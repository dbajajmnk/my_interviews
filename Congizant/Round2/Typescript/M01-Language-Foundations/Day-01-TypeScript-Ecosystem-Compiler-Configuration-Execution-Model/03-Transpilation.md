...
**Transpilation** is transforming TypeScript/modern syntax into target JavaScript.

---

# 2. Why

Interviewers use **Transpilation** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Transpilation** means transforming TypeScript/modern syntax into target JavaScript. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.

---

# 4. Engineering Explanation

emit removes type-only syntax and may downlevel selected syntax; it does not add runtime validation
...
In real TypeScript systems, this matters for build compatibility.
...
- Reproduce the smallest case involving **Transpilation**.
...
4. What is a common misuse of **Transpilation**?
5. Where would you use **Transpilation** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Transpilation**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Transpilation** in plain English.
