...
**noImplicitAny** is rejecting implicit any inference in places where type cannot be determined safely.

---

# 2. Why

Interviewers use **noImplicitAny** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **noImplicitAny** means rejecting implicit any inference in places where type cannot be determined safely. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.

---

# 4. Engineering Explanation

compiler reports parameters/expressions that otherwise become `any` implicitly
...
In real TypeScript systems, this matters for any containment.
...
- Reproduce the smallest case involving **noImplicitAny**.
...
1. What is **noImplicitAny**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **noImplicitAny**?
5. Where would you use **noImplicitAny** in a real system?
...
Create the smallest strict TypeScript example demonstrating **noImplicitAny**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **noImplicitAny** in plain English.
