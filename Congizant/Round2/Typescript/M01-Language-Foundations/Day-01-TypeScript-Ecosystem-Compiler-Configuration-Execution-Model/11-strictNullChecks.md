...
**strictNullChecks** is making null/undefined distinct in type analysis.

---

# 2. Why

Interviewers use **strictNullChecks** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **strictNullChecks** means making null/undefined distinct in type analysis. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.

---

# 4. Engineering Explanation

values are not assignable to unrelated types unless explicitly included; narrowing is required
...
In real TypeScript systems, this matters for null safety.
...
- Reproduce the smallest case involving **strictNullChecks**.
...
1. What is **strictNullChecks**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **strictNullChecks**?
5. Where would you use **strictNullChecks** in a real system?
...
Create the smallest strict TypeScript example demonstrating **strictNullChecks**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **strictNullChecks** in plain English.
