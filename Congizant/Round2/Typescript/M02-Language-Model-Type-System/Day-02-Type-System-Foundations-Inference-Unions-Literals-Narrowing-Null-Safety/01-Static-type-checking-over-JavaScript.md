# Topic 01 — Static type checking over JavaScript
...
**Static type checking over JavaScript** is compile-time analysis of assignability and contracts.

---

# 2. Why

Interviewers use **Static type checking over JavaScript** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Static type checking over JavaScript** means compile-time analysis of assignability and contracts. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.

---

# 4. Engineering Explanation

the checker reasons over structural types, control flow, generics, unions, and library declarations without executing code
...
In real TypeScript systems, this matters for preventing classes of defects.
...
- Reproduce the smallest case involving **Static type checking over JavaScript**.
...
1. What is **Static type checking over JavaScript**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **Static type checking over JavaScript**?
5. Where would you use **Static type checking over JavaScript** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Static type checking over JavaScript**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Static type checking over JavaScript** in plain English.
