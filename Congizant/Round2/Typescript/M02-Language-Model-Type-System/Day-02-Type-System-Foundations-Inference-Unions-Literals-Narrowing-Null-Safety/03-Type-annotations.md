...
**Type annotations** is explicitly specifying a static type.

---

# 2. Why

Interviewers use **Type annotations** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Type annotations** means explicitly specifying a static type. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.

---

# 4. Engineering Explanation

annotation constrains assignability at compile time and is erased at runtime
...
In real TypeScript systems, this matters for public contracts.
...
- Reproduce the smallest case involving **Type annotations**.
...
1. What is **Type annotations**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **Type annotations**?
5. Where would you use **Type annotations** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Type annotations**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Type annotations** in plain English.
