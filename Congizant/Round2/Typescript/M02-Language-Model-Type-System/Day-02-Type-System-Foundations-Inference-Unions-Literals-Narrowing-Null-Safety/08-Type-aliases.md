...
**Type aliases** is naming any TypeScript type expression.

---

# 2. Why

Interviewers use **Type aliases** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Type aliases** means naming any TypeScript type expression. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.

---

# 4. Engineering Explanation

aliases can name unions, intersections, primitives, tuples, mapped/conditional types and object shapes
...
In real TypeScript systems, this matters for contract readability.
...
- Reproduce the smallest case involving **Type aliases**.
...
1. What is **Type aliases**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **Type aliases**?
5. Where would you use **Type aliases** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Type aliases**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Type aliases** in plain English.
