...
**Interfaces** is named structural object/class contract with extension/merging behavior.

---

# 2. Why

Interviewers use **Interfaces** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Interfaces** means named structural object/class contract with extension/merging behavior. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.
...
- Reproduce the smallest case involving **Interfaces**.
...
4. What is a common misuse of **Interfaces**?
5. Where would you use **Interfaces** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Interfaces**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
