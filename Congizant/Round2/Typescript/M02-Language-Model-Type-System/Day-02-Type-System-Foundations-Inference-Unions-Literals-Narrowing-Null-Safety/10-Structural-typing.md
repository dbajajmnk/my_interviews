...
**Structural typing** is compatibility based primarily on required members rather than declared nominal identity.

---

# 2. Why

Interviewers use **Structural typing** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Structural typing** means compatibility based primarily on required members rather than declared nominal identity. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.

---

# 4. Engineering Explanation

a value can be assignable when its structure satisfies the target, subject to special checks like excess-property checks
...
In real TypeScript systems, this matters for flexible contracts and their limits.
...
- Reproduce the smallest case involving **Structural typing**.
...
4. What is a common misuse of **Structural typing**?
5. Where would you use **Structural typing** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Structural typing**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Structural typing** in plain English.
