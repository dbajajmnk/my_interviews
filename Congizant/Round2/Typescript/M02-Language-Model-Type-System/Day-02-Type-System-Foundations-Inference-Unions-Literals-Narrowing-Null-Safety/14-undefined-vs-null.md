...
**undefined vs null** is distinct runtime values and separate strict types.

---

# 2. Why

Interviewers use **undefined vs null** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **undefined vs null** means distinct runtime values and separate strict types. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.

---

# 4. Engineering Explanation

strictNullChecks forces explicit unions/narrowing; external data may still violate declared assumptions
...
In real TypeScript systems, this matters for API/null handling.
...
- Reproduce the smallest case involving **undefined vs null**.
...
4. What is a common misuse of **undefined vs null**?
5. Where would you use **undefined vs null** in a real system?
...
Create the smallest strict TypeScript example demonstrating **undefined vs null**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
