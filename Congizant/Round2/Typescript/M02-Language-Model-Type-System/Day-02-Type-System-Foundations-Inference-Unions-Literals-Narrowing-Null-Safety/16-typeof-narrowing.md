...
**typeof narrowing** is using JavaScript `typeof` as a type guard.

---

# 2. Why

Interviewers use **typeof narrowing** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **typeof narrowing** means using JavaScript `typeof` as a type guard. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.

---

# 4. Engineering Explanation

checker recognizes supported typeof checks and narrows corresponding union members
...
In real TypeScript systems, this matters for primitive narrowing.
...
- Reproduce the smallest case involving **typeof narrowing**.
...
4. What is a common misuse of **typeof narrowing**?
5. Where would you use **typeof narrowing** in a real system?
...
Create the smallest strict TypeScript example demonstrating **typeof narrowing**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **typeof narrowing** in plain English.
