...
**Truthiness narrowing** is narrowing using JavaScript Boolean-context semantics.

---

# 2. Why

Interviewers use **Truthiness narrowing** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Truthiness narrowing** means narrowing using JavaScript Boolean-context semantics. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.

---

# 4. Engineering Explanation

checker removes impossible falsy members but can accidentally discard valid `0`/empty-string cases
...
In real TypeScript systems, this matters for null guarding.
...
- Reproduce the smallest case involving **Truthiness narrowing**.
...
1. What is **Truthiness narrowing**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **Truthiness narrowing**?
5. Where would you use **Truthiness narrowing** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Truthiness narrowing**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Truthiness narrowing** in plain English.
