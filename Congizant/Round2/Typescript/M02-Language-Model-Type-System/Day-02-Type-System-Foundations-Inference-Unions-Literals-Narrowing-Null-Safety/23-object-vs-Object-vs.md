...
**object vs Object vs {}** is object-ish type distinctions.

---

# 2. Why

Interviewers use **object vs Object vs {}** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **object vs Object vs {}** means object-ish type distinctions. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.

---

# 4. Engineering Explanation

`object`, `Object`, and `{}` have different assignability semantics; prefer precise object shapes instead of broad catch-all types
...
In real TypeScript systems, this matters for API modeling.
...
- Reproduce the smallest case involving **object vs Object vs {}**.
...
1. What is **object vs Object vs {}**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **object vs Object vs {}**?
5. Where would you use **object vs Object vs {}** in a real system?
...
Create the smallest strict TypeScript example demonstrating **object vs Object vs {}**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **object vs Object vs {}** in plain English.
