# Topic 01 — Function parameter types
...
**Function parameter types** is typed callable inputs.

---

# 2. Why

Interviewers use **Function parameter types** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Function parameter types** means typed callable inputs. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.

---

# 4. Engineering Explanation

parameter annotations constrain callers at compile time; runtime still accepts JavaScript values unless boundary validates
...
- Reproduce the smallest case involving **Function parameter types**.
...
1. What is **Function parameter types**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **Function parameter types**?
5. Where would you use **Function parameter types** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Function parameter types**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Function parameter types** in plain English.
