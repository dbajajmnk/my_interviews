...
**Call signatures** is the TypeScript concept **Call signatures**.

---

# 2. Why

Interviewers use **Call signatures** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Call signatures** means the TypeScript concept **Call signatures**. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.
...
In TypeScript projects, **Call signatures** should be tied to a concrete contract, runtime boundary, maintainability, debugging, performance, or production requirement.
...
- Reproduce the smallest case involving **Call signatures**.
...
1. What is **Call signatures**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **Call signatures**?
5. Where would you use **Call signatures** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Call signatures**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Call signatures** in plain English.
