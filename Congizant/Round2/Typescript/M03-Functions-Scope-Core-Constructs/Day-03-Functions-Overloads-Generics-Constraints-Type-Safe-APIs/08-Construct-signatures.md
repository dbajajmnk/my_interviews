...
**Construct signatures** is the TypeScript concept **Construct signatures**.

---

# 2. Why

Interviewers use **Construct signatures** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Construct signatures** means the TypeScript concept **Construct signatures**. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.
...
In TypeScript projects, **Construct signatures** should be tied to a concrete contract, runtime boundary, maintainability, debugging, performance, or production requirement.
...
- Reproduce the smallest case involving **Construct signatures**.
...
1. What is **Construct signatures**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **Construct signatures**?
5. Where would you use **Construct signatures** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Construct signatures**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Construct signatures** in plain English.
