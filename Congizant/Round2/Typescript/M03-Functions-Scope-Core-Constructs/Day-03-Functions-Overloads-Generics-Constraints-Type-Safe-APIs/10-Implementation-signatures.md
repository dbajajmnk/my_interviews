# Topic 10 — Implementation signatures
...
**Implementation signatures** is actual overload implementation contract.

---

# 2. Why

Interviewers use **Implementation signatures** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Implementation signatures** means actual overload implementation contract. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.

---

# 4. Engineering Explanation

must be compatible with all overloads but is hidden from external call resolution
...
In real TypeScript systems, this matters for overload correctness.
...
- Reproduce the smallest case involving **Implementation signatures**.
...
1. What is **Implementation signatures**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **Implementation signatures**?
5. Where would you use **Implementation signatures** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Implementation signatures**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Implementation signatures** in plain English.
