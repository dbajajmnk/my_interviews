...
**Generic functions** is function parameterized over types.

---

# 2. Why

Interviewers use **Generic functions** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Generic functions** means function parameterized over types. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.

---

# 4. Engineering Explanation

type parameters relate inputs/outputs while preserving caller-specific information
...
In real TypeScript systems, this matters for reusable typed utilities.
...
- Reproduce the smallest case involving **Generic functions**.
...
1. What is **Generic functions**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **Generic functions**?
5. Where would you use **Generic functions** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Generic functions**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Generic functions** in plain English.
