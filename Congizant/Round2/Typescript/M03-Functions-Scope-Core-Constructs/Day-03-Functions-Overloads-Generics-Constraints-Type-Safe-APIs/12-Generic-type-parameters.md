# Topic 12 — Generic type parameters
...
**Generic type parameters** is extracting a function's parameter tuple.

---

# 2. Why

Interviewers use **Generic type parameters** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Generic type parameters** means extracting a function's parameter tuple. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.
...
- Reproduce the smallest case involving **Generic type parameters**.
...
1. What is **Generic type parameters**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **Generic type parameters**?
5. Where would you use **Generic type parameters** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Generic type parameters**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Generic type parameters** in plain English.
