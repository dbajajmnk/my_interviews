...
**Constraints** is restricting generic type parameters to required capabilities.

---

# 2. Why

Interviewers use **Constraints** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Constraints** means restricting generic type parameters to required capabilities. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.
...
- Reproduce the smallest case involving **Constraints**.
...
4. What is a common misuse of **Constraints**?
5. Where would you use **Constraints** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Constraints**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Constraints** in plain English.
