...
**Generic defaults** is default type arguments.

---

# 2. Why

Interviewers use **Generic defaults** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Generic defaults** means default type arguments. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.

---

# 4. Engineering Explanation

callers may omit a type argument when inference/default suffices
...
In real TypeScript systems, this matters for library ergonomics.
...
- Reproduce the smallest case involving **Generic defaults**.
...
1. What is **Generic defaults**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **Generic defaults**?
5. Where would you use **Generic defaults** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Generic defaults**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Generic defaults** in plain English.
