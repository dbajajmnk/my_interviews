...
**Variance awareness** is how generic assignability changes with subtype relationships.

---

# 2. Why

Interviewers use **Variance awareness** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Variance awareness** means how generic assignability changes with subtype relationships. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.

---

# 4. Engineering Explanation

function parameter/return positions influence covariance/contravariance; TypeScript includes pragmatic/bivariant behaviors in selected contexts
...
In real TypeScript systems, this matters for callback/API safety.
...
- Reproduce the smallest case involving **Variance awareness**.
...
1. What is **Variance awareness**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **Variance awareness**?
5. Where would you use **Variance awareness** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Variance awareness**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Variance awareness** in plain English.
