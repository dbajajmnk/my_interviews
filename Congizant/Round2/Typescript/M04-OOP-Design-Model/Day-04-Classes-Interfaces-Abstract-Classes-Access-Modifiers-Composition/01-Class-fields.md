...
**Class fields** is the TypeScript concept **Class fields**.

---

# 2. Why

Interviewers use **Class fields** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Class fields** means the TypeScript concept **Class fields**. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.
...
In TypeScript projects, **Class fields** should be tied to a concrete contract, runtime boundary, maintainability, debugging, performance, or production requirement.
...
- Reproduce the smallest case involving **Class fields**.
...
1. What is **Class fields**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **Class fields**?
5. Where would you use **Class fields** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Class fields**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Class fields** in plain English.
