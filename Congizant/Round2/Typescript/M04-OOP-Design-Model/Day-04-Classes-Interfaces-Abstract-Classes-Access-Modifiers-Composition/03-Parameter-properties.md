...
**Parameter properties** is constructor shorthand declaring and initializing class members.

---

# 2. Why

Interviewers use **Parameter properties** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Parameter properties** means constructor shorthand declaring and initializing class members. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.

---

# 4. Engineering Explanation

access modifier/readonly on constructor parameter creates a field and assignment in emitted JS
...
```typescript
class S { constructor(private readonly repo:Repo){} }
```
...
In real TypeScript systems, this matters for DI-heavy classes.
...
- Reproduce the smallest case involving **Parameter properties**.
...
1. What is **Parameter properties**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **Parameter properties**?
5. Where would you use **Parameter properties** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Parameter properties**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Parameter properties** in plain English.
