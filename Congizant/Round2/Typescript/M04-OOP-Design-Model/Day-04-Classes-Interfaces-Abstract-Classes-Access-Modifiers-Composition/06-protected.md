...
**protected** is subclass-visible TypeScript member.

---

# 2. Why

Interviewers use **protected** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **protected** means subclass-visible TypeScript member. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.

---

# 4. Engineering Explanation

protected restricts type-level access to class/subclasses and is erased at runtime
...
In real TypeScript systems, this matters for inheritance.
...
- Reproduce the smallest case involving **protected**.
...
4. What is a common misuse of **protected**?
5. Where would you use **protected** in a real system?
...
Create the smallest strict TypeScript example demonstrating **protected**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **protected** in plain English.
