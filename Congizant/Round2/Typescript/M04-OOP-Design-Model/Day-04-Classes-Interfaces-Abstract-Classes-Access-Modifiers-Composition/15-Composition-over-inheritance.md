# Topic 15 — Composition over inheritance
...
**Composition over inheritance** is the TypeScript concept **Composition over inheritance**.

---

# 2. Why

Interviewers use **Composition over inheritance** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Composition over inheritance** means the TypeScript concept **Composition over inheritance**. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.
...
In TypeScript projects, **Composition over inheritance** should be tied to a concrete contract, runtime boundary, maintainability, debugging, performance, or production requirement.
...
- Reproduce the smallest case involving **Composition over inheritance**.
...
4. What is a common misuse of **Composition over inheritance**?
5. Where would you use **Composition over inheritance** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Composition over inheritance**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
