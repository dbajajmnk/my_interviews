# Topic 16 — Dependency injection by constructor
...
**Dependency injection by constructor** is supplying dependencies rather than constructing them inside policy code.

---

# 2. Why

Interviewers use **Dependency injection by constructor** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Dependency injection by constructor** means supplying dependencies rather than constructing them inside policy code. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.

---

# 4. Engineering Explanation

constructor/function injection works at runtime; interfaces may describe ports only at compile time
...
In real TypeScript systems, this matters for testable architecture.
...
- Reproduce the smallest case involving **Dependency injection by constructor**.
...
1. What is **Dependency injection by constructor**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **Dependency injection by constructor**?
5. Where would you use **Dependency injection by constructor** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Dependency injection by constructor**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Dependency injection by constructor** in plain English.
