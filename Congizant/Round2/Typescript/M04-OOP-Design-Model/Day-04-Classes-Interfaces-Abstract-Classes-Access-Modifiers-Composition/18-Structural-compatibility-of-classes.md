# Topic 18 — Structural compatibility of classes
...
**Structural compatibility of classes** is the TypeScript concept **Structural compatibility of classes**.

---

# 2. Why

Interviewers use **Structural compatibility of classes** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Structural compatibility of classes** means the TypeScript concept **Structural compatibility of classes**. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.
...
In TypeScript projects, **Structural compatibility of classes** should be tied to a concrete contract, runtime boundary, maintainability, debugging, performance, or production requirement.
...
- Reproduce the smallest case involving **Structural compatibility of classes**.
...
1. What is **Structural compatibility of classes**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **Structural compatibility of classes**?
5. Where would you use **Structural compatibility of classes** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Structural compatibility of classes**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Structural compatibility of classes** in plain English.
