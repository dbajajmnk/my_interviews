...
**Abstract Factory** is creates related typed object families.

---

# 2. Why

Interviewers use **Abstract Factory** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Abstract Factory** means creates related typed object families. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.

---

# 4. Engineering Explanation

one factory interface returns a compatible family of products
...
In production TypeScript, use it for provider/environment families; reject it when it only adds ceremony.
...
- Reproduce the smallest case involving **Abstract Factory**.
...
4. What is a common misuse of **Abstract Factory**?
5. Where would you use **Abstract Factory** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Abstract Factory**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
