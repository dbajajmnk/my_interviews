# Topic 12 — Function types as Strategy
...
**Function types as Strategy** is describing callable signatures.

---

# 2. Why

Interviewers use **Function types as Strategy** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Function types as Strategy** means describing callable signatures. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.

---

# 4. Engineering Explanation

function type captures parameter/return contract and can be composed generically
...
In real TypeScript systems, this matters for callbacks/strategies.
...
- Reproduce the smallest case involving **Function types as Strategy**.
...
1. What is **Function types as Strategy**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **Function types as Strategy**?
5. Where would you use **Function types as Strategy** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Function types as Strategy**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Function types as Strategy** in plain English.
