...
**Array<T>** is the TypeScript concept **Array<T>**.

---

# 2. Why

Interviewers use **Array<T>** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Array<T>** means the TypeScript concept **Array<T>**. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.
...
In TypeScript projects, **Array<T>** should be tied to a concrete contract, runtime boundary, maintainability, debugging, performance, or production requirement.
...
- Reproduce the smallest case involving **Array<T>**.
...
4. What is a common misuse of **Array<T>**?
5. Where would you use **Array<T>** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Array<T>**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Array<T>** in plain English.
