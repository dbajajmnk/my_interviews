...
**Readonly tuples** is the TypeScript concept **Readonly tuples**.

---

# 2. Why

Interviewers use **Readonly tuples** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Readonly tuples** means the TypeScript concept **Readonly tuples**. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.
...
In TypeScript projects, **Readonly tuples** should be tied to a concrete contract, runtime boundary, maintainability, debugging, performance, or production requirement.
...
- Reproduce the smallest case involving **Readonly tuples**.
...
1. What is **Readonly tuples**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **Readonly tuples**?
5. Where would you use **Readonly tuples** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Readonly tuples**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Readonly tuples** in plain English.
