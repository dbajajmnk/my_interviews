...
**Partial** is making all properties optional at type level.

---

# 2. Why

Interviewers use **Partial** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Partial** means making all properties optional at type level. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.
...
- Reproduce the smallest case involving **Partial**.
...
4. What is a common misuse of **Partial**?
5. Where would you use **Partial** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Partial**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Partial** in plain English.
