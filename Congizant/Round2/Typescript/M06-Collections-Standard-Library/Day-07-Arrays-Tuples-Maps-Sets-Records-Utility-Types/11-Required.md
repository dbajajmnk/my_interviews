...
**Required** is making properties required.

---

# 2. Why

Interviewers use **Required** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Required** means making properties required. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.

---

# 4. Engineering Explanation

mapped utility removes optional modifiers at compile time
...
In real TypeScript systems, this matters for normalized internal config.
...
- Reproduce the smallest case involving **Required**.
...
4. What is a common misuse of **Required**?
5. Where would you use **Required** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Required**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Required** in plain English.
