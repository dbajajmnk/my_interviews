...
**Omit** is excluding selected properties.

---

# 2. Why

Interviewers use **Omit** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Omit** means excluding selected properties. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.

---

# 4. Engineering Explanation

implemented through key exclusion/mapping; runtime objects are unchanged
...
In real TypeScript systems, this matters for DTO derivation.
...
- Reproduce the smallest case involving **Omit**.
...
4. What is a common misuse of **Omit**?
5. Where would you use **Omit** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Omit**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Omit** in plain English.
