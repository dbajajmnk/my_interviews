...
**ReturnType** is extracting a function return type.

---

# 2. Why

Interviewers use **ReturnType** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **ReturnType** means extracting a function return type. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.

---

# 4. Engineering Explanation

conditional/infer utility reads static callable return type
...
- Reproduce the smallest case involving **ReturnType**.
...
1. What is **ReturnType**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **ReturnType**?
5. Where would you use **ReturnType** in a real system?
...
Create the smallest strict TypeScript example demonstrating **ReturnType**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **ReturnType** in plain English.
