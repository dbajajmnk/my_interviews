...
**Awaited** is recursively unwrapping Promise-like result types.

---

# 2. Why

Interviewers use **Awaited** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Awaited** means recursively unwrapping Promise-like result types. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.
...
- Reproduce the smallest case involving **Awaited**.
...
4. What is a common misuse of **Awaited**?
5. Where would you use **Awaited** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Awaited**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Awaited** in plain English.
