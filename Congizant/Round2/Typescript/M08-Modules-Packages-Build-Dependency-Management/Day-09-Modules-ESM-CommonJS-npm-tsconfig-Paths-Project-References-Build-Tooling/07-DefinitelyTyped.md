...
**DefinitelyTyped** is community-maintained type declarations for JavaScript packages.

---

# 2. Why

Interviewers use **DefinitelyTyped** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **DefinitelyTyped** means community-maintained type declarations for JavaScript packages. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.

---

# 4. Engineering Explanation

@types packages add compile-time declarations but do not change the package runtime implementation
...
In real TypeScript systems, this matters for JS library interop.
...
- Reproduce the smallest case involving **DefinitelyTyped**.
...
4. What is a common misuse of **DefinitelyTyped**?
5. Where would you use **DefinitelyTyped** in a real system?
...
Create the smallest strict TypeScript example demonstrating **DefinitelyTyped**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **DefinitelyTyped** in plain English.
