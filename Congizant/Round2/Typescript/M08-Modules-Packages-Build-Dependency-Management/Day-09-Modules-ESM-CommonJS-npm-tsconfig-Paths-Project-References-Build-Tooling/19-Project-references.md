...
**Project references** is structuring large TypeScript programs into buildable project graphs.

---

# 2. Why

Interviewers use **Project references** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Project references** means structuring large TypeScript programs into buildable project graphs. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.

---

# 4. Engineering Explanation

references/composite outputs improve incremental builds and enforce project boundaries
...
In real TypeScript systems, this matters for monorepos.
...
- Reproduce the smallest case involving **Project references**.
...
1. What is **Project references**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **Project references**?
5. Where would you use **Project references** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Project references**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Project references** in plain English.
