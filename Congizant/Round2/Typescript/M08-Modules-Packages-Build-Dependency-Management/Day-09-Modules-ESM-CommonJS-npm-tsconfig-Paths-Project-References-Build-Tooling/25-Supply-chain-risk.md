...
**Supply-chain risk** is the TypeScript concept **Supply-chain risk**.

---

# 2. Why

Interviewers use **Supply-chain risk** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Supply-chain risk** means the TypeScript concept **Supply-chain risk**. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.
...
In TypeScript projects, **Supply-chain risk** should be tied to a concrete contract, runtime boundary, maintainability, debugging, performance, or production requirement.
...
- Reproduce the smallest case involving **Supply-chain risk**.
...
4. What is a common misuse of **Supply-chain risk**?
5. Where would you use **Supply-chain risk** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Supply-chain risk**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Supply-chain risk** in plain English.
