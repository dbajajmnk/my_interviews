...
**Mapped types** is transforming properties of another type.

---

# 2. Why

Interviewers use **Mapped types** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Mapped types** means transforming properties of another type. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.

---

# 4. Engineering Explanation

mapped types iterate over a PropertyKey union such as keyof T and apply type/modifier transformations
...
In real TypeScript systems, this matters for derived contracts.
...
- Reproduce the smallest case involving **Mapped types**.
...
1. What is **Mapped types**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **Mapped types**?
5. Where would you use **Mapped types** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Mapped types**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Mapped types** in plain English.
