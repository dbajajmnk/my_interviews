...
**as const** is const assertion preserving literal/readonly information.

---

# 2. Why

Interviewers use **as const** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **as const** means const assertion preserving literal/readonly information. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.

---

# 4. Engineering Explanation

narrows literals and marks object/array properties readonly at compile time; runtime object is not frozen
...
In real TypeScript systems, this matters for literal registries.
...
- Reproduce the smallest case involving **as const**.
...
4. What is a common misuse of **as const**?
5. Where would you use **as const** in a real system?
...
Create the smallest strict TypeScript example demonstrating **as const**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **as const** in plain English.
