# Topic 13 — Const type parameters awareness
...
**Const type parameters awareness** is extracting a function's parameter tuple.

---

# 2. Why

Interviewers use **Const type parameters awareness** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Const type parameters awareness** means extracting a function's parameter tuple. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.

---

# 4. Engineering Explanation

conditional/infer-based utility reflects static function type
...
In real TypeScript systems, this matters for wrapper/library typing.
...
- Reproduce the smallest case involving **Const type parameters awareness**.
...
1. What is **Const type parameters awareness**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **Const type parameters awareness**?
5. Where would you use **Const type parameters awareness** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Const type parameters awareness**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Const type parameters awareness** in plain English.
