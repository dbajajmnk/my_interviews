# Topic 14 — Branded/opaque type patterns
...
**Branded/opaque type patterns** is nominal-like distinction layered over structural types.

---

# 2. Why

Interviewers use **Branded/opaque type patterns** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Branded/opaque type patterns** means nominal-like distinction layered over structural types. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.

---

# 4. Engineering Explanation

intersections with unique marker properties can prevent accidental mixing at compile time; runtime remains ordinary values
...
In real TypeScript systems, this matters for domain identifiers.
...
- Reproduce the smallest case involving **Branded/opaque type patterns**.
...
1. What is **Branded/opaque type patterns**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **Branded/opaque type patterns**?
5. Where would you use **Branded/opaque type patterns** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Branded/opaque type patterns**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Branded/opaque type patterns** in plain English.
