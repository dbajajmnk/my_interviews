...
**Class decorators** is runtime metaprogramming syntax/semantics with TypeScript typing support.

---

# 2. Why

Interviewers use **Class decorators** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Class decorators** means runtime metaprogramming syntax/semantics with TypeScript typing support. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.
...
- Reproduce the smallest case involving **Class decorators**.
...
1. What is **Class decorators**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **Class decorators**?
5. Where would you use **Class decorators** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Class decorators**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Class decorators** in plain English.
