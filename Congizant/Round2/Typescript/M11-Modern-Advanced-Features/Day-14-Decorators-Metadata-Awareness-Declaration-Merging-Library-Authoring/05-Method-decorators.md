...
**Method decorators** is runtime metaprogramming syntax/semantics with TypeScript typing support.

---

# 2. Why

Interviewers use **Method decorators** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Method decorators** means runtime metaprogramming syntax/semantics with TypeScript typing support. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.
...
- Reproduce the smallest case involving **Method decorators**.
...
1. What is **Method decorators**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **Method decorators**?
5. Where would you use **Method decorators** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Method decorators**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Method decorators** in plain English.
