# Topic 06 — Field/accessor decorators awareness
...
**Field/accessor decorators awareness** is runtime metaprogramming syntax/semantics with TypeScript typing support.

---

# 2. Why

Interviewers use **Field/accessor decorators awareness** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Field/accessor decorators awareness** means runtime metaprogramming syntax/semantics with TypeScript typing support. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.
...
- Reproduce the smallest case involving **Field/accessor decorators awareness**.
...
1. What is **Field/accessor decorators awareness**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **Field/accessor decorators awareness**?
5. Where would you use **Field/accessor decorators awareness** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Field/accessor decorators awareness**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Field/accessor decorators awareness** in plain English.
