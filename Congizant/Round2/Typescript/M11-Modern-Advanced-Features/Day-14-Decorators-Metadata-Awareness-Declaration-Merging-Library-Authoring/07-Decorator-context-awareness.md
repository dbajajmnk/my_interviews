# Topic 07 — Decorator context awareness
...
**Decorator context awareness** is runtime metaprogramming syntax/semantics with TypeScript typing support.

---

# 2. Why

Interviewers use **Decorator context awareness** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Decorator context awareness** means runtime metaprogramming syntax/semantics with TypeScript typing support. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.
...
- Reproduce the smallest case involving **Decorator context awareness**.
...
1. What is **Decorator context awareness**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **Decorator context awareness**?
5. Where would you use **Decorator context awareness** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Decorator context awareness**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Decorator context awareness** in plain English.
