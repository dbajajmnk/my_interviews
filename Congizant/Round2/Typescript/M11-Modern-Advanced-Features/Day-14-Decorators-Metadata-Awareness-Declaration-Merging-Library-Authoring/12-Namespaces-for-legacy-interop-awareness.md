# Topic 12 — Namespaces for legacy interop awareness
...
**Namespaces for legacy interop awareness** is legacy TypeScript internal-module construct.

---

# 2. Why

Interviewers use **Namespaces for legacy interop awareness** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Namespaces for legacy interop awareness** means legacy TypeScript internal-module construct. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.

---

# 4. Engineering Explanation

namespace can emit IIFE/object patterns and merge declarations; ES modules are preferred for modern modular code
...
In real TypeScript systems, this matters for legacy interop.
...
- Reproduce the smallest case involving **Namespaces for legacy interop awareness**.
...
1. What is **Namespaces for legacy interop awareness**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **Namespaces for legacy interop awareness**?
5. Where would you use **Namespaces for legacy interop awareness** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Namespaces for legacy interop awareness**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Namespaces for legacy interop awareness** in plain English.
