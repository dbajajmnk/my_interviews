# Topic 02 — unknown at trust boundaries
...
**unknown at trust boundaries** is safe top type for untrusted/unknown values.

---

# 2. Why

Interviewers use **unknown at trust boundaries** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **unknown at trust boundaries** means safe top type for untrusted/unknown values. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.
...
- Reproduce the smallest case involving **unknown at trust boundaries**.
...
1. What is **unknown at trust boundaries**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **unknown at trust boundaries**?
5. Where would you use **unknown at trust boundaries** in a real system?
...
Create the smallest strict TypeScript example demonstrating **unknown at trust boundaries**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **unknown at trust boundaries** in plain English.
