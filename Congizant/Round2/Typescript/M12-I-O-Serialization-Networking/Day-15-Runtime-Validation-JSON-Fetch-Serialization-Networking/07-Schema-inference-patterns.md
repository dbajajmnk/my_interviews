# Topic 07 — Schema inference patterns
...
**Schema inference patterns** is introducing a type variable inside conditional matching.

---

# 2. Why

Interviewers use **Schema inference patterns** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Schema inference patterns** means introducing a type variable inside conditional matching. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.

---

# 4. Engineering Explanation

compiler infers a type from a matched position such as function return or array element
...
In real TypeScript systems, this matters for type utilities.
...
- Reproduce the smallest case involving **Schema inference patterns**.
...
1. What is **Schema inference patterns**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **Schema inference patterns**?
5. Where would you use **Schema inference patterns** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Schema inference patterns**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Schema inference patterns** in plain English.
