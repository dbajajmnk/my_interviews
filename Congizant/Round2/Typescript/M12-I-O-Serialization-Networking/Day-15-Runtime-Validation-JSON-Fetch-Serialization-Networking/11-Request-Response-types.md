# Topic 11 — Request/Response types
...
**Request/Response types** is the TypeScript concept **Request/Response types**.

---

# 2. Why

Interviewers use **Request/Response types** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Request/Response types** means the TypeScript concept **Request/Response types**. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.
...
In TypeScript projects, **Request/Response types** should be tied to a concrete contract, runtime boundary, maintainability, debugging, performance, or production requirement.
...
- Reproduce the smallest case involving **Request/Response types**.
...
1. What is **Request/Response types**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **Request/Response types**?
5. Where would you use **Request/Response types** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Request/Response types**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Request/Response types** in plain English.
