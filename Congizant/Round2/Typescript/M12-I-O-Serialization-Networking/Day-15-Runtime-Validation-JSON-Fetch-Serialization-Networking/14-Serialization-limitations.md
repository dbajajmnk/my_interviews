# Topic 14 — Serialization limitations
...
**Serialization limitations** is the TypeScript concept **Serialization limitations**.

---

# 2. Why

Interviewers use **Serialization limitations** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Serialization limitations** means the TypeScript concept **Serialization limitations**. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.
...
In TypeScript projects, **Serialization limitations** should be tied to a concrete contract, runtime boundary, maintainability, debugging, performance, or production requirement.
...
- Reproduce the smallest case involving **Serialization limitations**.
...
1. What is **Serialization limitations**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **Serialization limitations**?
5. Where would you use **Serialization limitations** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Serialization limitations**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Serialization limitations** in plain English.
