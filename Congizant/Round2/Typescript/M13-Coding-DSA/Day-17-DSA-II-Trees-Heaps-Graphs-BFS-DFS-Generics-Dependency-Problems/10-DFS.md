...
Interviewers use **DFS** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **DFS** means depth-first traversal. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.

---

# 4. Engineering Explanation

recursion/stack explores a branch and visited prevents cycles
...
In real TypeScript systems, this matters for graphs.
...
- Reproduce the smallest case involving **DFS**.
...
4. What is a common misuse of **DFS**?
5. Where would you use **DFS** in a real system?
...
Create the smallest strict TypeScript example demonstrating **DFS**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
