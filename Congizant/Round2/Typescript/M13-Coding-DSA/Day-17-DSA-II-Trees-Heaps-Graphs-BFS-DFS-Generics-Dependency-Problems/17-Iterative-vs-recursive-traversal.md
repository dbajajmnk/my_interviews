# Topic 17 — Iterative vs recursive traversal
...
**Iterative vs recursive traversal** is the TypeScript concept **Iterative vs recursive traversal**.

---

# 2. Why

Interviewers use **Iterative vs recursive traversal** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Iterative vs recursive traversal** means the TypeScript concept **Iterative vs recursive traversal**. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.
...
In TypeScript projects, **Iterative vs recursive traversal** should be tied to a concrete contract, runtime boundary, maintainability, debugging, performance, or production requirement.
...
- Reproduce the smallest case involving **Iterative vs recursive traversal**.
...
4. What is a common misuse of **Iterative vs recursive traversal**?
5. Where would you use **Iterative vs recursive traversal** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Iterative vs recursive traversal**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
