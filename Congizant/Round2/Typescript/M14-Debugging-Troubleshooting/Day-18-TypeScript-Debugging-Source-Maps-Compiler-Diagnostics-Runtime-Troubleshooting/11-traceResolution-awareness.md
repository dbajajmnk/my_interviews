# Topic 11 — traceResolution awareness
...
**traceResolution awareness** is module-resolution diagnostic output.

---

# 2. Why

Interviewers use **traceResolution awareness** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **traceResolution awareness** means module-resolution diagnostic output. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.

---

# 4. Engineering Explanation

compiler logs how each module/type reference was resolved, useful for path/package/@types issues
...
In real TypeScript systems, this matters for module debugging.
...
- Reproduce the smallest case involving **traceResolution awareness**.
...
1. What is **traceResolution awareness**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **traceResolution awareness**?
5. Where would you use **traceResolution awareness** in a real system?
...
Create the smallest strict TypeScript example demonstrating **traceResolution awareness**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **traceResolution awareness** in plain English.
