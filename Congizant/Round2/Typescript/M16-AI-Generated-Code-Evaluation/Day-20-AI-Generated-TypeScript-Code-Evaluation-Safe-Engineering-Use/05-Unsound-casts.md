...
**Unsound casts** is the TypeScript concept **Unsound casts**.

---

# 2. Why

Interviewers use **Unsound casts** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Unsound casts** means the TypeScript concept **Unsound casts**. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.
...
In TypeScript projects, **Unsound casts** should be tied to a concrete contract, runtime boundary, maintainability, debugging, performance, or production requirement.
...
- Reproduce the smallest case involving **Unsound casts**.
...
1. What is **Unsound casts**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **Unsound casts**?
5. Where would you use **Unsound casts** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Unsound casts**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Unsound casts** in plain English.
