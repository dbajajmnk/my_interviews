...
**Generated tests** is the TypeScript concept **Generated tests**.

---

# 2. Why

Interviewers use **Generated tests** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Generated tests** means the TypeScript concept **Generated tests**. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.
...
In TypeScript projects, **Generated tests** should be tied to a concrete contract, runtime boundary, maintainability, debugging, performance, or production requirement.
...
- Reproduce the smallest case involving **Generated tests**.
...
4. What is a common misuse of **Generated tests**?
5. Where would you use **Generated tests** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Generated tests**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
