# Topic 02 — Node test runner awareness
...
**Node test runner awareness** is TypeScript tests executed through a build/transformation/runtime setup.

---

# 2. Why

Interviewers use **Node test runner awareness** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Node test runner awareness** means TypeScript tests executed through a build/transformation/runtime setup. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.

---

# 4. Engineering Explanation

type checking and test execution are separate gates unless toolchain combines them
...
In real TypeScript systems, this matters for testing.
...
- Reproduce the smallest case involving **Node test runner awareness**.
...
1. What is **Node test runner awareness**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **Node test runner awareness**?
5. Where would you use **Node test runner awareness** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Node test runner awareness**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Node test runner awareness** in plain English.
