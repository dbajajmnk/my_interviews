...
**tsd awareness** is type-level testing tool awareness.

---

# 2. Why

Interviewers use **tsd awareness** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **tsd awareness** means type-level testing tool awareness. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.

---

# 4. Engineering Explanation

type tests assert compiler inference/assignability for public TypeScript APIs; they do not execute runtime behavior
...
In real TypeScript systems, this matters for library type contracts.
...
- Reproduce the smallest case involving **tsd awareness**.
...
1. What is **tsd awareness**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **tsd awareness**?
5. Where would you use **tsd awareness** in a real system?
...
Create the smallest strict TypeScript example demonstrating **tsd awareness**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **tsd awareness** in plain English.
