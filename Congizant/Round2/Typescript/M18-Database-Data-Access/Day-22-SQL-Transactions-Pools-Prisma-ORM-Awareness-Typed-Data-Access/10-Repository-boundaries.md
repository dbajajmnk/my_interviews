# Topic 10 — Repository boundaries
...
**Repository boundaries** is the TypeScript concept **Repository boundaries**.

---

# 2. Why

Interviewers use **Repository boundaries** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Repository boundaries** means the TypeScript concept **Repository boundaries**. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.
...
In TypeScript projects, **Repository boundaries** should be tied to a concrete contract, runtime boundary, maintainability, debugging, performance, or production requirement.
...
- Reproduce the smallest case involving **Repository boundaries**.
...
1. What is **Repository boundaries**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **Repository boundaries**?
5. Where would you use **Repository boundaries** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Repository boundaries**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
