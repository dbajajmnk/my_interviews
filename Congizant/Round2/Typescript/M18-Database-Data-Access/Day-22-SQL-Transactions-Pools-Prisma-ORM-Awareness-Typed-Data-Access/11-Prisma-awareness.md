...
**Prisma awareness** is generated type-safe ORM/client awareness.

---

# 2. Why

Interviewers use **Prisma awareness** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Prisma awareness** means generated type-safe ORM/client awareness. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.

---

# 4. Engineering Explanation

schema generates client/types, but DB state/migrations/runtime input still govern truth
...
In real TypeScript systems, this matters for typed data access.
...
- Reproduce the smallest case involving **Prisma awareness**.
...
4. What is a common misuse of **Prisma awareness**?
5. Where would you use **Prisma awareness** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Prisma awareness**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
