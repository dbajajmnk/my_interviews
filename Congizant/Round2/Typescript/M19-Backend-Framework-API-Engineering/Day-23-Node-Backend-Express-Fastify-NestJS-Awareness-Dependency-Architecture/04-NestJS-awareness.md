...
**NestJS awareness** is NestJS framework awareness.

---

# 2. Why

Interviewers use **NestJS awareness** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **NestJS awareness** means NestJS framework awareness. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.
...
- Reproduce the smallest case involving **NestJS awareness**.
...
1. What is **NestJS awareness**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **NestJS awareness**?
5. Where would you use **NestJS awareness** in a real system?
...
Create the smallest strict TypeScript example demonstrating **NestJS awareness**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **NestJS awareness** in plain English.
