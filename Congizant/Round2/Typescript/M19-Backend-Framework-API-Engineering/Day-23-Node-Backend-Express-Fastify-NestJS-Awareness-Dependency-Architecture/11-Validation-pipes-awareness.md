# Topic 11 — Validation pipes awareness
...
**Validation pipes awareness** is NestJS-style runtime validation/transformation boundary.

---

# 2. Why

Interviewers use **Validation pipes awareness** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Validation pipes awareness** means NestJS-style runtime validation/transformation boundary. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.

---

# 4. Engineering Explanation

DTO class metadata/validator libraries can execute checks; interfaces alone cannot
...
In real TypeScript systems, this matters for request validation.
...
- Reproduce the smallest case involving **Validation pipes awareness**.
...
1. What is **Validation pipes awareness**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **Validation pipes awareness**?
5. Where would you use **Validation pipes awareness** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Validation pipes awareness**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Validation pipes awareness** in plain English.
