# Topic 18 — Interceptors awareness
...
**Interceptors awareness** is framework cross-cutting request/response wrapper awareness.

---

# 2. Why

Interviewers use **Interceptors awareness** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Interceptors awareness** means framework cross-cutting request/response wrapper awareness. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.

---

# 4. Engineering Explanation

interceptors wrap handler execution for logging/transformation/caching etc.
...
In real TypeScript systems, this matters for cross-cutting concerns.
...
- Reproduce the smallest case involving **Interceptors awareness**.
...
1. What is **Interceptors awareness**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **Interceptors awareness**?
5. Where would you use **Interceptors awareness** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Interceptors awareness**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Interceptors awareness** in plain English.
