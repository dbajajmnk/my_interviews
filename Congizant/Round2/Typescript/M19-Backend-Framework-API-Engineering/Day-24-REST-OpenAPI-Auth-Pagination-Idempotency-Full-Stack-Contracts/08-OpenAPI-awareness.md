...
**OpenAPI awareness** is machine-readable runtime API contract description.

---

# 2. Why

Interviewers use **OpenAPI awareness** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **OpenAPI awareness** means machine-readable runtime API contract description. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.
...
- Reproduce the smallest case involving **OpenAPI awareness**.
...
4. What is a common misuse of **OpenAPI awareness**?
5. Where would you use **OpenAPI awareness** in a real system?
...
Create the smallest strict TypeScript example demonstrating **OpenAPI awareness**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
