# Topic 02 — Type-checking performance
...
**Type-checking performance** is compiler/editor work needed to solve project type graph.

---

# 2. Why

Interviewers use **Type-checking performance** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Type-checking performance** means compiler/editor work needed to solve project type graph. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.

---

# 4. Engineering Explanation

large unions, recursive conditionals, project structure, declaration complexity and dependency graph influence checker cost
...
In real TypeScript systems, this matters for large projects.
...
- Reproduce the smallest case involving **Type-checking performance**.
...
1. What is **Type-checking performance**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **Type-checking performance**?
5. Where would you use **Type-checking performance** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Type-checking performance**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Type-checking performance** in plain English.
