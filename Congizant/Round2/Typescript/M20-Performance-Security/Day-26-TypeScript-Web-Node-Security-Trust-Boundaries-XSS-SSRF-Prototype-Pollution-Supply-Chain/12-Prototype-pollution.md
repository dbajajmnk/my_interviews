...
**Prototype pollution** is runtime JavaScript object/prototype attack unaffected by static types.

---

# 2. Why

Interviewers use **Prototype pollution** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Prototype pollution** means runtime JavaScript object/prototype attack unaffected by static types. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.

---

# 4. Engineering Explanation

unsafe deep merge/path assignment can write prototype-related keys despite nice interfaces
...
In real TypeScript systems, this matters for Node/web security.
...
- Reproduce the smallest case involving **Prototype pollution**.
...
4. What is a common misuse of **Prototype pollution**?
5. Where would you use **Prototype pollution** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Prototype pollution**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
