...
**Unsafe object merging** is the TypeScript concept **Unsafe object merging**.

---

# 2. Why

Interviewers use **Unsafe object merging** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Unsafe object merging** means the TypeScript concept **Unsafe object merging**. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.
...
In TypeScript projects, **Unsafe object merging** should be tied to a concrete contract, runtime boundary, maintainability, debugging, performance, or production requirement.
...
- Reproduce the smallest case involving **Unsafe object merging**.
...
4. What is a common misuse of **Unsafe object merging**?
5. Where would you use **Unsafe object merging** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Unsafe object merging**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
