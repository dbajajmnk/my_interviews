...
**NFRs** is the TypeScript concept **NFRs**.

---

# 2. Why

Interviewers use **NFRs** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **NFRs** means the TypeScript concept **NFRs**. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.
...
In TypeScript projects, **NFRs** should be tied to a concrete contract, runtime boundary, maintainability, debugging, performance, or production requirement.
...
- Reproduce the smallest case involving **NFRs**.
...
4. What is a common misuse of **NFRs**?
5. Where would you use **NFRs** in a real system?
...
Create the smallest strict TypeScript example demonstrating **NFRs**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **NFRs** in plain English.
