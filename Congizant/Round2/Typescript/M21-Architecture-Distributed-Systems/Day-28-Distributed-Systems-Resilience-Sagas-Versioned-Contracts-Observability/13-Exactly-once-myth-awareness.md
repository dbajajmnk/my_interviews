# Topic 13 — Exactly-once myth awareness
...
**Exactly-once myth awareness** is the TypeScript concept **Exactly-once myth awareness**.

---

# 2. Why

Interviewers use **Exactly-once myth awareness** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Exactly-once myth awareness** means the TypeScript concept **Exactly-once myth awareness**. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.
...
In TypeScript projects, **Exactly-once myth awareness** should be tied to a concrete contract, runtime boundary, maintainability, debugging, performance, or production requirement.
...
- Reproduce the smallest case involving **Exactly-once myth awareness**.
...
4. What is a common misuse of **Exactly-once myth awareness**?
5. Where would you use **Exactly-once myth awareness** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Exactly-once myth awareness**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
