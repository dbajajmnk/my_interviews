...
**SLI/SLO/SLA** is the TypeScript concept **SLI/SLO/SLA**.

---

# 2. Why

Interviewers use **SLI/SLO/SLA** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **SLI/SLO/SLA** means the TypeScript concept **SLI/SLO/SLA**. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.
...
In TypeScript projects, **SLI/SLO/SLA** should be tied to a concrete contract, runtime boundary, maintainability, debugging, performance, or production requirement.
...
- Reproduce the smallest case involving **SLI/SLO/SLA**.
...
4. What is a common misuse of **SLI/SLO/SLA**?
5. Where would you use **SLI/SLO/SLA** in a real system?
...
Create the smallest strict TypeScript example demonstrating **SLI/SLO/SLA**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
