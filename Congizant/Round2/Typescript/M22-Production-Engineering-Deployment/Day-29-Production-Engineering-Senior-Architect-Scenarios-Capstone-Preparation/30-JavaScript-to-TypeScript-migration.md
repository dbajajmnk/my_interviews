# Topic 30 — JavaScript-to-TypeScript migration
...
**JavaScript-to-TypeScript migration** is incremental adoption of static checking.

---

# 2. Why

Interviewers use **JavaScript-to-TypeScript migration** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **JavaScript-to-TypeScript migration** means incremental adoption of static checking. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.

---

# 4. Engineering Explanation

migration can start with allowJs/checkJs or file conversion, then tighten strictness and eliminate unsafe boundaries gradually
...
```typescript
// baseline errors → convert boundaries → strictness ratchet
```
...
In real TypeScript systems, this matters for modernization.
...
- Reproduce the smallest case involving **JavaScript-to-TypeScript migration**.
...
1. What is **JavaScript-to-TypeScript migration**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **JavaScript-to-TypeScript migration**?
5. Where would you use **JavaScript-to-TypeScript migration** in a real system?
...
Create the smallest strict TypeScript example demonstrating **JavaScript-to-TypeScript migration**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **JavaScript-to-TypeScript migration** in plain English.
