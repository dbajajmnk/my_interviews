# Topic 31 — Strict-mode migration
...
**Strict-mode migration** is progressively enabling strict compiler checks.

---

# 2. Why

Interviewers use **Strict-mode migration** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Strict-mode migration** means progressively enabling strict compiler checks. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.

---

# 4. Engineering Explanation

large codebases often need staged error baselines and module-by-module repair rather than `as any` suppression
...
- Reproduce the smallest case involving **Strict-mode migration**.
...
1. What is **Strict-mode migration**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **Strict-mode migration**?
5. Where would you use **Strict-mode migration** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Strict-mode migration**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Strict-mode migration** in plain English.
