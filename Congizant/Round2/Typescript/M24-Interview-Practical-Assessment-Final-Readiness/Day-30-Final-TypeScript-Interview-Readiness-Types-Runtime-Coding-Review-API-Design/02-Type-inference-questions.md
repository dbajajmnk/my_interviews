# Topic 02 — Type inference questions
...
**Type inference questions** is allowing compiler to infer types from initializers, context and generic relationships.

---

# 2. Why

Interviewers use **Type inference questions** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Type inference questions** means allowing compiler to infer types from initializers, context and generic relationships. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.
...
- Reproduce the smallest case involving **Type inference questions**.
...
1. What is **Type inference questions**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **Type inference questions**?
5. Where would you use **Type inference questions** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Type inference questions**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Type inference questions** in plain English.
