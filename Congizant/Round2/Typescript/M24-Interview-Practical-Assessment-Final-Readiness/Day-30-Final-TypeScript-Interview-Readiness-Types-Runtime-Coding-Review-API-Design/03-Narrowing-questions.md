...
**Narrowing questions** is the TypeScript concept **Narrowing questions**.

---

# 2. Why

Interviewers use **Narrowing questions** to test whether you understand both TypeScript's compile-time guarantees and the emitted JavaScript/runtime behavior. Senior answers must distinguish static safety from runtime truth.

---

# 3. Plain English

Plain English: **Narrowing questions** means the TypeScript concept **Narrowing questions**. TypeScript can prove some relationships before execution, but it cannot make unvalidated external data or runtime effects safe by declaration alone.
...
In TypeScript projects, **Narrowing questions** should be tied to a concrete contract, runtime boundary, maintainability, debugging, performance, or production requirement.
...
- Reproduce the smallest case involving **Narrowing questions**.
...
1. What is **Narrowing questions**?
2. What does TypeScript guarantee here?
3. What remains purely runtime JavaScript behavior?
4. What is a common misuse of **Narrowing questions**?
5. Where would you use **Narrowing questions** in a real system?
...
Create the smallest strict TypeScript example demonstrating **Narrowing questions**. Inspect or reason about the emitted JavaScript. Then introduce one realistic misuse, reproduce the compiler/runtime failure, fix it, and explain which review rule would have caught it.
...
- [ ] I can define **Narrowing questions** in plain English.
